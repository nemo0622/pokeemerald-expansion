...
MysteryGift_EventScript_Monotype_Dark::
	randomelement SPECIES_MURKROW, SPECIES_GRIMER_ALOLAN, SPECIES_SNEASEL, SPECIES_MEOWTH_ALOLAN, SPECIES_VULLABY, SPECIES_HOUNDOUR, SPECIES_STUNKY, SPECIES_EKANS, SPECIES_SCRAGGY, SPECIES_ZIGZAGOON_GALAR, SPECIES_IMPIDIMP
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Water::
	randomelement SPECIES_BARBOACH, SPECIES_CORPHISH, SPECIES_WINGULL, SPECIES_QUAXLY, SPECIES_FINIZEN, SPECIES_RELICANTH, SPECIES_POPPLIO, SPECIES_CORSOLA, SPECIES_FROAKIE, SPECIES_PANPOUR, SPECIES_DUCKLETT, SPECIES_POLIWAG, SPECIES_WOOPER, SPECIES_OMANYTE, SPECIES_KABUTO, SPECIES_SPHEAL, SPECIES_SEEL, SPECIES_BUIZEL, SPECIES_FINNEON, SPECIES_WAILMER, SPECIES_TENTACOOL, SPECIES_CLAUNCHER, SPECIES_BASCULIN_WHITE_STRIPED, SPECIES_SKRELP, SPECIES_CHINCHOU, SPECIES_SHELLDER, SPECIES_CLAMPERL, SPECIES_MAGIKARP, SPECIES_BRUXISH, SPECIES_LAPRAS, SPECIES_PSYDUCK, SPECIES_REMORAID, SPECIES_TIRTOUGA
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
