...
MysteryGift_EventScript_Monotype_Bug::
	randomelement SPECIES_FALINKS, SPECIES_NINCADA, SPECIES_GRUBBIN, SPECIES_PARAS, SPECIES_CUTIEFLY, SPECIES_CATERPIE, SPECIES_WEEDLE, SPECIES_HERACROSS, SPECIES_DWEBBLE, SPECIES_SKORUPI, SPECIES_SPINARAK, SPECIES_SCYTHER, SPECIES_ANORITH, SPECIES_YANMA, SPECIES_LARVESTA
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Dragon::
	randomelement SPECIES_NOIBAT, SPECIES_BAGON, SPECIES_GOOMY, SPECIES_DRATINI, SPECIES_APPLIN
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Fairy::
	randomelement SPECIES_PONYTA_GALARIAN, SPECIES_CUTIEFLY, SPECIES_RALTS, SPECIES_MAWILE, SPECIES_VULPIX, SPECIES_TOGEPI, SPECIES_VULPIX_ALOLA, SPECIES_FINNEON, SPECIES_DEDENNE, SPECIES_CLEFFA, SPECIES_IGGLYBUFF, SPECIES_TINKATINK, SPECIES_IMPIDIMP, SPECIES_SWABLU
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Fighting::
	randomelement SPECIES_FALINKS, SPECIES_TIMBURR, SPECIES_HERACROSS, SPECIES_MIENFOO, SPECIES_SNEASEL_HISUI, SPECIES_STUFFUL, SPECIES_CRABRAWLER, SPECIES_MEDITITE, SPECIES_PANCHAM, SPECIES_SCRAGGY, SPECIES_PASSIMIAN, SPECIES_FARFETCHD, SPECIES_MANKEY
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Grass::
	randomelement SPECIES_APPLIN, SPECIES_BOUNSWEET, SPECIES_ROWLET, SPECIES_CHESPIN, SPECIES_PANSAGE, SPECIES_HOPPIP, SPECIES_PARAS, SPECIES_SKIDDO, SPECIES_PUMPKABOO, SPECIES_SHROOMISH, SPECIES_TOEDSCOOL, SPECIES_CHERUBI, SPECIES_LILEEP, SPECIES_FOMANTIS, SPECIES_VOLTORB_HISUI, SPECIES_BUDEW, SPECIES_PHANTUMP, SPECIES_SNOVER, SPECIES_DHELMISE
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Ground::
	randomelement SPECIES_SANDILE, SPECIES_CUFANT, SPECIES_NINCADA, SPECIES_WOOPER_PALDEAN, SPECIES_PHANPY, SPECIES_CUBONE, SPECIES_MUDBRAY, SPECIES_SANDSHREW, SPECIES_WOOPER, SPECIES_TOEDSCOOL, SPECIES_BALTOY, SPECIES_TRAPINCH, SPECIES_DODUO, SPECIES_NUMEL, SPECIES_LARVITAR
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Steel::
	randomelement SPECIES_CUFANT, SPECIES_MAWILE, SPECIES_ARON, SPECIES_HONEDGE, SPECIES_BRONZOR, SPECIES_MEOWTH_GALAR, SPECIES_TOGEDEMARU, SPECIES_TINKATINK, SPECIES_MAGNEMITE, SPECIES_SKARMORY, SPECIES_PAWNIARD
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
