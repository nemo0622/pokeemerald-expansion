...
MysteryGift_EventScript_Monotype_Dark::
	randomelement SPECIES_MURKROW, SPECIES_VULLABY, SPECIES_HOUNDOUR, SPECIES_STUNKY, SPECIES_EKANS, SPECIES_SCRAGGY, SPECIES_ZIGZAGOON_GALAR, SPECIES_IMPIDIMP, SPECIES_PAWNIARD
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Dragon::
	randomelement SPECIES_NOIBAT, SPECIES_BAGON, SPECIES_GOOMY
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Electric::
	randomelement SPECIES_MAREEP, SPECIES_BLITZLE, SPECIES_ELEKID, SPECIES_PACHIRISU, SPECIES_TYNAMO, SPECIES_PAWMI, SPECIES_TOGEDEMARU, SPECIES_DEDENNE, SPECIES_CHINCHOU, SPECIES_VOLTORB_HISUI, SPECIES_MAGNEMITE, SPECIES_ORICORIO_POM_POM
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Fairy::
	randomelement SPECIES_FLABEBE, SPECIES_CUTIEFLY, SPECIES_RALTS, SPECIES_MAWILE, SPECIES_VULPIX, SPECIES_TOGEPI, SPECIES_VULPIX_ALOLA, SPECIES_FINNEON, SPECIES_DEDENNE, SPECIES_CLEFFA, SPECIES_IGGLYBUFF, SPECIES_TINKATINK, SPECIES_IMPIDIMP, SPECIES_SWABLU
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Fire::
	randomelement SPECIES_LITTEN, SPECIES_FENNEKIN, SPECIES_PANSEAR, SPECIES_ORICORIO_BAILE, SPECIES_VULPIX, SPECIES_SALANDIT, SPECIES_HOUNDOUR, SPECIES_MAGBY, SPECIES_DARUMAKA, SPECIES_TORKOAL, SPECIES_NUMEL, SPECIES_GROWLITHE_HISUI, SPECIES_LARVESTA
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Ground::
	randomelement SPECIES_NINCADA, SPECIES_PHANPY, SPECIES_CUBONE, SPECIES_MUDBRAY, SPECIES_SANDSHREW, SPECIES_WOOPER, SPECIES_TOEDSCOOL, SPECIES_BALTOY, SPECIES_TRAPINCH, SPECIES_DODUO, SPECIES_NUMEL, SPECIES_LARVITAR
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Ice::
	randomelement SPECIES_SNORUNT, SPECIES_SPHEAL, SPECIES_VULPIX_ALOLA, SPECIES_LAPRAS, SPECIES_CUBCHOO, SPECIES_SNOVER, SPECIES_VANILLITE
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Normal::
	randomelement SPECIES_SENTRET, SPECIES_LILLIPUP, SPECIES_PIKIPEK, SPECIES_EEVEE, SPECIES_SHUPPET, SPECIES_AIPOM, SPECIES_HOOTHOOT, SPECIES_ZORUA_HISUI, SPECIES_SHROODLE, SPECIES_STUFFUL, SPECIES_IGGLYBUFF, SPECIES_KECLEON, SPECIES_ORANGURU, SPECIES_ZIGZAGOON_GALAR, SPECIES_GIRAFARIG, SPECIES_RUFFLET
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Poison::
	randomelement SPECIES_WEEDLE, SPECIES_GASTLY, SPECIES_SALANDIT, SPECIES_SKORUPI, SPECIES_SPINARAK, SPECIES_SNEASEL_HISUI, SPECIES_SHROODLE, SPECIES_STUNKY, SPECIES_TENTACOOL, SPECIES_EKANS, SPECIES_SKRELP, SPECIES_BUDEW
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Psychic::
	randomelement SPECIES_ORICORIO_PAU, SPECIES_RALTS, SPECIES_WOOBAT, SPECIES_FLITTLE, SPECIES_BALTOY, SPECIES_BRONZOR, SPECIES_CHINGLING, SPECIES_MEDITITE, SPECIES_DROWZEE, SPECIES_MUNNA, SPECIES_ORANGURU, SPECIES_BRUXISH, SPECIES_GIRAFARIG
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Rock::
	randomelement SPECIES_NOSEPASS, SPECIES_ROCKRUFF, SPECIES_ARON, SPECIES_KLAWF, SPECIES_DWEBBLE, SPECIES_MINIOR, SPECIES_OMANYTE, SPECIES_KABUTO, SPECIES_CORSOLA_GALAR, SPECIES_LILEEP, SPECIES_ANORITH, SPECIES_GROWLITHE_HISUI, SPECIES_TIRTOUGA, SPECIES_ARCHEN, SPECIES_LARVITAR
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
