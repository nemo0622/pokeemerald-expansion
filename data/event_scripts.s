...
MysteryGift_EventScript_DoMysteryGift::
	...
	goto_if_eq VAR_RESULT, 8, MysteryGift_EventScript_UltraBeasts
...
MysteryGift_EventScript_Girlypop::
	randomelement SPECIES_CLEFAIRY, SPECIES_VULPIX_ALOLA, SPECIES_JIGGLYPUFF, SPECIES_TOGEPI, SPECIES_RALTS, SPECIES_MAWILE, SPECIES_DEDENNE, SPECIES_POPPLIO, SPECIES_TINKATINK, SPECIES_FLABEBE, SPECIES_CUTIEFLY, SPECIES_SNORUNT, SPECIES_ZORUA_HISUI, SPECIES_PUMPKABOO, SPECIES_ORICORIO_SENSU, SPECIES_CORSOLA_GALAR, SPECIES_PHANTUMP, SPECIES_SEEL, SPECIES_LAPRAS, SPECIES_EEVEE, SPECIES_CLAMPERL, SPECIES_BRUXISH, SPECIES_POLIWAG, SPECIES_CHINCHOU, SPECIES_WOOPER, SPECIES_SPHEAL, SPECIES_FINNEON, SPECIES_PANPOUR, SPECIES_ZIGZAGOON_GALAR, SPECIES_SENTRET, SPECIES_AIPOM, SPECIES_SWABLU, SPECIES_LILLIPUP, SPECIES_STUFFUL, SPECIES_GIRAFARIG, SPECIES_FLITTLE, SPECIES_MUNNA, SPECIES_ORICORIO_PAU, SPECIES_WOOBAT, SPECIES_ROSELIA, SPECIES_FOMANTIS, SPECIES_HOPPIP, SPECIES_CHERUBI, SPECIES_ROWLET, SPECIES_TOEDSCOOL, SPECIES_CATERPIE, SPECIES_LILEEP, SPECIES_OMANYTE, SPECIES_KABUTO, SPECIES_LARVITAR, SPECIES_DWEBBLE, SPECIES_ARCHEN, SPECIES_ROCKRUFF, SPECIES_GROWLITHE_HISUI, SPECIES_VANILLITE, SPECIES_VULPIX, SPECIES_FENNEKIN, SPECIES_ORICORIO_BAILE, SPECIES_NUMEL, SPECIES_LITTEN, SPECIES_MURKROW, SPECIES_VULLABY, SPECIES_IMPIDIMP, SPECIES_TOGEDEMARU, SPECIES_EKANS, SPECIES_SPINARAK, SPECIES_SNEASEL_HISUI, SPECIES_PHANPY, SPECIES_CUBONE, SPECIES_TRAPINCH, SPECIES_MUDBRAY, SPECIES_MAREEP, SPECIES_PAWMI, SPECIES_GOOMY, SPECIES_ORICORIO_POM_POM, SPECIES_DODUO, SPECIES_HOOTHOOT, SPECIES_MEDITITE, SPECIES_MIENFOO, SPECIES_MANKEY, SPECIES_SCRAGGY, SPECIES_PANCHAM
...
MysteryGift_EventScript_UltraBeasts::
	bufferspeciesname STR_VAR_1, SPECIES_NIHILEGO
	setvar VAR_TEMP_TRANSFERRED_SPECIES, SPECIES_NIHILEGO
	givemon SPECIES_NIHILEGO, 5
	@ call MysteryGift_EventScript_ReceivedMon
	bufferspeciesname STR_VAR_1, SPECIES_BUZZWOLE
	setvar VAR_TEMP_TRANSFERRED_SPECIES, SPECIES_BUZZWOLE
	givemon SPECIES_BUZZWOLE, 5
	@ call MysteryGift_EventScript_ReceivedMon
	bufferspeciesname STR_VAR_1, SPECIES_PHEROMOSA
	setvar VAR_TEMP_TRANSFERRED_SPECIES, SPECIES_PHEROMOSA
	givemon SPECIES_PHEROMOSA, 5
	@ call MysteryGift_EventScript_ReceivedMon
	bufferspeciesname STR_VAR_1, SPECIES_XURKITREE
	setvar VAR_TEMP_TRANSFERRED_SPECIES, SPECIES_XURKITREE
	givemon SPECIES_XURKITREE, 5
	@ call MysteryGift_EventScript_ReceivedMon
	bufferspeciesname STR_VAR_1, SPECIES_CELESTEELA
	setvar VAR_TEMP_TRANSFERRED_SPECIES, SPECIES_CELESTEELA
	givemon SPECIES_CELESTEELA, 5
	@ call MysteryGift_EventScript_ReceivedMon
	bufferspeciesname STR_VAR_1, SPECIES_KARTANA
	setvar VAR_TEMP_TRANSFERRED_SPECIES, SPECIES_KARTANA
	givemon SPECIES_KARTANA, 5
	@ call MysteryGift_EventScript_ReceivedMon
	bufferspeciesname STR_VAR_1, SPECIES_GUZZLORD
	setvar VAR_TEMP_TRANSFERRED_SPECIES, SPECIES_GUZZLORD
	givemon SPECIES_GUZZLORD, 5
	@ call MysteryGift_EventScript_ReceivedMon
	releaseall
	end

MysteryGift_EventScript_NemosFavs::
	randomelement SPECIES_ROWLET, SPECIES_LITTEN, SPECIES_POPPLIO, SPECIES_BRAIXEN, SPECIES_VULPIX, SPECIES_TOEDSCOOL, SPECIES_PUMPKABOO, SPECIES_MINIOR_BLUE, SPECIES_ZORUA_HISUI, SPECIES_CRABRAWLER, SPECIES_BASCULIN_WHITE_STRIPED, SPECIES_GROWLITHE_HISUI, SPECIES_ARCHEN, SPECIES_IMPIDIMP, SPECIES_TRAPINCH, SPECIES_ANORITH, SPECIES_PAWMI, SPECIES_ROCKRUFF
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
...
MysteryGift_EventScript_Monotype_Bug::
	randomelement SPECIES_NINCADA, SPECIES_GRUBBIN, SPECIES_PARAS, SPECIES_CUTIEFLY, SPECIES_CATERPIE, SPECIES_WEEDLE, SPECIES_HERACROSS, SPECIES_DWEBBLE, SPECIES_SKORUPI, SPECIES_SPINARAK, SPECIES_SCYTHER, SPECIES_ANORITH, SPECIES_YANMA, SPECIES_LARVESTA
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Dark::
	randomelement SPECIES_MURKROW, SPECIES_GRIMER_ALOLAN, SPECIES_SNEASEL, SPECIES_MEOWTH_ALOLAN, SPECIES_VULLABY, SPECIES_HOUNDOUR, SPECIES_STUNKY, SPECIES_EKANS, SPECIES_SCRAGGY, SPECIES_ZIGZAGOON_GALAR, SPECIES_IMPIDIMP, SPECIES_PAWNIARD
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Dragon::
	randomelement SPECIES_NOIBAT, SPECIES_BAGON, SPECIES_GOOMY, SPECIES_DRATINI
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Electric::
	randomelement SPECIES_MAREEP, SPECIES_VOLTORB, SPECIES_BLITZLE, SPECIES_ELEKID, SPECIES_PACHIRISU, SPECIES_TYNAMO, SPECIES_PAWMI, SPECIES_TOGEDEMARU, SPECIES_DEDENNE, SPECIES_CHINCHOU, SPECIES_VOLTORB_HISUI, SPECIES_MAGNEMITE, SPECIES_ORICORIO_POM_POM
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Fairy::
	randomelement SPECIES_FLABEBE, SPECIES_PONYTA_GALARIAN, SPECIES_CUTIEFLY, SPECIES_RALTS, SPECIES_MAWILE, SPECIES_VULPIX, SPECIES_TOGEPI, SPECIES_VULPIX_ALOLA, SPECIES_FINNEON, SPECIES_DEDENNE, SPECIES_CLEFFA, SPECIES_IGGLYBUFF, SPECIES_TINKATINK, SPECIES_IMPIDIMP, SPECIES_SWABLU
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Fighting::
	randomelement SPECIES_TIMBURR, SPECIES_HERACROSS, SPECIES_MIENFOO, SPECIES_SNEASEL_HISUI, SPECIES_STUFFUL, SPECIES_CRABRAWLER, SPECIES_MEDITITE, SPECIES_PANCHAM, SPECIES_SCRAGGY, SPECIES_PASSIMIAN, SPECIES_FARFETCHD, SPECIES_MANKEY
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Fire::
	randomelement SPECIES_LITTEN, SPECIES_PONYTA, SPECIES_FENNEKIN, SPECIES_PANSEAR, SPECIES_ORICORIO_BAILE, SPECIES_VULPIX, SPECIES_SALANDIT, SPECIES_HOUNDOUR, SPECIES_MAGBY, SPECIES_DARUMAKA, SPECIES_TORKOAL, SPECIES_NUMEL, SPECIES_GROWLITHE_HISUI, SPECIES_LARVESTA
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Flying::
	randomelement SPECIES_ORICORIO_BAILE, SPECIES_ORICORIO_PAU, SPECIES_ORICORIO_POM_POM, SPECIES_ORICORIO_SENSU, SPECIES_ROWLET, SPECIES_PIKIPEK, SPECIES_DUCKLETT, SPECIES_HOPPIP, SPECIES_MURKROW, SPECIES_VULLABY, SPECIES_WOOBAT, SPECIES_HOOTHOOT, SPECIES_MINIOR, SPECIES_NOIBAT, SPECIES_SCYTHER, SPECIES_DODUO, SPECIES_SWABLU, SPECIES_FARFETCHD, SPECIES_YANMA, SPECIES_SKARMORY, SPECIES_RUFFLET, SPECIES_ARCHEN
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Ghost::
	randomelement SPECIES_ORICORIO_SENSU, SPECIES_PUMPKABOO, SPECIES_SHUPPET, SPECIES_HONEDGE, SPECIES_GASTLY, SPECIES_ZORUA_HISUI, SPECIES_CORSOLA_GALAR, SPECIES_PHANTUMP, SPECIES_DUSKULL, SPECIES_DHELMISE
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Grass::
	randomelement SPECIES_ROWLET, SPECIES_CHESPIN, SPECIES_PANSAGE, SPECIES_HOPPIP, SPECIES_PARAS, SPECIES_SKIDDO, SPECIES_PUMPKABOO, SPECIES_SHROOMISH, SPECIES_TOEDSCOOL, SPECIES_CHERUBI, SPECIES_LILEEP, SPECIES_FOMANTIS, SPECIES_VOLTORB_HISUI, SPECIES_BUDEW, SPECIES_PHANTUMP, SPECIES_SNOVER, SPECIES_DHELMISE
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Ground::
	randomelement SPECIES_NINCADA, SPECIES_WOOPER_PALDEAN, SPECIES_PHANPY, SPECIES_CUBONE, SPECIES_MUDBRAY, SPECIES_SANDSHREW, SPECIES_WOOPER, SPECIES_TOEDSCOOL, SPECIES_BALTOY, SPECIES_TRAPINCH, SPECIES_DODUO, SPECIES_NUMEL, SPECIES_LARVITAR
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Ice::
	randomelement SPECIES_SNORUNT, SPECIES_DARUMAKA_GALARIAN, SPECIES_SNEASEL, SPECIES_SPHEAL, SPECIES_VULPIX_ALOLA, SPECIES_LAPRAS, SPECIES_CUBCHOO, SPECIES_SNOVER, SPECIES_VANILLITE
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Normal::
	randomelement SPECIES_SENTRET, SPECIES_MEOWTH, SPECIES_LILLIPUP, SPECIES_PIKIPEK, SPECIES_EEVEE, SPECIES_SHUPPET, SPECIES_AIPOM, SPECIES_HOOTHOOT, SPECIES_ZORUA_HISUI, SPECIES_SHROODLE, SPECIES_STUFFUL, SPECIES_IGGLYBUFF, SPECIES_KECLEON, SPECIES_ORANGURU, SPECIES_ZIGZAGOON_GALAR, SPECIES_GIRAFARIG, SPECIES_RUFFLET
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Poison::
	randomelement SPECIES_WEEDLE, SPECIES_GRIMER, SPECIES_GRIMER_ALOLAN, SPECIES_GASTLY, SPECIES_SALANDIT, SPECIES_SKORUPI, SPECIES_SPINARAK, SPECIES_SNEASEL_HISUI, SPECIES_SHROODLE, SPECIES_STUNKY, SPECIES_TENTACOOL, SPECIES_EKANS, SPECIES_SKRELP, SPECIES_BUDEW
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Psychic::
	randomelement SPECIES_ORICORIO_PAU, SPECIES_PONYTA_GALARIAN, SPECIES_RALTS, SPECIES_WOOBAT, SPECIES_FLITTLE, SPECIES_BALTOY, SPECIES_BRONZOR, SPECIES_CHINGLING, SPECIES_MEDITITE, SPECIES_DROWZEE, SPECIES_MUNNA, SPECIES_ORANGURU, SPECIES_BRUXISH, SPECIES_GIRAFARIG
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Rock::
	randomelement SPECIES_NOSEPASS, SPECIES_CORSOLA, SPECIES_ROCKRUFF, SPECIES_ARON, SPECIES_KLAWF, SPECIES_DWEBBLE, SPECIES_MINIOR, SPECIES_OMANYTE, SPECIES_KABUTO, SPECIES_CORSOLA_GALAR, SPECIES_LILEEP, SPECIES_ANORITH, SPECIES_GROWLITHE_HISUI, SPECIES_TIRTOUGA, SPECIES_ARCHEN, SPECIES_LARVITAR
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Steel::
	randomelement SPECIES_MAWILE, SPECIES_ARON, SPECIES_HONEDGE, SPECIES_BRONZOR, SPECIES_MEOWTH_GALAR, SPECIES_TOGEDEMARU, SPECIES_TINKATINK, SPECIES_MAGNEMITE, SPECIES_SKARMORY, SPECIES_PAWNIARD
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Water::
	randomelement SPECIES_POPPLIO, SPECIES_CORSOLA, SPECIES_FROAKIE, SPECIES_PANPOUR, SPECIES_DUCKLETT, SPECIES_POLIWAG, SPECIES_WOOPER, SPECIES_OMANYTE, SPECIES_KABUTO, SPECIES_SPHEAL, SPECIES_SEEL, SPECIES_BUIZEL, SPECIES_FINNEON, SPECIES_WAILMER, SPECIES_TENTACOOL, SPECIES_CLAUNCHER, SPECIES_BASCULIN_WHITE_STRIPED, SPECIES_SKRELP, SPECIES_CHINCHOU, SPECIES_SHELLDER, SPECIES_CLAMPERL, SPECIES_MAGIKARP, SPECIES_BRUXISH, SPECIES_LAPRAS, SPECIES_PSYDUCK, SPECIES_REMORAID, SPECIES_TIRTOUGA
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
