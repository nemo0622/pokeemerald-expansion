...
MysteryGift_EventScript_Monotype_Bug::
	randomelement SPECIES_SNOM, SPECIES_FALINKS, SPECIES_NINCADA, SPECIES_GRUBBIN, SPECIES_PARAS, SPECIES_CUTIEFLY, SPECIES_CATERPIE, SPECIES_WEEDLE, SPECIES_HERACROSS, SPECIES_DWEBBLE, SPECIES_SKORUPI, SPECIES_SPINARAK, SPECIES_SCYTHER, SPECIES_ANORITH, SPECIES_YANMA
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Dragon::
	randomelement SPECIES_TYRUNT, SPECIES_BAGON, SPECIES_GOOMY, SPECIES_DRATINI, SPECIES_APPLIN
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Electric::
	randomelement SPECIES_HELIOPTILE, SPECIES_MAREEP, SPECIES_VOLTORB, SPECIES_BLITZLE, SPECIES_PACHIRISU, SPECIES_ELECTRIKE, SPECIES_PAWMI, SPECIES_TOGEDEMARU, SPECIES_DEDENNE, SPECIES_CHINCHOU, SPECIES_VOLTORB_HISUI, SPECIES_MAGNEMITE, SPECIES_ORICORIO_POM_POM
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Fighting::
	randomelement SPECIES_FALINKS, SPECIES_TIMBURR, SPECIES_HERACROSS, SPECIES_MIENFOO, SPECIES_SNEASEL_HISUI, SPECIES_STUFFUL, SPECIES_CRABRAWLER, SPECIES_MEDITITE, SPECIES_PANCHAM, SPECIES_SCRAGGY, SPECIES_PASSIMIAN, SPECIES_MANKEY
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Fire::
	randomelement SPECIES_LITWICK, SPECIES_CHARCADET, SPECIES_FUECOCO, SPECIES_LITTEN, SPECIES_PONYTA, SPECIES_FENNEKIN, SPECIES_PANSEAR, SPECIES_ORICORIO_BAILE, SPECIES_VULPIX, SPECIES_SALANDIT, SPECIES_HOUNDOUR, SPECIES_TORKOAL, SPECIES_NUMEL, SPECIES_GROWLITHE_HISUI
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Flying::
	randomelement SPECIES_NATU, SPECIES_WINGULL, SPECIES_GLIGAR, SPECIES_ORICORIO_BAILE, SPECIES_CHATOT, SPECIES_ORICORIO_PAU, SPECIES_ORICORIO_POM_POM, SPECIES_ORICORIO_SENSU, SPECIES_ROWLET, SPECIES_PIKIPEK, SPECIES_DUCKLETT, SPECIES_HOPPIP, SPECIES_MURKROW, SPECIES_VULLABY, SPECIES_WOOBAT, SPECIES_HOOTHOOT, SPECIES_MINIOR, SPECIES_SCYTHER, SPECIES_DODUO, SPECIES_SWABLU, SPECIES_YANMA, SPECIES_SKARMORY, SPECIES_RUFFLET, SPECIES_ARCHEN
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Ghost::
	randomelement SPECIES_LITWICK, SPECIES_ORICORIO_SENSU, SPECIES_PUMPKABOO, SPECIES_SHUPPET, SPECIES_HONEDGE, SPECIES_GASTLY, SPECIES_ZORUA_HISUI, SPECIES_CORSOLA_GALAR, SPECIES_DUSKULL, SPECIES_DHELMISE
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Grass::
	randomelement SPECIES_SPRIGATITO, SPECIES_APPLIN, SPECIES_BOUNSWEET, SPECIES_ROWLET, SPECIES_CHESPIN, SPECIES_PANSAGE, SPECIES_HOPPIP, SPECIES_PARAS, SPECIES_SKIDDO, SPECIES_PUMPKABOO, SPECIES_SHROOMISH, SPECIES_TOEDSCOOL, SPECIES_CHERUBI, SPECIES_LILEEP, SPECIES_FOMANTIS, SPECIES_VOLTORB_HISUI, SPECIES_BUDEW, SPECIES_SNOVER, SPECIES_DHELMISE
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Ice::
	randomelement SPECIES_AMAURA, SPECIES_SNOM, SPECIES_SNORUNT, SPECIES_SNEASEL, SPECIES_SPHEAL, SPECIES_VULPIX_ALOLA, SPECIES_LAPRAS, SPECIES_CUBCHOO, SPECIES_SNOVER, SPECIES_SWINUB
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Normal::
	randomelement SPECIES_HELIOPTILE, SPECIES_STANTLER, SPECIES_KOMALA, SPECIES_CHATOT, SPECIES_MEOWTH, SPECIES_LILLIPUP, SPECIES_PIKIPEK, SPECIES_EEVEE, SPECIES_SHUPPET, SPECIES_AIPOM, SPECIES_HOOTHOOT, SPECIES_ZORUA_HISUI, SPECIES_SHROODLE, SPECIES_STUFFUL, SPECIES_IGGLYBUFF, SPECIES_KECLEON, SPECIES_ORANGURU, SPECIES_ZIGZAGOON_GALAR, SPECIES_GIRAFARIG, SPECIES_RUFFLET
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Psychic::
	randomelement SPECIES_NATU, SPECIES_SOLOSIS, SPECIES_GOTHITA, SPECIES_ORICORIO_PAU, SPECIES_PONYTA_GALARIAN, SPECIES_RALTS, SPECIES_WOOBAT, SPECIES_FLITTLE, SPECIES_BALTOY, SPECIES_BRONZOR, SPECIES_MEDITITE, SPECIES_DROWZEE, SPECIES_MUNNA, SPECIES_ORANGURU, SPECIES_BRUXISH, SPECIES_GIRAFARIG
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
