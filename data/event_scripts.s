...
MysteryGift_EventScript_Monotype_Flying::
	randomelement SPECIES_NATU, SPECIES_WINGULL, SPECIES_GLIGAR, SPECIES_ORICORIO_BAILE, SPECIES_CHATOT, SPECIES_ORICORIO_PAU, SPECIES_ORICORIO_POM_POM, SPECIES_ORICORIO_SENSU, SPECIES_ROWLET, SPECIES_PIKIPEK, SPECIES_DUCKLETT, SPECIES_HOPPIP, SPECIES_MURKROW, SPECIES_VULLABY, SPECIES_WOOBAT, SPECIES_HOOTHOOT, SPECIES_MINIOR, SPECIES_NOIBAT, SPECIES_SCYTHER, SPECIES_DODUO, SPECIES_SWABLU, SPECIES_YANMA, SPECIES_SKARMORY, SPECIES_RUFFLET, SPECIES_ARCHEN
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Ice::
	randomelement SPECIES_SNOM, SPECIES_SNORUNT, SPECIES_SNEASEL, SPECIES_SPHEAL, SPECIES_VULPIX_ALOLA, SPECIES_LAPRAS, SPECIES_CUBCHOO, SPECIES_SNOVER, SPECIES_SWINUB
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Psychic::
	randomelement SPECIES_NATU, SPECIES_SOLOSIS, SPECIES_GOTHITA, SPECIES_ORICORIO_PAU, SPECIES_PONYTA_GALARIAN, SPECIES_RALTS, SPECIES_WOOBAT, SPECIES_FLITTLE, SPECIES_BALTOY, SPECIES_BRONZOR, SPECIES_CHINGLING, SPECIES_MEDITITE, SPECIES_DROWZEE, SPECIES_MUNNA, SPECIES_ORANGURU, SPECIES_BRUXISH, SPECIES_GIRAFARIG
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
