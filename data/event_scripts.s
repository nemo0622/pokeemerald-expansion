...
MysteryGift_EventScript_Monotype_Dragon::
	randomelement SPECIES_TYRUNT, SPECIES_BAGON, SPECIES_GOOMY, SPECIES_DRATINI, SPECIES_APPLIN, SPECIES_JANGMO_O
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Fighting::
	randomelement SPECIES_FALINKS, SPECIES_TIMBURR, SPECIES_HERACROSS, SPECIES_MIENFOO, SPECIES_SNEASEL_HISUI, SPECIES_STUFFUL, SPECIES_CRABRAWLER, SPECIES_MEDITITE, SPECIES_PANCHAM, SPECIES_SCRAGGY, SPECIES_PASSIMIAN, SPECIES_MANKEY, SPECIES_FLAMIGO
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Fire::
	randomelement SPECIES_LITWICK, SPECIES_CHARCADET, SPECIES_FUECOCO, SPECIES_LITTEN, SPECIES_PONYTA, SPECIES_FENNEKIN, SPECIES_PANSEAR, SPECIES_ORICORIO_BAILE, SPECIES_VULPIX, SPECIES_SALANDIT, SPECIES_HOUNDOUR, SPECIES_TORKOAL, SPECIES_NUMEL, SPECIES_GROWLITHE_HISUI, SPECIES_CYNDAQUIL, SPECIES_SIZZLIPEDE
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Flying::
	randomelement SPECIES_TROPIUS, SPECIES_NATU, SPECIES_WINGULL, SPECIES_GLIGAR, SPECIES_ORICORIO_BAILE, SPECIES_CHATOT, SPECIES_ORICORIO_PAU, SPECIES_ORICORIO_POM_POM, SPECIES_ORICORIO_SENSU, SPECIES_ROWLET, SPECIES_PIKIPEK, SPECIES_DUCKLETT, SPECIES_HOPPIP, SPECIES_MURKROW, SPECIES_VULLABY, SPECIES_WOOBAT, SPECIES_HOOTHOOT, SPECIES_MINIOR, SPECIES_SCYTHER, SPECIES_DODUO, SPECIES_SWABLU, SPECIES_YANMA, SPECIES_AERODACTYL, SPECIES_RUFFLET, SPECIES_ARCHEN, SPECIES_FLAMIGO
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
