...
MysteryGift_EventScript_Monotype_Flying::
	randomelement SPECIES_NATU, SPECIES_WINGULL, SPECIES_GLIGAR, SPECIES_ORICORIO_BAILE, SPECIES_CHATOT, SPECIES_ORICORIO_PAU, SPECIES_ORICORIO_POM_POM, SPECIES_ORICORIO_SENSU, SPECIES_ROWLET, SPECIES_PIKIPEK, SPECIES_DUCKLETT, SPECIES_HOPPIP, SPECIES_MURKROW, SPECIES_VULLABY, SPECIES_WOOBAT, SPECIES_HOOTHOOT, SPECIES_MINIOR, SPECIES_SCYTHER, SPECIES_DODUO, SPECIES_SWABLU, SPECIES_YANMA, SPECIES_AERODACTYL, SPECIES_RUFFLET, SPECIES_ARCHEN
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
...
MysteryGift_EventScript_Monotype_Steel::
	randomelement SPECIES_CUFANT, SPECIES_MAWILE, SPECIES_ARON, SPECIES_HONEDGE, SPECIES_BRONZOR, SPECIES_MEOWTH_GALAR, SPECIES_TOGEDEMARU, SPECIES_TINKATINK, SPECIES_MAGNEMITE, SPECIES_PAWNIARD
	bufferspeciesname STR_VAR_1, VAR_RESULT
	setvar VAR_TEMP_TRANSFERRED_SPECIES, VAR_RESULT
	givemon VAR_RESULT, 5
	call MysteryGift_EventScript_ReceivedMon
