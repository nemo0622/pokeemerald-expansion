...
#define RP_CONFIG_USE_ROTOM_PHONE         TRUE              // Ctrl+F replaced in rotom_start_menu.c with `FlagGet(FLAG_SYS_POKEDEX_GET)`
#define RP_CONFIG_MONOCHROME_ICONS        FALSE
#define RP_CONFIG_PALETTE_BUFFER          FALSE
#define RP_CONFIG_ROTOM_REALITY_SHORTCUT  FALSE
#define RP_CONFIG_24_HOUR_MODE            FALSE
#define RP_CONFIG_NUM_MINUTES_TO_UPDATE   4
