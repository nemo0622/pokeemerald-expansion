...
extern const u32 gMessageBox_Nameplate_Gfx[];
...
extern const u32 gDecorIcon_EntertainmentCenter[];
extern const u32 gDecorIconPalette_EntertainmentCenter[];
extern const u32 gDecorIcon_PokeballStation[];
extern const u32 gDecorIconPalette_PokeballStation[];
extern const u32 gDecorIcon_Shrine[];
extern const u32 gDecorIconPalette_Shrine[];
extern const u32 gDecorIcon_Slide[];
extern const u32 gDecorIconPalette_Slide[];
extern const u32 gDecorIcon_Fossil_Display[];
extern const u32 gDecorIconPalette_Fossil_Display[];
...
extern const u32 gDecorIcon_SmallFlowerBox[];
extern const u32 gDecorIconPalette_SmallFlowerBox[];
extern const u32 gDecorIcon_LargeBed[];
extern const u32 gDecorIconPalette_LargeBed[];
extern const u32 gDecorIcon_PatternedBed[];
extern const u32 gDecorIconPalette_PatternedBed[];
extern const u32 gDecorIcon_BookAndQuill[];
extern const u32 gDecorIconPalette_BookAndQuill[];
extern const u32 gDecorIcon_DollSquare[];
extern const u32 gDecorIconPalette_DollSquare[];
...
extern const u32 gBattleTerrainPalette_TallGrass[]; // day palette
extern const u32 gBattleTerrainPalette_Twilight_TallGrass[]; // morning/evening palette
extern const u32 gBattleTerrainPalette_Night_TallGrass[]; // night palette
extern const u32 gBattleTerrainPalette_TallGrass_Orange[];
extern const u32 gBattleTerrainPalette_Twilight_TallGrass_Orange[];
extern const u32 gBattleTerrainPalette_Night_TallGrass_Orange[];
...
extern const u32 gBattleTerrainPalette_Twilight_LongGrass[];
extern const u32 gBattleTerrainPalette_Night_LongGrass[];
...
extern const u32 gBattleTerrainPalette_Twilight_Sand[];
extern const u32 gBattleTerrainPalette_Night_Sand[];
...
extern const u32 gBattleTerrainPalette_Underwater[]; // no time of day differences
...
extern const u32 gBattleTerrainPalette_Twilight_Water[];
extern const u32 gBattleTerrainPalette_Night_Water[];
...
extern const u32 gBattleTerrainPalette_Twilight_PondWater[];
extern const u32 gBattleTerrainPalette_Night_PondWater[];
...
extern const u32 gBattleTerrainPalette_Twilight_Rock[];
extern const u32 gBattleTerrainPalette_Night_Rock[];
...
extern const u32 gBattleTerrainPalette_Cave[]; // no time of day difference
...
extern const u32 gBattleTerrainPalette_Building[]; // no time of day difference
extern const u32 gBattleTerrainPalette_Plain[]; // no time of day difference
extern const u32 gBattleTerrainPalette_Frontier[]; // no time of day difference
...
extern const u32 gBattleTerrainPalette_BuildingGym[]; // no time of day difference
extern const u32 gBattleTerrainPalette_BuildingLeader[]; // no time of day difference
...
extern const u32 gItemIcon_Centiskite[];
extern const u32 gItemIconPalette_Centiskite[];
...
extern const u32 gItemIconPalette_Copperajite[];
extern const u32 gItemIcon_Dragoniteite[];
extern const u32 gItemIconPalette_Dragoniteite[];
extern const u32 gItemIcon_Noctowlite[];
extern const u32 gItemIconPalette_Noctowlite[];
extern const u32 gItemIcon_Flygonite[];
extern const u32 gItemIconPalette_Flygonite[];
extern const u32 gItemIcon_Archeopsite[];
extern const u32 gItemIconPalette_Archeopsite[];
extern const u32 gItemIcon_Mandibite[];
extern const u32 gItemIconPalette_Mandibite[];
extern const u32 gItemIcon_Gogoatite[];
extern const u32 gItemIconPalette_Gogoatite[];
extern const u32 gItemIcon_Pangorite[];
extern const u32 gItemIconPalette_Pangorite[];
extern const u32 gItemIcon_Heliolite[];
extern const u32 gItemIconPalette_Heliolite[];
extern const u32 gItemIcon_Toucannonite[];
extern const u32 gItemIconPalette_Toucannonite[];
extern const u32 gItemIcon_Ribombite[];
extern const u32 gItemIconPalette_Ribombite[];
extern const u32 gItemIcon_Wyrdeerite[];
extern const u32 gItemIconPalette_Wyrdeerite[];
extern const u32 gItemIcon_Tinkatite[];
extern const u32 gItemIconPalette_Tinkatite[];
extern const u32 gItemIcon_Cyclizite_S[];
...
extern const u16 gObjectEventPal_Outfit_Zookeeper[];
extern const u16 gObjectEventPal_Outfit_Traditional[];
extern const u16 gObjectEventPal_Outfit_East_Blue[];
...
extern const u16 gObjectEventPal_Outfit_Johto[];
extern const u16 gObjectEventPal_Outfit_Alola[];
extern const u16 gObjectEventPal_Outfit_Paldea[];
extern const u16 gObjectEventPal_Outfit_Hylian[];
...
extern const u32 gTrainerFrontPic_Outfit_Zookeeper_M[];
extern const u32 gTrainerPalette_Outfit_Zookeeper_M[];
extern const u32 gTrainerFrontPic_Outfit_Zookeeper_F[];
extern const u32 gTrainerPalette_Outfit_Zookeeper_F[];
extern const u32 gTrainerFrontPic_Outfit_Traditional_M[];
extern const u32 gTrainerPalette_Outfit_Traditional_M[];
extern const u32 gTrainerFrontPic_Outfit_Traditional_F[];
extern const u32 gTrainerPalette_Outfit_Traditional_F[];
extern const u32 gTrainerFrontPic_Outfit_East_Blue_M[];
extern const u32 gTrainerPalette_Outfit_East_Blue_M[];
extern const u32 gTrainerFrontPic_Outfit_East_Blue_F[];
extern const u32 gTrainerPalette_Outfit_East_Blue_F[];
extern const u32 gTrainerFrontPic_Outfit_Coral_M[];
extern const u32 gTrainerPalette_Outfit_Coral_M[];
extern const u32 gTrainerFrontPic_Outfit_Coral_F[];
extern const u32 gTrainerPalette_Outfit_Coral_F[];
extern const u32 gTrainerFrontPic_Outfit_Tropics_M[];
extern const u32 gTrainerPalette_Outfit_Tropics_M[];
extern const u32 gTrainerFrontPic_Outfit_Tropics_F[];
extern const u32 gTrainerPalette_Outfit_Tropics_F[];
extern const u32 gTrainerFrontPic_Outfit_Old_Sofos_M[];
...
extern const u32 gTrainerFrontPic_Outfit_Johto_M[];
extern const u32 gTrainerPalette_Outfit_Johto_M[];
extern const u32 gTrainerFrontPic_Outfit_Johto_F[];
extern const u32 gTrainerPalette_Outfit_Johto_F[];
extern const u32 gTrainerFrontPic_Outfit_Alola_M[];
extern const u32 gTrainerPalette_Outfit_Alola_M[];
extern const u32 gTrainerFrontPic_Outfit_Alola_F[];
extern const u32 gTrainerPalette_Outfit_Alola_F[];
extern const u32 gTrainerFrontPic_Outfit_Paldea_M[];
extern const u32 gTrainerPalette_Outfit_Paldea_M[];
extern const u32 gTrainerFrontPic_Outfit_Paldea_F[];
extern const u32 gTrainerPalette_Outfit_Paldea_F[];
extern const u32 gTrainerFrontPic_Outfit_Hylian_M[];
extern const u32 gTrainerPalette_Outfit_Hylian_M[];
extern const u32 gTrainerFrontPic_Outfit_Hylian_F[];
extern const u32 gTrainerPalette_Outfit_Hylian_F[];
