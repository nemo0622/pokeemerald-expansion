...
#define FLAG_HIDDEN_ITEM_BRONZE_PASS_NORTH_STARDUST          (FLAG_HIDDEN_ITEMS_START + 0x00)
#define FLAG_HIDDEN_ITEM_BRONZE_PASS_NORTH_ULTRA_BALL        (FLAG_HIDDEN_ITEMS_START + 0x01)
...
#define FLAG_ITEM_PENTEPETAL_LOVE_BALL                              0x414
#define FLAG_ITEM_VULCAI_SEA_RAZOR_FANG                             0x415
#define FLAG_ITEM_WANDERERS_WOODS_S_SUPER_POTION                    0x416
#define FLAG_ITEM_WANDERERS_WOODS_RAZOR_FANG                        0x417
...
#define FLAG_UNLOCKED_MEGA_EVOLUTION                              0x49F // Used to indicate to certain menus that tera is unlocked, and to signal that tera unlock event happened
...
#define FLAG_SYS_ROTOM_PHONE_GET                     (SYSTEM_FLAGS + 0x2)
...
#define FLAG_INVISIBLE_DAY_NIGHT_CYCLE              (SYSTEM_FLAGS + 0x25) // Whether day/night cycle is visible (toggled ON by default in new_game.inc)
...
#define FLAG_SYS_REGIROCK_PUZZLE_COMPLETED          (SYSTEM_FLAGS + 0x50) // 0x910
