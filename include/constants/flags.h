...
#define FLAG_EXP_SHARE       0x20 // EXP Share Flag
...
#define FLAG_RECEIVED_Z_RING                 0x110
...
// Mystery Gift Flags, used by mystery code thing
...
#define FLAG_EGG_MOVES_TUTOR  0x2A1 // Enable/disable egg move tutor
...
#define FLAG_SYS_DISABLE_BATTLE_BG                   (SYSTEM_FLAGS + 0x3) // Enable/Disable battle backgrounds
...
#define FLAG_IS_CHAMPION                            (SYSTEM_FLAGS + 0x1F) // Seems to be related to linking. (0x87F i think)
