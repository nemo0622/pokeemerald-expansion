...
// If it's on the player's side, it also requires ITEM_KEY_STONE in the user's bag and for the player to trigger it by pressing START before selecting a move.
// param1: item to hold.
