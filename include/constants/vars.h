...
#define VAR_STARTER_MON                                  0x4023 // Set to Species ID of Pokémon chosen
...
#define VAR_BERRY_TREES_PLANTED                          0x4052 // berry trees planted count
#define VAR_LAVARIDGE_TOWN_STATE                         0x4053
#define VAR_CURRENT_SECRET_BASE                          0x4054 // was probably allocated for VAR_FALLARBOR_TOWN_STATE at one point
#define VAR_CHOSEN_SAIL_LOCATION                         0x4055 // place player chooses to sail to with PIRAEUS
...
#define VAR_TIMES_MINED                                  0x405C // Times done mining minigame
...
#define VAR_RANIA_STATE                                  0x40FF // Tracks Player's relationship with Rania
