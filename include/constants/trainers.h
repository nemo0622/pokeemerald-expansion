...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_ALOLA_YOUNGSTER,
    TRAINER_PIC_FRONT_ALOLA_LASS,
    TRAINER_PIC_FRONT_ALOLA_SCHOOL_KID_M,
    TRAINER_PIC_FRONT_ALOLA_SCHOOL_KID_F,
    TRAINER_PIC_FRONT_ALOLA_BUG_CATCHER_M,
    TRAINER_PIC_FRONT_ALOLA_BUG_CATCHER_F,
    TRAINER_PIC_FRONT_ALOLA_SWIMMER_M,
    TRAINER_PIC_FRONT_ALOLA_SWIMMER_F,
    TRAINER_PIC_FRONT_ALOLA_SIGHTSEER_M,
    TRAINER_PIC_FRONT_ALOLA_SIGHTSEER_F,
    TRAINER_PIC_FRONT_ALOLA_DANCER_M,
    TRAINER_PIC_FRONT_ALOLA_DANCER_F,
    TRAINER_PIC_FRONT_ALOLA_PUNK_ROCKER_M,
    TRAINER_PIC_FRONT_ALOLA_PUNK_ROCKER_F,
    TRAINER_PIC_FRONT_ALOLA_SINGER, // Inspired by Iz Kamakawiwo'ole
    TRAINER_PIC_FRONT_ALOLA_RISING_STAR_M,
    TRAINER_PIC_FRONT_ALOLA_RISING_STAR_F,
    TRAINER_PIC_FRONT_ALOLA_ACE_TRAINER_M,
    TRAINER_PIC_FRONT_ALOLA_ACE_TRAINER_F,
    TRAINER_PIC_FRONT_ALOLA_FISHERMAN,
    TRAINER_PIC_FRONT_ALOLA_GENTLEMAN,
    TRAINER_PIC_FRONT_ALOLA_LADY,
    TRAINER_PIC_FRONT_ALOLA_FARMER_M,
    TRAINER_PIC_FRONT_ALOLA_FARMER_F,
    TRAINER_PIC_FRONT_ALOLA_AETHER_FOUNDATION_M,
    TRAINER_PIC_FRONT_ALOLA_AETHER_FOUNDATION_F,
    TRAINER_PIC_FRONT_ALOLA_TEAM_SKULL_M,
    TRAINER_PIC_FRONT_ALOLA_TEAM_SKULL_F,
    TRAINER_PIC_FRONT_ALOLA_HIKER,
    TRAINER_PIC_FRONT_ALOLA_BACKPACKER,
    TRAINER_PIC_FRONT_ALOLA_SAILOR_M,
    TRAINER_PIC_FRONT_ALOLA_SAILOR_F,
    TRAINER_PIC_FRONT_ALOLA_CAMPER,
    TRAINER_PIC_FRONT_ALOLA_PICNICKER,
    TRAINER_PIC_FRONT_ALOLA_BLACK_BELT,
    TRAINER_PIC_FRONT_ALOLA_BATTLE_GIRL,
    TRAINER_PIC_FRONT_ALOLA_BREEDER_M,
    TRAINER_PIC_FRONT_ALOLA_BREEDER_F,
    TRAINER_PIC_FRONT_ALOLA_BIRD_KEEPER,
    TRAINER_PIC_FRONT_ALOLA_VETERAN_M,
    TRAINER_PIC_FRONT_ALOLA_VETERAN_F,
    TRAINER_PIC_FRONT_ALOLA_BELLHOP,
    TRAINER_PIC_FRONT_ALOLA_COLLECTOR,
    TRAINER_PIC_FRONT_ALOLA_OFFICE_WORKER_M,
    TRAINER_PIC_FRONT_ALOLA_OFFICE_WORKER_F,
    TRAINER_PIC_FRONT_ALOLA_BIKER,
    TRAINER_PIC_FRONT_ALOLA_JESTER,
    TRAINER_PIC_FRONT_ALOLA_BEAUTY,
    TRAINER_PIC_FRONT_ALOLA_PILOT,
    TRAINER_PIC_FRONT_ALOLA_ARTIST,
    TRAINER_PIC_FRONT_ALOLA_PSYCHIC,
    TRAINER_PIC_FRONT_ALOLA_HEX_MANIAC,
    TRAINER_PIC_FRONT_ALOLA_RANGER_M,
    TRAINER_PIC_FRONT_ALOLA_RANGER_F,
    TRAINER_PIC_FRONT_ALOLA_SCIENTIST_M,
    TRAINER_PIC_FRONT_ALOLA_SCIENTIST_F,
    TRAINER_PIC_FRONT_ALOLA_KUPUNA_M, // Word for "Elder" in Hawaiian
    TRAINER_PIC_FRONT_ALOLA_KUPUNA_F, // Word for "Elder" in Hawaiian
    TRAINER_PIC_FRONT_ALOLA_SURFER,
    ...
    TRAINER_PIC_FRONT_ALOLA_RYUKI,
    TRAINER_PIC_FRONT_ALOLA_MINA,
    TRAINER_PIC_FRONT_ALOLA_HAPU,
    TRAINER_PIC_FRONT_ALOLA_KUKUI,
    TRAINER_PIC_FRONT_ALOLA_BURNET,
    TRAINER_PIC_FRONT_ALOLA_HAU,
    TRAINER_PIC_FRONT_ALOLA_LILLIE,
    TRAINER_PIC_FRONT_ALOLA_GLADION,
...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_ALOLA_YOUNGSTER,
    TRAINER_CLASS_ALOLA_LASS,
    TRAINER_CLASS_ALOLA_SCHOOL_KID, // Replaces SM/USUM Preschooler, because come on now lets be fr
    TRAINER_CLASS_ALOLA_BUG_CATCHER,
    TRAINER_CLASS_ALOLA_SWIMMER,
    TRAINER_CLASS_ALOLA_SIGHTSEER,
    TRAINER_CLASS_ALOLA_DANCER, // Can be M or F
    TRAINER_CLASS_ALOLA_PUNK_ROCKER, // Replaces Punk Guy/Girl
    TRAINER_CLASS_ALOLA_SINGER, // Inspired by Iz Kamakawiwo'ole
    TRAINER_CLASS_ALOLA_RISING_STAR,
    TRAINER_CLASS_ALOLA_ACE_TRAINER,
    TRAINER_CLASS_ALOLA_FISHERMAN,
    TRAINER_CLASS_ALOLA_GENTLEMAN,
    TRAINER_CLASS_ALOLA_LADY,
    TRAINER_CLASS_ALOLA_FARMER,
    TRAINER_CLASS_ALOLA_AETHER_FOUNDATION,
    TRAINER_CLASS_ALOLA_TEAM_SKULL,
    TRAINER_CLASS_ALOLA_HIKER,
    TRAINER_CLASS_ALOLA_BACKPACKER,
    TRAINER_CLASS_ALOLA_SAILOR,
    TRAINER_CLASS_ALOLA_CAMPER,
    TRAINER_CLASS_ALOLA_PICNICKER,
    TRAINER_CLASS_ALOLA_BLACK_BELT,
    TRAINER_CLASS_ALOLA_BATTLE_GIRL,
    TRAINER_CLASS_ALOLA_BREEDER,
    TRAINER_CLASS_ALOLA_BIRD_KEEPER,
    TRAINER_CLASS_ALOLA_VETERAN,
    TRAINER_CLASS_ALOLA_BELLHOP,
    TRAINER_CLASS_ALOLA_COLLECTOR,
    TRAINER_CLASS_ALOLA_OFFICE_WORKER, // Also used to Alola Leo Teacher
    TRAINER_CLASS_ALOLA_BIKER,
    TRAINER_CLASS_ALOLA_JESTER,
    TRAINER_CLASS_ALOLA_BEAUTY,
    TRAINER_CLASS_ALOLA_PILOT,
    TRAINER_CLASS_ALOLA_ARTIST,
    TRAINER_CLASS_ALOLA_PSYCHIC,
    TRAINER_CLASS_ALOLA_HEX_MANIAC,
    TRAINER_CLASS_ALOLA_RANGER, // Based on Park Rangers (many National Parks in Hawai'i)
    TRAINER_CLASS_ALOLA_SCIENTIST,
    TRAINER_CLASS_ALOLA_KUPUNA, // Word for "Elder" in Hawaiian
    TRAINER_CLASS_ALOLA_TRIAL_CAPTAIN,
    TRAINER_CLASS_ALOLA_KAHUNA,
    TRAINER_CLASS_ALOLA_PROFESSOR,
