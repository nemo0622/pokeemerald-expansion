...
#define FLAG_HIDE_LILLIE_ALOLA_LEO_SCHOOL              0
#define FLAG_GOT_QUICK_CLAW_TRAINER_SCHOOL          0
#define FLAG_HIDE_LILLIE_ALOLA_LEO_SCHOOL_2          0
#define FLAG_HIDE_LILLIE_INSIDE_SCHOOL          0
#define FLAG_HIDE_TAUROS_ALOLA_LEO               0
#define FLAG_HIDE_PICNICKER_HAUOLI_BEACHFRONT                0
#define FLAG_HIDE_MAREANIE_HAUOLI_BEACHFRONT                    0
...
#define FLAG_UNLOCKED_POKERIDE_TAUROS                           0
#define FLAG_UNLOCKED_POKERIDE_STOUTLAND                           0
#define FLAG_UNLOCKED_POKERIDE_LAPRAS                           0
#define FLAG_UNLOCKED_POKERIDE_DRAMPA                           0
#define FLAG_UNLOCKED_POKERIDE_FLYGON                           0
#define FLAG_UNLOCKED_POKERIDE_BEWEAR                           0
