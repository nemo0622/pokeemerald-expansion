...
#define OLD_ROD_BAR_WIDTH               48   // Default pixel width of the fishing bar. Cannot be below 33 or above 64.
#define GOOD_ROD_BAR_WIDTH              56   // Fishing bar pixel width for the Good Rod. FG_BAR_WIDTH_FROM_ROD_TYPE must be TRUE. Cannot be below 33 or above 64.
#define SUPER_ROD_BAR_WIDTH             64   // Fishing bar pixel width for the Super Rod. FG_BAR_WIDTH_FROM_ROD_TYPE must be TRUE. Cannot be below 33 or above 64.
...
#define TREASURE_TIME_GOAL              120  // Number of frames inside the fishing bar required to claim the treasure. Must be divisible by TREASURE_INCREMENT.
#define TREASURE_INCREMENT              15   // Height of full treasure score meter in pixels.
#define TREASURE_ICON_WIDTH             32
#define TREASURE_SPAWN_MIN              70  // Minimum number of frames before treasure can spawn.
#define TREASURE_SPAWN_MAX              170  // Maximum number of frames before treasure can spawn.
