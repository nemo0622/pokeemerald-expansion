...
extern const u8 gText_MenuRotomPhone[];
...
extern const u8 gText_ArcanineDoll128BP[];
extern const u8 gText_RaikouDoll256BP[];
extern const u8 gText_EnteiDoll256BP[];
extern const u8 gText_SuicuneDoll256BP[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_ArchenDollDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_ImpidimpDollDesc[];
...
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_Performer_MIntro[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_Performer_MMon1[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_Performer_MMon2Ask[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_Performer_MAccept[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_Performer_MReject[];
...
extern const u8 gText_LevelCapsSetting[];
extern const u8 gText_LevelCapsSetting_On[];
extern const u8 gText_LevelCapsSetting_Off[];
...
extern const u8 gText_SideQuestName_45[];
extern const u8 gText_SideQuestName_46[];
extern const u8 gText_SideQuestName_47[];
extern const u8 gText_SideQuestName_48[];
extern const u8 gText_SideQuestName_49[];
extern const u8 gText_SideQuestName_50[];
extern const u8 gText_SideQuestName_51[];
extern const u8 gText_SideQuestName_52[];
extern const u8 gText_SideQuestName_53[];
extern const u8 gText_SideQuestName_54[];
...
extern const u8 gText_SideQuestName_63[];
extern const u8 gText_SideQuestName_64[];
extern const u8 gText_SideQuestName_65[];
extern const u8 gText_SideQuestName_66[];
extern const u8 gText_SideQuestName_67[];
extern const u8 gText_SideQuestName_68[];
...
extern const u8 gText_SideQuestDesc_45[];
extern const u8 gText_SideQuestDesc_46[];
extern const u8 gText_SideQuestDesc_47[];
extern const u8 gText_SideQuestDesc_48[];
extern const u8 gText_SideQuestDesc_49[];
extern const u8 gText_SideQuestDesc_50[];
extern const u8 gText_SideQuestDesc_51[];
extern const u8 gText_SideQuestDesc_52[];
extern const u8 gText_SideQuestDesc_53[];
extern const u8 gText_SideQuestDesc_54[];
...
extern const u8 gText_SideQuestDesc_63[];
extern const u8 gText_SideQuestDesc_64[];
extern const u8 gText_SideQuestDesc_65[];
extern const u8 gText_SideQuestDesc_66[];
extern const u8 gText_SideQuestDesc_67[];
extern const u8 gText_SideQuestDesc_68[];
...
extern const u8 gText_SideQuestMap45[];
extern const u8 gText_SideQuestMap46[];
extern const u8 gText_SideQuestMap47[];
extern const u8 gText_SideQuestMap48[];
extern const u8 gText_SideQuestMap49[];
extern const u8 gText_SideQuestMap50[];
extern const u8 gText_SideQuestMap51[];
extern const u8 gText_SideQuestMap52[];
extern const u8 gText_SideQuestMap53[];
extern const u8 gText_SideQuestMap54[];
...
extern const u8 gText_SideQuestMap63[];
extern const u8 gText_SideQuestMap64[];
extern const u8 gText_SideQuestMap65[];
extern const u8 gText_SideQuestMap66[];
extern const u8 gText_SideQuestMap67[];
extern const u8 gText_SideQuestMap68[];
