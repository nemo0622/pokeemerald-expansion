...
#define B_SMART_WILD_AI_FLAG        FLAG_SMART_WILD_MONS     // If this flag is set, wild Pokémon will become smart, with all AI flags enabled.
#define B_FLAG_NO_CATCHING          FLAG_PREVENT_CATCHING    // If this flag is set, the ability to catch wild Pokémon is disabled.
#define B_FLAG_NO_RUNNING           FLAG_PREVENT_RUNNING     // If this flag is set, the ability to escape from wild battles is disabled. Also makes Roar/Whirlwind and Teleport (under Gen8) fail.
