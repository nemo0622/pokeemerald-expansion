...
#define I_SHINY_CHARM_ADDITIONAL_ROLLS  4           // (DEFAULT: 2) Amount of additional shiny rolls if the player has the Shiny Charm. Set it to 0 to disable Shiny Charm's effects.
