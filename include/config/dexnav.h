...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_SYS_DEXNAV_GET // Searching for mon
#define DN_FLAG_DEXNAV_GET            FLAG_SYS_DEXNAV_SEARCH // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_DEXNAV_DETECTOR_MODE // Allow player to find hidden mons
#define DN_VAR_SPECIES                VAR_DEXNAV_SPECIES_TARGET // Registered DexNav species
