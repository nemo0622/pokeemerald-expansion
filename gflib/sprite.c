...
// static void RequestSpriteFrameImageCopy(u16 index, u16 tileNum, const struct SpriteFrameImage *images); // moved to sprite.h
...
// static void SetSpriteOamFlipBits(struct Sprite *sprite, u8 hFlip, u8 vFlip); // moved to sprite.h
