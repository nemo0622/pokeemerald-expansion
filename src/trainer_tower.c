...
static const struct SinglesTrainerInfo sSingleBattleTrainerInfo[] = {
    ...
    // {OBJ_EVENT_GFX_GEN3_WOMAN_1_FRLG,   FACILITY_CLASS_SCHOOL_KID_F,      FEMALE},
    // {OBJ_EVENT_GFX_BALDING_MAN,    FACILITY_CLASS_POKEFAN_M,           MALE},
    // {OBJ_EVENT_GFX_GEN3_WOMAN_3_FRLG,   FACILITY_CLASS_POKEFAN_F,         FEMALE},
    // {OBJ_EVENT_GFX_GEN3_OLD_MAN_1,      FACILITY_CLASS_EXPERT_M,            MALE},
    // {OBJ_EVENT_GFX_GEN3_OLD_WOMAN_FRLG, FACILITY_CLASS_EXPERT_F,          FEMALE},
    // {OBJ_EVENT_GFX_COOLTRAINER_M,  FACILITY_CLASS_DRAGON_TAMER,        MALE},
    // {OBJ_EVENT_GFX_GEN3_LITTLE_BOY_FRLG, FACILITY_CLASS_NINJA_BOY,           MALE},
    // {OBJ_EVENT_GFX_BATTLE_GIRL,    FACILITY_CLASS_BATTLE_GIRL,       FEMALE},
    // {OBJ_EVENT_GFX_GEN3_BEAUTY_FRLG,    FACILITY_CLASS_PARASOL_LADY,      FEMALE},
    // {OBJ_EVENT_GFX_GEN3_FAT_MAN_FRLG,   FACILITY_CLASS_COLLECTOR,           MALE},
    // {OBJ_EVENT_GFX_GEN3_YOUNGSTER_FRLG, FACILITY_CLASS_YOUNGSTER_FRLG,           MALE},
    // {OBJ_EVENT_GFX_GEN3_BUG_CATCHER_FRLG, FACILITY_CLASS_BUG_CATCHER_FRLG,         MALE},
    // {OBJ_EVENT_GFX_GEN3_LASS_FRLG,      FACILITY_CLASS_LASS_FRLG,              FEMALE},
    // {OBJ_EVENT_GFX_GEN3_SAILOR_FRLG,    FACILITY_CLASS_SAILOR_FRLG,              MALE},
    // {OBJ_EVENT_GFX_GEN3_CAMPER_FRLG,    FACILITY_CLASS_CAMPER_FRLG,              MALE},
    // {OBJ_EVENT_GFX_GEN3_PICNICKER_FRLG, FACILITY_CLASS_PICNICKER_FRLG,         FEMALE},
    // {OBJ_EVENT_GFX_SUPER_NERD,     FACILITY_CLASS_POKEMANIAC,          MALE},
    // {OBJ_EVENT_GFX_SUPER_NERD,     FACILITY_CLASS_SUPER_NERD_FRLG,          MALE},
    // {OBJ_EVENT_GFX_GEN3_HIKER_FRLG,     FACILITY_CLASS_HIKER_FRLG,               MALE},
    ...
    // {OBJ_EVENT_GFX_GEN3_SWIMMER_M_LAND, FACILITY_CLASS_SWIMMER_M_FRLG,           MALE},
    // {OBJ_EVENT_GFX_BIKER,          FACILITY_CLASS_CUE_BALL_FRLG,            MALE},
    // {OBJ_EVENT_GFX_GEN3_BEAUTY_FRLG,    FACILITY_CLASS_BEAUTY_FRLG,            FEMALE},
    // {OBJ_EVENT_GFX_GEN3_SWIMMER_F_LAND, FACILITY_CLASS_SWIMMER_F_FRLG,         FEMALE},
    ...
    // {OBJ_EVENT_GFX_GEN3_GENTLEMAN,      FACILITY_CLASS_GENTLEMAN_FRLG,           MALE},
    // {OBJ_EVENT_GFX_GEN3_WOMAN_1_FRLG,   FACILITY_CLASS_PSYCHIC_F_FRLG,         FEMALE},
    // {OBJ_EVENT_GFX_BATTLE_GIRL,    FACILITY_CLASS_CRUSH_GIRL_FRLG,        FEMALE},
    // {OBJ_EVENT_GFX_GEN3_TUBER_F_FRLG,   FACILITY_CLASS_TUBER_FRLG,             FEMALE},
    // {OBJ_EVENT_GFX_GEN3_WOMAN_2_FRLG,   FACILITY_CLASS_PKMN_BREEDER_FRLG,      FEMALE},
    // {OBJ_EVENT_GFX_GEN3_CAMPER_FRLG,    FACILITY_CLASS_PKMN_RANGER_M_FRLG,       MALE},
    // {OBJ_EVENT_GFX_GEN3_PICNICKER_FRLG, FACILITY_CLASS_PKMN_RANGER_F_FRLG,     FEMALE},
    // {OBJ_EVENT_GFX_GEN3_WOMAN_2_FRLG,   FACILITY_CLASS_AROMA_LADY_FRLG,        FEMALE},
    // {OBJ_EVENT_GFX_GEN3_HIKER_FRLG,     FACILITY_CLASS_RUIN_MANIAC,         MALE},
    // {OBJ_EVENT_GFX_GEN3_WOMAN_2_FRLG,   FACILITY_CLASS_LADY_FRLG,              FEMALE}
};

static const struct DoublesTrainerInfo sDoubleBattleTrainerInfo[] = {
    // {OBJ_EVENT_GFX_GEN3_BEAUTY_FRLG,    OBJ_EVENT_GFX_GEN3_WOMAN_1_FRLG,   FACILITY_CLASS_SR_AND_JR,       FEMALE, FEMALE},
    // {OBJ_EVENT_GFX_GEN3_OLD_MAN_1,      OBJ_EVENT_GFX_GEN3_OLD_WOMAN_FRLG, FACILITY_CLASS_OLD_COUPLE,        MALE, FEMALE},
    // {OBJ_EVENT_GFX_GEN3_LITTLE_GIRL_FRLG, OBJ_EVENT_GFX_GEN3_LITTLE_GIRL_FRLG,    FACILITY_CLASS_TWINS_FRLG,           FEMALE, FEMALE},
    // {OBJ_EVENT_GFX_COOLTRAINER_M,  OBJ_EVENT_GFX_COOLTRAINER_F,  FACILITY_CLASS_COOL_COUPLE_FRLG,       MALE, FEMALE},
    // {OBJ_EVENT_GFX_GEN3_BEAUTY_FRLG,    OBJ_EVENT_GFX_MAN,            FACILITY_CLASS_YOUNG_COUPLE_FRLG,    FEMALE,   MALE},
    // {OBJ_EVENT_GFX_BATTLE_GIRL,    OBJ_EVENT_GFX_BLACKBELT,      FACILITY_CLASS_CRUSH_KIN_FRLG,       FEMALE,   MALE},
    // {OBJ_EVENT_GFX_GEN3_SWIMMER_F_LAND, OBJ_EVENT_GFX_GEN3_TUBER_M_LAND,   FACILITY_CLASS_SIS_AND_BRO_FRLG,     FEMALE,   MALE}
};
...
static void SetTrainerTowerNPCGraphics(void)
{
    ...
    case CHALLENGE_TYPE_SINGLE:
        ...
        if (i != NELEMS(sSingleBattleTrainerInfo))
            ...
            trainerGfx1 = OBJ_EVENT_GFX_GEN3_YOUNGSTER;
    ...
    case CHALLENGE_TYPE_DOUBLE:
        ...
        {
            trainerGfx1  = OBJ_EVENT_GFX_GEN3_YOUNGSTER;
            trainerGfx2 = OBJ_EVENT_GFX_GEN3_YOUNGSTER;
        }
