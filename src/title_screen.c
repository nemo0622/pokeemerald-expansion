...
static const u32 sTitleScreenRayquazaGfx[] = INCBIN_U32("graphics/title_screen/EmeraldSeaglassTilemap.4bpp.lz");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/EmeraldSeaglassBin.bin.lz");
...
static void Task_TitleScreenPhase2(u8 taskId)
{
    ...
    else
    {
        ...
        CreateSprite(&sStarter1SpriteTemplate, 194, 105, 0);
        CreateSprite(&sStarter2SpriteTemplate, 122, 105, 0);
        CreateSprite(&sStarter3SpriteTemplate, 50, 105, 0);
