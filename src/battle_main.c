...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_ALOLA_YOUNGSTER] =                 { _("Youngster"), 4 },
    [TRAINER_CLASS_ALOLA_LASS] =                      { _("Lass"), 4 },
    [TRAINER_CLASS_ALOLA_SCHOOL_KID] =                { _("School Kid"), 5 },
    [TRAINER_CLASS_ALOLA_BUG_CATCHER] =               { _("Bug Catcher"), 3 },
    [TRAINER_CLASS_ALOLA_SWIMMER] =                   { _("Swimmer"), 2, BALL_DIVE },
    [TRAINER_CLASS_ALOLA_SIGHTSEER] =                 { _("Sightseer"), 6 },
    [TRAINER_CLASS_ALOLA_DANCER] =                    { _("Dancer"), 6 },
    [TRAINER_CLASS_ALOLA_PUNK_ROCKER] =               { _("Punk Rocker"), 4 },
    [TRAINER_CLASS_ALOLA_SINGER] =                    { _("Singer"), 8 },
    [TRAINER_CLASS_ALOLA_RISING_STAR] =               { _("Rising Star"), 8 },
    [TRAINER_CLASS_ALOLA_ACE_TRAINER] =               { _("Ace Trainer"), 12, BALL_ULTRA },
    [TRAINER_CLASS_ALOLA_FISHERMAN] =                 { _("Fisherman"), 8, BALL_LURE },
    [TRAINER_CLASS_ALOLA_GENTLEMAN] =                 { _("Gentleman"), 18, BALL_LUXURY },
    [TRAINER_CLASS_ALOLA_LADY] =                      { _("Lady"), 18, BALL_LUXURY },
    [TRAINER_CLASS_ALOLA_FARMER] =                    { _("Farmer"), 8, BALL_NEST },
    [TRAINER_CLASS_ALOLA_AETHER_FOUNDATION] =         { _("Aether Fdtn."), 15, BALL_HEAL },
    [TRAINER_CLASS_ALOLA_TEAM_SKULL] =                { _("Team Skull"), 8 },
    [TRAINER_CLASS_ALOLA_HIKER] =                     { _("Hiker"), 9, },
    [TRAINER_CLASS_ALOLA_BACKPACKER] =                { _("Backpacker"), 8 },
    [TRAINER_CLASS_ALOLA_SAILOR] =                    { _("Sailor"), 5 },
    [TRAINER_CLASS_ALOLA_CAMPER] =                    { _("Camper"), 5 },
    [TRAINER_CLASS_ALOLA_PICNICKER] =                 { _("Picnicker"), 5 },
    [TRAINER_CLASS_ALOLA_BLACK_BELT] =                { _("Black Belt"), 6, BALL_ULTRA },
    [TRAINER_CLASS_ALOLA_BATTLE_GIRL] =               { _("Battle Girl"), 6, BALL_ULTRA },
    [TRAINER_CLASS_ALOLA_BREEDER] =                   { _("{PKMN} Breeder"), 7, BALL_FRIEND },
    [TRAINER_CLASS_ALOLA_BIRD_KEEPER] =               { _("Bird Keeper"), 8 },
    [TRAINER_CLASS_ALOLA_VETERAN] =                   { _("Veteran"), 12, BALL_ULTRA },
    [TRAINER_CLASS_ALOLA_BELLHOP] =                   { _("Bellhop"), 6 },
    [TRAINER_CLASS_ALOLA_COLLECTOR] =                 { _("Collector"), 8 },
    [TRAINER_CLASS_ALOLA_OFFICE_WORKER] =             { _("Worker"), 8 },
    [TRAINER_CLASS_ALOLA_BIKER] =                     { _("Biker"), 6 },
    [TRAINER_CLASS_ALOLA_JESTER] =                    { _("Jester"), 6 },
    [TRAINER_CLASS_ALOLA_BEAUTY] =                    { _("Beauty"), 10, BALL_LUXURY },
    [TRAINER_CLASS_ALOLA_PILOT] =                     { _("Pilot"), 15, BALL_GREAT },
    [TRAINER_CLASS_ALOLA_ARTIST] =                    { _("Artist"), 4 },
    [TRAINER_CLASS_ALOLA_PSYCHIC] =                   { _("Psychic"), 6 },
    [TRAINER_CLASS_ALOLA_HEX_MANIAC] =                { _("Hex Maniac"), 7 },
    [TRAINER_CLASS_ALOLA_RANGER] =                    { _("Ranger"), 8 },
    [TRAINER_CLASS_ALOLA_SCIENTIST] =                 { _("Scientist"), 10 },
    [TRAINER_CLASS_ALOLA_KUPUNA] =                    { _("Kupuna Elder"), 15 },
    [TRAINER_CLASS_ALOLA_TRIAL_CAPTAIN] =             { _("Trial Capt."), 25 },
    [TRAINER_CLASS_ALOLA_KAHUNA] =                    { _("Kahuna"), 35 },
    [TRAINER_CLASS_ALOLA_PROFESSOR] =                 { _("Professor"), 25 },
};
...
void SpriteCB_FaintOpponentMon(struct Sprite *sprite)
{
    ...
    yOffset = gSpeciesInfo[species].frontPicYOffset - FORCED_MON_SPRITE_OFFSET;
