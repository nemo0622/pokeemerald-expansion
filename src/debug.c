...
{
    FLAG_VISITED_IKI_TOWN,
    FLAG_VISITED_HAUOLI_CITY,
    FLAG_VISITED_HEAHEA_CITY,
    FLAG_VISITED_PANIOLA_TOWN,
    FLAG_VISITED_ROYAL_AVENUE,
    FLAG_VISITED_KONIKONI_CITY,
    FLAG_VISITED_MALIE_CITY,
    FLAG_VISITED_MT_HOKULANI,
    FLAG_VISITED_TAPU_VILLAGE,
    FLAG_VISITED_PO_TOWN,
    FLAG_VISITED_AETHER_PARADISE,
    FLAG_VISITED_SEAFOLK_VILLAGE,
    FLAG_VISITED_EXEGGUTOR_ISLAND,
    FLAG_VISITED_BATTLE_TREE,
    FLAG_VISITED_LOCATION_15,
    FLAG_VISITED_LOCATION_16,
...
{
    OBJ_EVENT_GFX_GEN3_RIVAL_ELIO_NORMAL,
    OBJ_EVENT_GFX_GEN3_RIVAL_SELENE_NORMAL,
    OBJ_EVENT_GFX_GEN3_STEVEN,
    OBJ_EVENT_GFX_GEN3_WALLY,
    OBJ_EVENT_GFX_GEN3_RED,
    OBJ_EVENT_GFX_GEN3_LEAF,
};
