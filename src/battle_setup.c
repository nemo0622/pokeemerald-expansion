...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_SWIMMER_NATASHA, TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_3, TRAINER_GABRIELLE_4, TRAINER_GABRIELLE_5, MAP_MT_PYRE_3F),
    ...
    [REMATCH_SAWYER] = REMATCH(TRAINER_SCHOOL_BOY_OLIVER, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MAP_MT_CHIMNEY),
...
static void CB2_EndScriptedWildBattle(void)
{
    ...
    {
        if (CurrentBattlePyramidLocation() != PYRAMID_LOCATION_NONE || FlagGet(FLAG_LILLIE_NEEDS_HELP_MAHALO_TRAIL))
