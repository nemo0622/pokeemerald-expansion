...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_DUSTY] = REMATCH(TRAINER_PYTHIOSGYM_ADDONIS, TRAINER_PYTHIOSGYM_YANNA, TRAINER_LEADER_SABELLA, TRAINER_LEADER_SABELLA_HARD, TRAINER_ERINYSPATH_CHIMERA_ADMIN, ROUTE111),
    ...
    [REMATCH_CINDY] = REMATCH(TRAINER_ASTERISEA_MAURIE, TRAINER_MYRRINIGYM_TASOS, TRAINER_MYRRINIGYM_REMIGIO, TRAINER_MYRRINIGYM_ALMA, TRAINER_LEADER_THYRSUS, ROUTE104),
    ...
    [REMATCH_WINSTON] = REMATCH(TRAINER_PENTEPETAL_CHIMERA_GRUNT, TRAINER_WINSTON_2, TRAINER_WINSTON_3, TRAINER_WINSTON_4, TRAINER_WINSTON_5, ROUTE104),
