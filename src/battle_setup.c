...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_ETHAN] = REMATCH(TRAINER_PENTEPETAL_RANIA, TRAINER_ETHAN_2, TRAINER_ETHAN_3, TRAINER_ETHAN_4, TRAINER_ETHAN_5, JAGGED_PASS),
    ...
    [REMATCH_JEFFREY] = REMATCH(TRAINER_NYXTRAILS_BRIENNEREY_1, TRAINER_NYXTRAILS_BRIENNEREY_2, TRAINER_NYXTRAILS_BRIENNEREY_3, TRAINER_NYXTRAILS_BRIENNEREY_4, TRAINER_NYXTRAILS_BRIENNEREY_5, ROUTE120),
