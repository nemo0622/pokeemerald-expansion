...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_SAWYER] = REMATCH(TRAINER_BRONZE_PASS_KLEFTIS_GRUNT, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MT_CHIMNEY),
...
u8 GetTrainerBattleTransition(void)
{
    ...
    if (trainerClass == TRAINER_CLASS_TEAM_KLEFTIS
