...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_BRONZEPASS_ROSE, TRAINER_WANDERERSWOODS_LYDIA, TRAINER_WANDERERSWOODS_THOMAS, TRAINER_PYTHIOSGYM_ROSARA, TRAINER_PYTHIOSGYM_TAFOS, ROUTE118),
    [REMATCH_ANDRES] = REMATCH(TRAINER_ANDRES_1, TRAINER_ANDRES_2, TRAINER_ANDRES_3, TRAINER_ANDRES_4, TRAINER_ANDRES_5, ROUTE105),
    [REMATCH_DUSTY] = REMATCH(TRAINER_PYTHIOSGYM_ADDONIS, TRAINER_PYTHIOSGYM_YANNA, TRAINER_LEADER_KLEIO, TRAINER_LEADER_KLEIO_HARD, TRAINER_ERINYSPATH_CHIMERA_ADMIN, ROUTE111),
    [REMATCH_LOLA] = REMATCH(TRAINER_PYTHIOSCEMETERY_GALEI, TRAINER_RIVERWALK_TRAIL_S_GIANNA, TRAINER_RIVERWALK_TRAIL_S_BARNETT, TRAINER_KALAMI_GYM_REX, TRAINER_KALAMI_GYM_DANIEL, ROUTE109),
    [REMATCH_RICKY] = REMATCH(TRAINER_KALAMI_GYM_TASOULA, TRAINER_ERINYSPATH_E_ROGER, TRAINER_ERINYSPATH_W_HELENA, TRAINER_ERINYSPATH_W_LEWEY, TRAINER_ERINYSPATH_W_IRO_AND_ANNA, ROUTE109),
    ...
    [REMATCH_BROOKE] = REMATCH(TRAINER_SOFOSGYM_BROOKE, TRAINER_ASTERISEA_TALEIA, TRAINER_ASTERISEA_HAMON, TRAINER_ASTERISEA_GEORGIA, TRAINER_ASTERISEA_TRYFON, ROUTE111),
    [REMATCH_WILTON] = REMATCH(TRAINER_FROSLASSCAVERN_F3_KAUROS, TRAINER_WANDERERSWOODS_S_WARREN, TRAINER_WANDERERSWOODS_S_DUNCAN, TRAINER_WANDERERSWOODS_S_DONNA, TRAINER_ASFALHILLS_LENA_AND_MARISA, ROUTE111),
    [REMATCH_VALERIE] = REMATCH(TRAINER_ASTERISEA_SIKAR, TRAINER_ASTERISEA_MATILDA, TRAINER_ASTERISEA_HARVEY, TRAINER_ASTERISEA_JOSEPH, TRAINER_ASTERISEA_LEON, MT_PYRE_6F),
    [REMATCH_CINDY] = REMATCH(TRAINER_ASTERISEA_MAURIE, TRAINER_MYRRINIGYM_TASOS, TRAINER_MYRRINIGYM_REMIGIO, TRAINER_MYRRINIGYM_ALMA, TRAINER_LEADER_EUTERPE, ROUTE104),
    [REMATCH_THALIA] = REMATCH(TRAINER_VULCAISEA_PELAGIA, TRAINER_THALIA_2, TRAINER_THALIA_3, TRAINER_THALIA_4, TRAINER_THALIA_5, ABANDONED_SHIP_ROOMS_1F),
    [REMATCH_JESSICA] = REMATCH(TRAINER_MARMAROMINES_CHIMERA_ADMIN, TRAINER_UNDERWATER_WESTON, TRAINER_UNDERWATER_MAURICIUS, TRAINER_UNDERWATER_QUINTUS, TRAINER_UNDERWATER_ARIK, ROUTE121),
    [REMATCH_WINSTON] = REMATCH(TRAINER_PENTEPETAL_CHIMERA_GRUNT, TRAINER_VULCAISEA_SHERRY, TRAINER_VULCAISEA_LUSIO, TRAINER_VULCAISEA_MAHYA, TRAINER_VULCAISEA_LEYLI, ROUTE104),
    [REMATCH_STEVE] = REMATCH(TRAINER_VULCAISEA_ZISSIS, TRAINER_VULCAISEA_JULIEN, TRAINER_VULCAISEA_TABATA, TRAINER_VULCAISEA_SEBASTIAN, TRAINER_FRESCOISLES_STELLA, ROUTE114),
    [REMATCH_TONY] = REMATCH(TRAINER_FRESCOGYM_FRIDA, TRAINER_KAPTARAWEST_DANI, TRAINER_KAPTARAWEST_BARREL, TRAINER_KAPTARAWEST_SALLADOR, TRAINER_KAPTARAWEST_PENNY, ROUTE107),
    [REMATCH_NOB] = REMATCH(TRAINER_SATYRSLAIR_CHIMERA_ADMIN_HARD, TRAINER_LASTLIGHT_HARLEY, TRAINER_LASTLIGHT_BILLIE, TRAINER_LASTLIGHT_ZOEY, TRAINER_LASTLIGHT_PHALLON, ROUTE115),
    [REMATCH_KOJI] = REMATCH(TRAINER_KOJI_1, TRAINER_KOJI_2, TRAINER_KOJI_3, TRAINER_KOJI_4, TRAINER_KOJI_5, ROUTE127),
    [REMATCH_FERNANDO] = REMATCH(TRAINER_CORRINCROSSING_ALFRED, TRAINER_FERNANDO_2, TRAINER_FERNANDO_3, TRAINER_FERNANDO_4, TRAINER_FERNANDO_5, ROUTE123),
    [REMATCH_DALTON] = REMATCH(TRAINER_CORRINCROSSING_DARCEY, TRAINER_CORRINCROSSING_MAXIM, TRAINER_CORRINCROSSING_OSKAR, TRAINER_PORTPELLO_RANIA, TRAINER_PORTPELLO_RANIA_HARD, ROUTE118),
    [REMATCH_BERNIE] = REMATCH(TRAINER_NYXTRAILS_GRUNT2, TRAINER_NYXTRAILS_GRUNT3, TRAINER_NYXTRAILS_GRUNT4, TRAINER_NYXTRAILS_GRUNT5, TRAINER_NYXTRAILS_GRUNT6, ROUTE114),
    [REMATCH_ETHAN] = REMATCH(TRAINER_PENTEPETAL_RANIA, TRAINER_POLLENROAD_RUBEN, TRAINER_POLLENROAD_JONAH, TRAINER_POLLENROAD_HANNAH, TRAINER_POLLENROAD_ASHARI, JAGGED_PASS),
    ...
    [REMATCH_JEFFREY] = REMATCH(TRAINER_DAVOSISTRAITS_NEWELL, TRAINER_DAVOSISTRAITS_ALKIS, TRAINER_DAVOSISTRAITS_LEONIDAS, TRAINER_DAVOSISTRAITS_PATELINA, TRAINER_DAVOSISTRAITS_MINAS, ROUTE120),
    [REMATCH_CAMERON] = REMATCH(TRAINER_ELITEFOUR_TERPSIKORE_HARD, TRAINER_ELITEFOUR_EUTERPE, TRAINER_ELITEFOUR_EUTERPE_HARD, TRAINER_ELITEFOUR_RHADINE, TRAINER_ELITEFOUR_RHADINE_HARD, ROUTE123),
    [REMATCH_JACKI] = REMATCH(TRAINER_WAKEWATER_ALEXANDER, TRAINER_WAKEWATER_KASSA, TRAINER_WAKEWATER_POLYMNIA, TRAINER_WAKEWATER_OURANI, TRAINER_WAKEWATER_KLEIO, ROUTE123),
    [REMATCH_WALTER] = REMATCH(TRAINER_WAKEWATER_TERPSIKORE, TRAINER_WAKEWATER_RHADINE, TRAINER_WAKEWATER_KALLIOPE, TRAINER_WAKEWATER_CHIMERA_ADMIN_M, TRAINER_WAKEWATER_CHIMERA_ADMIN_F, ROUTE121),
    [REMATCH_KAREN] = REMATCH(TRAINER_WAKEWATER_AMY, TRAINER_WAKEWATER_NOB, TRAINER_WAKEWATER_DALE, TRAINER_WAKEWATER_ALLEN, TRAINER_WAKEWATER_NIKITA, ROUTE116),
    [REMATCH_JERRY] = REMATCH(TRAINER_WAKEWATER_CAIDEN, TRAINER_WAKEWATER_JERRY, TRAINER_WAKEWATER_ERIKOV, TRAINER_WAKEWATER_RAJ, TRAINER_WAKEWATER_BITA, ROUTE116),
    [REMATCH_ANNA_AND_MEG] = REMATCH(TRAINER_SATYRSLAIR_RYAN, TRAINER_ANNA_AND_MEG_2, TRAINER_ANNA_AND_MEG_3, TRAINER_ANNA_AND_MEG_4, TRAINER_ANNA_AND_MEG_5, ROUTE117),
    [REMATCH_ISABEL] = REMATCH(TRAINER_ISABEL_1, TRAINER_ISABEL_2, TRAINER_ISABEL_3, TRAINER_ISABEL_4, TRAINER_ISABEL_5, ROUTE110),
    [REMATCH_MIGUEL] = REMATCH(TRAINER_WAKEWATER_MISSINGNOVGC, TRAINER_MIGUEL_2, TRAINER_MIGUEL_3, TRAINER_MIGUEL_4, TRAINER_MIGUEL_5, ROUTE103),
    ...
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_JUSMAILGYM_KARI, TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_3, TRAINER_GABRIELLE_4, TRAINER_GABRIELLE_5, MT_PYRE_3F),
    ...
    [REMATCH_SAWYER] = REMATCH(TRAINER_BRONZE_PASS_CHIMERA_GRUNT, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MT_CHIMNEY),
    ...
    [REMATCH_ROXANNE] = REMATCH(TRAINER_WAKEWATER_SASHA, TRAINER_ROXANNE_2, TRAINER_ROXANNE_3, TRAINER_ROXANNE_4, TRAINER_ROXANNE_5, RUSTBORO_CITY),
    [REMATCH_BRAWLY] = REMATCH(TRAINER_WAKEWATER_CONNIE, TRAINER_BRAWLY_2, TRAINER_BRAWLY_3, TRAINER_BRAWLY_4, TRAINER_BRAWLY_5, DEWFORD_TOWN),
    [REMATCH_WATTSON] = REMATCH(TRAINER_WAKEWATER_SHIA, TRAINER_WATTSON_2, TRAINER_WATTSON_3, TRAINER_WATTSON_4, TRAINER_WATTSON_5, MAUVILLE_CITY),
    [REMATCH_FLANNERY] = REMATCH(TRAINER_WAKEWATER_OLIVIA, TRAINER_FLANNERY_2, TRAINER_FLANNERY_3, TRAINER_FLANNERY_4, TRAINER_FLANNERY_5, LAVARIDGE_TOWN),
    [REMATCH_NORMAN] = REMATCH(TRAINER_WAKEWATER_KYLE, TRAINER_NORMAN_2, TRAINER_NORMAN_3, TRAINER_NORMAN_4, TRAINER_NORMAN_5, PETALBURG_CITY),
    [REMATCH_WINONA] = REMATCH(TRAINER_WAKEWATER_NEMO, TRAINER_WINONA_2, TRAINER_WINONA_3, TRAINER_WINONA_4, TRAINER_WINONA_5, FORTREE_CITY),
    [REMATCH_TATE_AND_LIZA] = REMATCH(TRAINER_WAKEWATER_CASSIE, TRAINER_TATE_AND_LIZA_2, TRAINER_TATE_AND_LIZA_3, TRAINER_TATE_AND_LIZA_4, TRAINER_TATE_AND_LIZA_5, MOSSDEEP_CITY),
    [REMATCH_JUAN] = REMATCH(TRAINER_WAKEWATER_JARED, TRAINER_JUAN_2, TRAINER_JUAN_3, TRAINER_JUAN_4, TRAINER_JUAN_5, SOOTOPOLIS_CITY),
    [REMATCH_SIDNEY] = REMATCH(TRAINER_WAKEWATER_ANYALIOS, TRAINER_WAKEWATER_ANYALIOS, TRAINER_WAKEWATER_ANYALIOS, TRAINER_WAKEWATER_ANYALIOS, TRAINER_WAKEWATER_ANYALIOS, EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_WAKEWATER_RANIA, TRAINER_WAKEWATER_RANIA, TRAINER_WAKEWATER_RANIA, TRAINER_WAKEWATER_RANIA, TRAINER_WAKEWATER_RANIA, EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_WAKEWATER_MICHAH, TRAINER_WAKEWATER_MICHAH, TRAINER_WAKEWATER_MICHAH, TRAINER_WAKEWATER_MICHAH, TRAINER_WAKEWATER_MICHAH, EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(TRAINER_WAKEWATER_DRAKE, TRAINER_WAKEWATER_DRAKE, TRAINER_WAKEWATER_DRAKE, TRAINER_WAKEWATER_DRAKE, TRAINER_WAKEWATER_DRAKE, EVER_GRANDE_CITY),
...
u8 GetTrainerBattleTransition(void)
{
    ...
    if (trainerClass == TRAINER_CLASS_TEAM_CHIMERA
        || trainerClass == TRAINER_CLASS_CHIMERA_LEADER
        || trainerClass == TRAINER_CLASS_CHIMERA_ADMIN)
...
void PlayTrainerEncounterMusic(void)
{
        ...
        && sTrainerBattleMode != TRAINER_BATTLE_CONTINUE_SCRIPT_DOUBLE_NO_MUSIC)
    {
        ...
        // }
        music = MUS_ENCOUNTER_MALE; // just one track for Lazarus
