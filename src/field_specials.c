...
void CheckRouteCaptureProgress(void)
{
    ...
    switch(mapId)
    {
        ...
        {
            u32 localArray[32] = {SPECIES_FOMANTIS, SPECIES_TRUMBEAK, SPECIES_ORANGURU, SPECIES_PASSIMIAN, SPECIES_MORGREM, SPECIES_YANMA, SPECIES_DUOSION, SPECIES_LURANTIS, SPECIES_ALTARIA, SPECIES_REUNICLUS, SPECIES_GOLDUCK, SPECIES_CLAYDOL, SPECIES_ESPATHRA, SPECIES_GOTHORITA, SPECIES_GOTHITELLE, SPECIES_CHARJABUG, SPECIES_SKIPLOOM, SPECIES_ROSELIA, SPECIES_TAUROS, SPECIES_GOOMY, SPECIES_PERRSERKER, SPECIES_SLIGGOO, SPECIES_DEDENNE, SPECIES_CHERRIM, SPECIES_DOUBLADE, SPECIES_ARBOK, SPECIES_TOGEDEMARU, SPECIES_SKUNTANK, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE};
            for(u8 i=0; i<32; i++) { wildSpeciesArray[i] = localArray[i]; }
            break;
        }
