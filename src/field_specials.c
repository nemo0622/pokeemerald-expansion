...
void CheckRouteCaptureProgress(void)
{
    ...
    switch(mapId)
    {
        ...
        {
            u32 localArray[32] = {SPECIES_LILLIPUP, SPECIES_PIKIPEK, SPECIES_NINCADA, SPECIES_HOPPIP, SPECIES_GRUBBIN, SPECIES_PARAS, SPECIES_CUBONE, SPECIES_PHANPY, SPECIES_DUCKLETT, SPECIES_HOOTHOOT, SPECIES_MURKROW, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE};
            for(u8 i=0; i<32; i++) { wildSpeciesArray[i] = localArray[i]; }
            break;
        }
        ...
        {
            u32 localArray[32] = {SPECIES_SANDSHREW, SPECIES_ROCKRUFF, SPECIES_NOSEPASS, SPECIES_VULLABY, SPECIES_WOOBAT, SPECIES_TIMBURR, SPECIES_ARON, SPECIES_MANKEY, SPECIES_MAWILE, SPECIES_KLAWF, SPECIES_FLITTLE, SPECIES_PICHU, SPECIES_FLABEBE, SPECIES_SNOVER, SPECIES_SPINARAK, SPECIES_BRONZOR, SPECIES_DEDENNE, SPECIES_SKIDDO, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE};
            for(u8 i=0; i<32; i++) { wildSpeciesArray[i] = localArray[i]; }
            break;
        }
        case MAPSEC_RIVERWALK_TRAIL:
        {
            u32 localArray[32] = {SPECIES_ARON, SPECIES_PONYTA, SPECIES_MEDITITE, SPECIES_DODUO, SPECIES_CUTIEFLY, SPECIES_MUDBRAY, SPECIES_YAMPER, SPECIES_SANDILE, SPECIES_GLIGAR, SPECIES_JANGMO_O, SPECIES_YANMA, SPECIES_CUBCHOO, SPECIES_BUIZEL, SPECIES_WURMPLE, SPECIES_WOOPER, SPECIES_ZIGZAGOON, SPECIES_EKANS, SPECIES_BOUNSWEET, SPECIES_SILCOON, SPECIES_CUFANT, SPECIES_TROPIUS, SPECIES_PUMPKABOO, SPECIES_CASCOON, SPECIES_DREEPY, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE};
            for(u8 i=0; i<32; i++) { wildSpeciesArray[i] = localArray[i]; }
            break;
        }
        case MAPSEC_KALAMI_CITY:
        {
            u32 localArray[32] = {SPECIES_BUIZEL, SPECIES_WINGULL, SPECIES_WIMPOD, SPECIES_TOEDSCOOL, SPECIES_LILLIPUP, SPECIES_APPLIN, SPECIES_SHROODLE, SPECIES_MEOWTH, SPECIES_TOTODILE, SPECIES_PASSIMIAN, SPECIES_MURKROW, SPECIES_ORANGURU, SPECIES_MAGIKARP, SPECIES_SKRELP, SPECIES_CLAUNCHER, SPECIES_REMORAID, SPECIES_BARBOACH, SPECIES_QUAGSIRE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE};
            for(u8 i=0; i<32; i++) { wildSpeciesArray[i] = localArray[i]; }
            break;
        }
        ...
        {
            u32 localArray[32] = {SPECIES_TAUROS, SPECIES_PAWMI, SPECIES_MEOWTH, SPECIES_PACHIRISU, SPECIES_YAMPER, SPECIES_BUIZEL, SPECIES_CHATOT, SPECIES_DEDENNE, SPECIES_SHROODLE, SPECIES_STUNKY, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE};
            for(u8 i=0; i<32; i++) { wildSpeciesArray[i] = localArray[i]; }
            break;
        }
        ...
        {
            u32 localArray[32] = {SPECIES_MEDITITE, SPECIES_STEENEE, SPECIES_JIGGLYPUFF, SPECIES_PANCHAM, SPECIES_CHERUBI, SPECIES_FLAMIGO, SPECIES_ORICORIO, SPECIES_DROWZEE, SPECIES_FLOETTE, SPECIES_GOOMY, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE};
            for(u8 i=0; i<32; i++) { wildSpeciesArray[i] = localArray[i]; }
            break;
        }
        case MAPSEC_SEA_OF_VULCAI:
        {
            u32 localArray[32] = {SPECIES_FINNEON, SPECIES_REMORAID, SPECIES_WAILMER, SPECIES_SKRELP, SPECIES_CHINCHOU, SPECIES_CORSOLA, SPECIES_CLAMPERL, SPECIES_OCTILLERY, SPECIES_GYARADOS, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE};
            for(u8 i=0; i<32; i++) { wildSpeciesArray[i] = localArray[i]; }
            break;
        }
        case MAPSEC_FRESCO_ISLAND:
        {
            u32 localArray[32] = {SPECIES_TRAPINCH, SPECIES_SCRAGGY, SPECIES_GLIGAR, SPECIES_NUMEL, SPECIES_TINKATUFF, SPECIES_DODUO, SPECIES_HELIOPTILE, SPECIES_KROKOROK, SPECIES_SKORUPI, SPECIES_CYCLIZAR, SPECIES_QUAGSIRE, SPECIES_SALANDIT, SPECIES_DREEPY, SPECIES_WOOPER, SPECIES_CLODSIRE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE, SPECIES_NONE};
            for(u8 i=0; i<32; i++) { wildSpeciesArray[i] = localArray[i]; }
            break;
        }
    }
