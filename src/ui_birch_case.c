...
{
    [BALL_TOP_FIRST]        = {SPECIES_POPPLIO, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_TOP_SECOND]       = {SPECIES_ROWLET, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_MIDDLE_FIRST]     = {SPECIES_LITTEN, 5, ITEM_ORAN_BERRY, BALL_POKE},

    [BALL_TOP_THIRD]        = {SPECIES_FROAKIE, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_TOP_FOURTH]       = {SPECIES_CHESPIN, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_MIDDLE_THIRD]     = {SPECIES_FENNEKIN, 5, ITEM_ORAN_BERRY, BALL_POKE},

    [BALL_MIDDLE_SECOND]    = {SPECIES_QUAXLY, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_BOTTOM_FIRST]     = {SPECIES_SPRIGATITO, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_BOTTOM_SECOND]    = {SPECIES_FUECOCO, 5, ITEM_ORAN_BERRY, BALL_POKE},
};
