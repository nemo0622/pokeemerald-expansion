...
{
    [BALL_TOP_FIRST]        = {SPECIES_OSHAWOTT, 5, ITEM_ORAN_BERRY, BALL_POKE}, // originally piplup
    [BALL_TOP_SECOND]       = {SPECIES_SNIVY, 5, ITEM_ORAN_BERRY, BALL_POKE}, // originally rowlet
    [BALL_MIDDLE_FIRST]     = {SPECIES_TEPIG, 5, ITEM_ORAN_BERRY, BALL_POKE},

    [BALL_TOP_THIRD]        = {SPECIES_PANPOUR, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_TOP_FOURTH]       = {SPECIES_PANSAGE, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_MIDDLE_THIRD]     = {SPECIES_PANSEAR, 5, ITEM_ORAN_BERRY, BALL_POKE},

    [BALL_MIDDLE_SECOND]    = {SPECIES_IMPIDIMP, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_BOTTOM_FIRST]     = {SPECIES_DEDENNE, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_BOTTOM_SECOND]    = {SPECIES_SWABLU, 5, ITEM_ORAN_BERRY, BALL_POKE},
};
...
static void BirchCase_GiveMon() // Function that calls the GiveMon function pulled from Expansion by Lunos and Ghoulslash
{
    ...
    VarSet(VAR_STARTER_MON, sStarterChoices[sBirchCaseDataPtr->handPosition].species);
