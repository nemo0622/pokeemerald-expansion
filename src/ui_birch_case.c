...
{
    [BALL_TOP_FIRST]        = {SPECIES_PIPLUP, 5, ITEM_ORAN_BERRY, BALL_POKE},
    ...
    [BALL_TOP_FOURTH]       = {SPECIES_IMPIDIMP, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_MIDDLE_THIRD]     = {SPECIES_NONE, 5},

    [BALL_MIDDLE_SECOND]    = {SPECIES_NONE, 5},
    [BALL_BOTTOM_FIRST]     = {SPECIES_DODUO, 5, ITEM_ORAN_BERRY, BALL_POKE},
