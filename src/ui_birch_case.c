...
static const struct MonChoiceData sStarterChoices[9] = 
{
    ...
    [BALL_MIDDLE_SECOND]    = {SPECIES_PANPOUR, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_BOTTOM_FIRST]     = {SPECIES_PANSAGE, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_BOTTOM_SECOND]    = {SPECIES_PANSEAR, 5, ITEM_ORAN_BERRY, BALL_POKE},
};
