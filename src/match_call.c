...
{
    {
        .trainerId = TRAINER_BRONZEPASS_ROSE,
        .unused = 0,
    ...
    {
        .trainerId = TRAINER_PYTHIOSGYM_ADDONIS,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(12),
    ...
    {
        .trainerId = TRAINER_PYTHIOSCEMETERY_GALEI,
        .unused = 0,
    ...
    {
        .trainerId = TRAINER_KALAMI_GYM_TASOULA,
        .unused = 0,
    ...
    {
        .trainerId = TRAINER_SOFOSGYM_BROOKE,
        .unused = 0,
    ...
    {
        .trainerId = TRAINER_FROSLASSCAVERN_F3_KAUROS,
        .unused = 0,
    ...
    {
        .trainerId = TRAINER_ASTERISEA_SIKAR,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(8),
    ...
    {
        .trainerId = TRAINER_ASTERISEA_MAURIE,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(8),
    ...
    {
        .trainerId = TRAINER_MARMAROMINES_CHIMERA_ADMIN,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(10),
    ...
    {
        .trainerId = TRAINER_PENTEPETAL_CHIMERA_GRUNT,
        .unused = 0,
    ...
    {
        .trainerId = TRAINER_FRESCOGYM_FRIDA,
        .unused = 0,
    ...
    {
        .trainerId = TRAINER_SATYRSLAIR_CHIMERA_ADMIN_HARD,
        .unused = 0,
    ...
    {
        .trainerId = TRAINER_CORRINCROSSING_ALFRED,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(6),
    ...
    {
        .trainerId = TRAINER_CORRINCROSSING_DARCEY,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(4),
    ...
    {
        .trainerId = TRAINER_NYXTRAILS_GRUNT2,
        .unused = 0,
    ...
    {
        .trainerId = TRAINER_PENTEPETAL_RANIA,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(1),
    ...
    {
        .trainerId = TRAINER_DAVOSISTRAITS_NEWELL,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(7),
    ...
    {
        .trainerId = TRAINER_ELITEFOUR_TERPSIKORE_HARD,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(4),
    ...
    {
        .trainerId = TRAINER_WAKEWATER_ALEXANDER,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(8),
    ...
    {
        .trainerId = TRAINER_WAKEWATER_TERPSIKORE,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(12),
    ...
    {
        .trainerId = TRAINER_WAKEWATER_AMY,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(2),
    ...
    {
        .trainerId = TRAINER_WAKEWATER_CAIDEN,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(1),
    ...
    {
        .trainerId = TRAINER_SATYRSLAIR_RYAN,
        .unused = 6,
        .battleTopicTextIds = BATTLE_TEXT_IDS(9),
    ...
    {
        .trainerId = TRAINER_WAKEWATER_MISSINGNOVGC,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(11),
    ...
    {
        .trainerId = TRAINER_JUSMAILGYM_KARI,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(8),
    ...
    {
        .trainerId = TRAINER_BRONZE_PASS_CHIMERA_GRUNT,
        .unused = 0,
        // Thalia and Sawyer are the only ones who use different msg ids for their battle topics
...
static const struct MultiTrainerMatchCallText sMultiTrainerMatchCallTexts[] =
{
    ...
    { .trainerId = TRAINER_ERINYSPATH_CHIMERA_ADMIN_HARD, .text = gText_Gabby },
    { .trainerId = TRAINER_SATYRSLAIR_RYAN, .text = gText_Anna },
};
