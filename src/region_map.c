...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_CHAMPIONS_PEAK] = {MAP_GROUP(CHAMPIONS_PEAK_OUTSIDE), MAP_NUM(CHAMPIONS_PEAK_OUTSIDE), HEAL_LOCATION_CHAMPIONS_PEAK_OUTSIDE},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_CHAMPIONS_PEAK:
        return FlagGet(FLAG_VISITED_CHAMPIONS_PEAK) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    for (mapSecId = MAPSEC_ACRISIA_CITY; mapSecId <= MAPSEC_PALATI_CITY; mapSecId++)
    {
