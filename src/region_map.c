...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_ACRISIA_CITY] = {MAP_GROUP(ACRISIA_CITY), MAP_NUM(ACRISIA_CITY), HEAL_LOCATION_ACRISIA_CITY},
    [MAPSEC_JUSMAIL_TOWN] = {MAP_GROUP(JUSMAIL_TOWN), MAP_NUM(JUSMAIL_TOWN), HEAL_LOCATION_JUSMAIL_TOWN},
    [MAPSEC_PYTHIOS_TOWN] = {MAP_GROUP(PYTHIOS_TOWN), MAP_NUM(PYTHIOS_TOWN), HEAL_LOCATION_PYTHIOS_TOWN},
    [MAPSEC_SOFOS_CITY] = {MAP_GROUP(SOFOS_CITY), MAP_NUM(SOFOS_CITY), HEAL_LOCATION_SOFOS_CITY},
    [MAPSEC_MARMARO_ISLAND] = {MAP_GROUP(MARMARO_ISLAND), MAP_NUM(MARMARO_ISLAND), HEAL_LOCATION_MARMARO_ISLAND},
    [MAPSEC_MYRRINI_ISLAND] = {MAP_GROUP(MYRRINI_ISLAND), MAP_NUM(MYRRINI_ISLAND), HEAL_LOCATION_MYRRINI_ISLAND},
    [MAPSEC_FRESCO_ISLAND] = {MAP_GROUP(FRESCO_ISLAND), MAP_NUM(FRESCO_ISLAND), HEAL_LOCATION_FRESCO_ISLAND},
    [MAPSEC_PALATI_CITY] = {MAP_GROUP(PALATI_CITY), MAP_NUM(PALATI_CITY), HEAL_LOCATION_PALATI_CITY},
    [MAPSEC_PORT_PELLO] = {MAP_GROUP(PORT_PELLO), MAP_NUM(PORT_PELLO), HEAL_LOCATION_PORT_PELLO},
    [MAPSEC_AREIOS_HIDEOUT] = {MAP_GROUP(AREIOS_HIDEOUT), MAP_NUM(AREIOS_HIDEOUT), HEAL_LOCATION_AREIOS_HIDEOUT},
    [MAPSEC_RUINS_OF_AHIYAWA] = {MAP_GROUP(RUINS_OF_AHIYAWA), MAP_NUM(RUINS_OF_AHIYAWA), HEAL_LOCATION_RUINS_OF_AHIYAWA},
    ...
    [MAPSEC_WAKEWATER_ISLE] = {MAP_GROUP(WAKEWATER_ISLE), MAP_NUM(WAKEWATER_ISLE), HEAL_LOCATION_WAKEWATER_ISLE},
};
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_ACRISIA_CITY:
        return FlagGet(FLAG_VISITED_ACRISIA_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_JUSMAIL_TOWN:
        return FlagGet(FLAG_VISITED_JUSMAIL_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_PYTHIOS_TOWN:
        return FlagGet(FLAG_VISITED_PYTHIOS_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SOFOS_CITY:
        return FlagGet(FLAG_VISITED_SOFOS_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_MARMARO_ISLAND:
        return FlagGet(FLAG_VISITED_MARMARO_ISLAND) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_MYRRINI_ISLAND:
        return FlagGet(FLAG_VISITED_MYRRINI_ISLAND) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_FRESCO_ISLAND:
        return FlagGet(FLAG_VISITED_FRESCO_ISLAND) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_PALATI_CITY:
        return FlagGet(FLAG_VISITED_PALATI_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_PORT_PELLO:
        return FlagGet(FLAG_VISITED_PORT_PELLO) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_AREIOS_HIDEOUT:
        return FlagGet(FLAG_VISITED_AREIOS_HIDEOUT) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_RUINS_OF_AHIYAWA:
        return FlagGet(FLAG_VISITED_RUINS_OF_AHIYAWA) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_KALAMI_CITY:
        return FlagGet(FLAG_VISITED_KALAMI_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    ...
    case MAPSEC_WAKEWATER_ISLE:
        return FlagGet(FLAG_VISITED_WAKEWATER_ISLE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    for (mapSecId = MAPSEC_ACRISIA_CITY; mapSecId <= MAPSEC_NYX_TRAILS; mapSecId++) // loop through first and last used MAPSECs
    {
        ...
        && mapSecId != MAPSEC_AREIOS_HIDEOUT && mapSecId != MAPSEC_RUINS_OF_AHIYAWA && mapSecId != MAPSEC_KALAMI_CITY
