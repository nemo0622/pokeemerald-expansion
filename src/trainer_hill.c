...
{
    {TRAINER_CLASS_TEAM_CHIMERA, TRAINER_ENCOUNTER_MUSIC_AQUA},
    {TRAINER_CLASS_CHIMERA_ADMIN, TRAINER_ENCOUNTER_MUSIC_AQUA},
    {TRAINER_CLASS_CHIMERA_LEADER, TRAINER_ENCOUNTER_MUSIC_AQUA},
    ...
    {TRAINER_CLASS_PERFORMER_M, TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
...
static const u16 sPrizeListRoar[]        = {ITEM_TM_PSYSHOCK,          ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
