...
{
    u16 *berryPlantCount;
    berryPlantCount = GetVarPointer(VAR_BERRY_TREES_PLANTED);
    if (*berryPlantCount < 9999)
        (*berryPlantCount)++;
...
static const u8 sBerryMutations[][3] = {
    {ITEM_TO_BERRY(ITEM_CHERI_BERRY), ITEM_TO_BERRY(ITEM_RAWST_BERRY),   ITEM_TO_BERRY(ITEM_OCCA_BERRY)}, // fire
    {ITEM_TO_BERRY(ITEM_CHESTO_BERRY), ITEM_TO_BERRY(ITEM_ASPEAR_BERRY), ITEM_TO_BERRY(ITEM_PASSHO_BERRY)}, // water
    {ITEM_TO_BERRY(ITEM_ORAN_BERRY),   ITEM_TO_BERRY(ITEM_CHERI_BERRY),  ITEM_TO_BERRY(ITEM_WACAN_BERRY)}, // electric
    {ITEM_TO_BERRY(ITEM_CHESTO_BERRY), ITEM_TO_BERRY(ITEM_RAWST_BERRY), ITEM_TO_BERRY(ITEM_RINDO_BERRY)}, // grass
    {ITEM_TO_BERRY(ITEM_ASPEAR_BERRY), ITEM_TO_BERRY(ITEM_PERSIM_BERRY),  ITEM_TO_BERRY(ITEM_YACHE_BERRY)}, // ice
    {ITEM_TO_BERRY(ITEM_SITRUS_BERRY),  ITEM_TO_BERRY(ITEM_LEPPA_BERRY),   ITEM_TO_BERRY(ITEM_CHOPLE_BERRY)}, // fighting
    {ITEM_TO_BERRY(ITEM_PECHA_BERRY),    ITEM_TO_BERRY(ITEM_ORAN_BERRY), ITEM_TO_BERRY(ITEM_KEBIA_BERRY)}, // poison
    {ITEM_TO_BERRY(ITEM_SITRUS_BERRY), ITEM_TO_BERRY(ITEM_PECHA_BERRY),  ITEM_TO_BERRY(ITEM_SHUCA_BERRY)}, // ground
    {ITEM_TO_BERRY(ITEM_LUM_BERRY), ITEM_TO_BERRY(ITEM_RAWST_BERRY),  ITEM_TO_BERRY(ITEM_COBA_BERRY)}, // flying
    {ITEM_TO_BERRY(ITEM_PERSIM_BERRY),  ITEM_TO_BERRY(ITEM_PECHA_BERRY), ITEM_TO_BERRY(ITEM_PAYAPA_BERRY)}, // psychic
    {ITEM_TO_BERRY(ITEM_LEPPA_BERRY),  ITEM_TO_BERRY(ITEM_CHERI_BERRY),  ITEM_TO_BERRY(ITEM_TANGA_BERRY)}, // bug
    {ITEM_TO_BERRY(ITEM_SITRUS_BERRY), ITEM_TO_BERRY(ITEM_ORAN_BERRY),  ITEM_TO_BERRY(ITEM_CHARTI_BERRY)}, // rock
    {ITEM_TO_BERRY(ITEM_LUM_BERRY), ITEM_TO_BERRY(ITEM_PECHA_BERRY), ITEM_TO_BERRY(ITEM_KASIB_BERRY)}, // ghost
    {ITEM_TO_BERRY(ITEM_ASPEAR_BERRY),  ITEM_TO_BERRY(ITEM_LUM_BERRY), ITEM_TO_BERRY(ITEM_COLBUR_BERRY)}, // dark
    {ITEM_TO_BERRY(ITEM_CHERI_BERRY),  ITEM_TO_BERRY(ITEM_SITRUS_BERRY), ITEM_TO_BERRY(ITEM_BABIRI_BERRY)}, // steel
    // maximum of 15 mutations (only 4 bits are allocated)
};
