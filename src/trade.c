...
static bool8 DoTradeAnim_Cable(void)
{
    ...
    case STATE_START:
        ...
        gSprites[sTradeAnim->monSpriteIds[TRADE_PLAYER]].y2 = gSpeciesInfo[sTradeAnim->monSpecies[TRADE_PLAYER]].frontPicYOffset - 4;
        sTradeAnim->state++;
    ...
    case STATE_SHOW_NEW_MON:
        ...
        gSprites[sTradeAnim->monSpriteIds[TRADE_PARTNER]].y = gSpeciesInfo[sTradeAnim->monSpecies[TRADE_PARTNER]].frontPicYOffset - 4 + 60;
