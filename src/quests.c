...
{
	side_quest(
	      gText_SideQuestName_1, // name of the quest (QUEST_FIND_POKEDEX defined in include/constants/quests.h)
	      gText_SideQuestDesc_1, // description
	      gText_SideQuestDoneDesc_1, // description after completion
	      gText_SideQuestMap1, // what map it takes place on
	      ITEM_PARCEL, // graphic to show
	      ITEM, // type of graphic ("OBJECT", "ITEM", or "PKMN")
	      NULL, // subquest structure reference (all done above)
	      0 // # of subquests (defined in include/constants/quests.h)
	),
	side_quest(
	      gText_SideQuestName_2, // QUEST_GYM_1
	      gText_SideQuestDesc_2,
	      gText_SideQuestDoneDesc_2,
	      gText_SideQuestMap2,
	      SPECIES_SKIDDO,
	      PKMN,
	      NULL, // ah fuck it i dont wanna use subquests
	      0
	),
	side_quest(
	      gText_SideQuestName_3, // QUEST_CHECK_AFTER_GYM_1
	      gText_SideQuestDesc_3,
	      gText_SideQuestDoneDesc_3,
	      gText_SideQuestMap3,
	      OBJ_EVENT_GFX_PROF_ELIA,
	      OBJECT,
	      NULL,
	      0
	),
	side_quest(
	      gText_SideQuestName_4, // QUEST_GYM_2
	...
	side_quest(
	      gText_SideQuestName_5, // QUEST_CHECK_AFTER_GYM_2
	...
	side_quest(
	      gText_SideQuestName_6, // QUEST_GYM_3
	...
	side_quest(
	      gText_SideQuestName_7, // QUEST_GYM_4
	...
	side_quest(
	      gText_SideQuestName_8, // QUEST_GYM_5
	...
	side_quest(
	      gText_SideQuestName_9, // QUEST_GYM_6
	...
	side_quest(
	      gText_SideQuestName_10, // QUEST_GYM_7
	...
	side_quest(
	      gText_SideQuestName_11, // QUEST_GYM_8
	...
	side_quest(
	      gText_SideQuestName_12, // QUEST_CHAMPION
	...
	side_quest(
	      gText_SideQuestName_13, // QUEST_COMPLETE_DEX
	...
	side_quest(
	      gText_SideQuestName_14, // QUEST_TOGEPI_EVIOLITE
	...
	side_quest(
	      gText_SideQuestName_15, // QUEST_BALTOY_DUSK_STONE
	...
	side_quest(
	      gText_SideQuestName_16, // QUEST_PLANT_20_BERRIES
	...
	side_quest(
	      gText_SideQuestName_17, // QUEST_PLANT_50_BERRIES
	...
	side_quest(
	      gText_SideQuestName_18, // QUEST_PLANT_100_BERRIES
	...
	side_quest(
	      gText_SideQuestName_19, // QUEST_PLANT_200_BERRIES
	...
	side_quest(
	      gText_SideQuestName_20, // QUEST_HELP_PIRAEUS
	      gText_SideQuestDesc_20,
	      gText_SideQuestDoneDesc_20,
	      gText_SideQuestMap20,
	      OBJ_EVENT_GFX_PIRAEUS,
	      OBJECT,
	      NULL,
	      0
	),
