...
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_GEN3_RIVAL_ELIO_NORMAL,     OBJ_EVENT_GFX_GEN3_RIVAL_SELENE_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_GEN3_RIVAL_ELIO_MACH_BIKE,  OBJ_EVENT_GFX_GEN3_RIVAL_SELENE_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_GEN3_RIVAL_ELIO_ACRO_BIKE,  OBJ_EVENT_GFX_GEN3_RIVAL_SELENE_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_GEN3_RIVAL_ELIO_SURFING,    OBJ_EVENT_GFX_GEN3_RIVAL_SELENE_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_ELIO_UNDERWATER,       OBJ_EVENT_GFX_SELENE_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_GEN3_RIVAL_ELIO_FIELD_MOVE, OBJ_EVENT_GFX_GEN3_RIVAL_SELENE_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_ELIO_FISHING,          OBJ_EVENT_GFX_SELENE_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_ELIO_WATERING,         OBJ_EVENT_GFX_SELENE_WATERING},
    [PLAYER_AVATAR_STATE_VSSEEKER]   = {OBJ_EVENT_GFX_GEN3_RIVAL_ELIO_FIELD_MOVE, OBJ_EVENT_GFX_GEN3_RIVAL_SELENE_FIELD_MOVE},
};
...
{
    [MALE]   = OBJ_EVENT_GFX_GEN3_RED,
    [FEMALE] = OBJ_EVENT_GFX_GEN3_LEAF
};

static const u8 sRSAvatarGfxIds[GENDER_COUNT] =
{
    [MALE]   = OBJ_EVENT_GFX_GEN3_LINK_RS_ELIO,
    [FEMALE] = OBJ_EVENT_GFX_GEN3_LINK_RS_SELENE
};
...
static bool8 TryPushBoulder(s16 x, s16 y, enum Direction direction)
{
    if (FlagGet(FLAG_SYS_USE_STRENGTH))
    {
        ...
        if (objectEventId != OBJECT_EVENTS_COUNT && gObjectEvents[objectEventId].graphicsId == OBJ_EVENT_GFX_GEN3_PUSHABLE_BOULDER)
        {
...
enum Gender GetPlayerAvatarGenderByGraphicsId(u16 gfxId)
{
    ...
    case OBJ_EVENT_GFX_SELENE_UNDERWATER:
    case OBJ_EVENT_GFX_SELENE_FISHING:
    case OBJ_EVENT_GFX_SELENE_WATERING:
        return FEMALE;
    default:
        return MALE;
    }
