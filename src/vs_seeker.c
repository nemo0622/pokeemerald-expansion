...
static u32 GetGameProgressFlags()
{
    const u32 gameProgressFlags[] = {
        FLAG_VISITED_PANIOLA_TOWN,
        FLAG_VISITED_SEAFOLK_VILLAGE,
        FLAG_SYS_GAME_CLEAR,
...
static bool32 IsRegularLandTrainer(u8 graphicsId)
{
    ...
    {
        OBJ_EVENT_GFX_GEN3_AQUA_MEMBER_F,
        OBJ_EVENT_GFX_GEN3_AQUA_MEMBER_M,
        OBJ_EVENT_GFX_GEN3_BEAUTY,
        OBJ_EVENT_GFX_GEN3_BLACK_BELT,
        OBJ_EVENT_GFX_GEN3_BOY_1,
        OBJ_EVENT_GFX_GEN3_BOY_2,
        OBJ_EVENT_GFX_GEN3_BOY_3,
        OBJ_EVENT_GFX_GEN3_BUG_CATCHER,
        OBJ_EVENT_GFX_GEN3_CAMPER,
        OBJ_EVENT_GFX_GEN3_CYCLING_TRIATHLETE_F,
        OBJ_EVENT_GFX_GEN3_CYCLING_TRIATHLETE_M,
        OBJ_EVENT_GFX_GEN3_EXPERT_F,
        OBJ_EVENT_GFX_GEN3_EXPERT_M,
        OBJ_EVENT_GFX_GEN3_FAT_MAN,
        OBJ_EVENT_GFX_GEN3_FISHERMAN,
        OBJ_EVENT_GFX_GEN3_GENTLEMAN,
        OBJ_EVENT_GFX_GEN3_GIRL_1,
        OBJ_EVENT_GFX_GEN3_GIRL_2,
        OBJ_EVENT_GFX_GEN3_GIRL_3,
        OBJ_EVENT_GFX_GEN3_HEX_MANIAC,
        OBJ_EVENT_GFX_GEN3_HIKER,
        OBJ_EVENT_GFX_GEN3_LASS,
        OBJ_EVENT_GFX_GEN3_LITTLE_BOY,
        OBJ_EVENT_GFX_GEN3_LITTLE_GIRL,
        OBJ_EVENT_GFX_GEN3_MAGMA_MEMBER_F,
        OBJ_EVENT_GFX_GEN3_MAGMA_MEMBER_M,
        OBJ_EVENT_GFX_GEN3_MAN_3,
        OBJ_EVENT_GFX_GEN3_MAN_4,
        OBJ_EVENT_GFX_GEN3_MAN_5,
        OBJ_EVENT_GFX_GEN3_MANIAC,
        OBJ_EVENT_GFX_GEN3_NINJA_BOY,
        OBJ_EVENT_GFX_GEN3_PICNICKER,
        OBJ_EVENT_GFX_GEN3_POKEFAN_F,
        OBJ_EVENT_GFX_GEN3_POKEFAN_M,
        OBJ_EVENT_GFX_GEN3_PSYCHIC_M,
        OBJ_EVENT_GFX_GEN3_RICH_BOY,
        OBJ_EVENT_GFX_GEN3_RUNNING_TRIATHLETE_F,
        OBJ_EVENT_GFX_GEN3_RUNNING_TRIATHLETE_M,
        OBJ_EVENT_GFX_GEN3_SAILOR,
        OBJ_EVENT_GFX_GEN3_SCHOOL_KID_M,
        OBJ_EVENT_GFX_GEN3_TUBER_F,
        OBJ_EVENT_GFX_GEN3_TUBER_M,
        OBJ_EVENT_GFX_GEN3_TWIN,
        OBJ_EVENT_GFX_GEN3_WOMAN_1,
        OBJ_EVENT_GFX_GEN3_WOMAN_2,
        OBJ_EVENT_GFX_GEN3_WOMAN_4,
        OBJ_EVENT_GFX_GEN3_WOMAN_5,
        OBJ_EVENT_GFX_GEN3_YOUNGSTER,
        // OBJ_EVENT_GFX_GEN3_TUBER_F_FRLG,
        // OBJ_EVENT_GFX_GEN3_SAILOR_FRLG,
        // OBJ_EVENT_GFX_GEN3_HIKER_FRLG,
        // OBJ_EVENT_GFX_GEN3_PICNICKER_FRLG,
        // OBJ_EVENT_GFX_GEN3_CAMPER_FRLG,
        // OBJ_EVENT_GFX_GEN3_BEAUTY_FRLG,
        // OBJ_EVENT_GFX_GEN3_WOMAN_2_FRLG,
        // OBJ_EVENT_GFX_GEN3_FAT_MAN_FRLG,
        // OBJ_EVENT_GFX_GEN3_BUG_CATCHER_FRLG,
        // OBJ_EVENT_GFX_GEN3_WOMAN_1_FRLG,
        // OBJ_EVENT_GFX_GEN3_YOUNGSTER_FRLG,
        // OBJ_EVENT_GFX_GEN3_LASS_FRLG,
        // OBJ_EVENT_GFX_GEN3_LITTLE_GIRL_FRLG,
        // OBJ_EVENT_GFX_GEN3_LITTLE_BOY_FRLG,
    };
...
static bool32 IsRegularWaterTrainer(u8 graphicsId)
{
    ...
    {
        OBJ_EVENT_GFX_GEN3_SWIMMER_F,
        OBJ_EVENT_GFX_GEN3_SWIMMER_M,
        OBJ_EVENT_GFX_GEN3_TUBER_M_SWIMMING
    };
