...
static const struct MenuAction sMenuActions_Gender[] = {
    {COMPOUND_STRING("01"), {NULL}},
    {COMPOUND_STRING("02"), {NULL}}
};

static const u8 *const sMalePresetNames[] = {
    COMPOUND_STRING("Amali"),
...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, PALETTES_BG, SPECIES_ARCHEN);
...
{
    return CreateMonPicSprite_Affine(SPECIES_ARCHEN, FALSE, 0, MON_PIC_AFFINE_FRONT, x, y, 14, TAG_NONE);
}
