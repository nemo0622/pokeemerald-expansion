...
const u16 gMetatiles_Hauoli[] = INCBIN_U16("data/tilesets/secondary/hauoli/metatiles.bin");
const u16 gMetatileAttributes_Hauoli[] = INCBIN_U16("data/tilesets/secondary/hauoli/metatile_attributes.bin");
