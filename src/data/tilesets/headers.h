...
const struct Tileset gTileset_Acrisia =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Acrisia,
    .palettes = gTilesetPalettes_Acrisia,
    .metatiles = gMetatiles_Acrisia,
...
const struct Tileset gTileset_KaptaraIsland =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_KaptaraIsland,
    .palettes = gTilesetPalettes_KaptaraIsland,
    .metatiles = gMetatiles_KaptaraIsland,
...
const struct Tileset gTileset_FrescoIsles =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_FrescoIsles,
