static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ACRISIA_CITY - 1] = {MAP_GROUP(ACRISIA_CITY), MAP_NUM(ACRISIA_CITY), 33, 9},
    [HEAL_LOCATION_JUSMAIL_TOWN - 1] = {MAP_GROUP(JUSMAIL_TOWN), MAP_NUM(JUSMAIL_TOWN), 11, 21},
    [HEAL_LOCATION_PYTHIOS_TOWN - 1] = {MAP_GROUP(PYTHIOS_TOWN), MAP_NUM(PYTHIOS_TOWN), 9, 7},
    [HEAL_LOCATION_SOFOS_CITY - 1] = {MAP_GROUP(SOFOS_CITY), MAP_NUM(SOFOS_CITY), 21, 50},
    [HEAL_LOCATION_MARMARO_ISLAND - 1] = {MAP_GROUP(MARMARO_ISLAND), MAP_NUM(MARMARO_ISLAND), 25, 40},
    [HEAL_LOCATION_MYRRINI_ISLAND - 1] = {MAP_GROUP(MYRRINI_ISLAND), MAP_NUM(MYRRINI_ISLAND), 23, 38},
    [HEAL_LOCATION_FRESCO_ISLAND - 1] = {MAP_GROUP(FRESCO_ISLAND), MAP_NUM(FRESCO_ISLAND), 9, 17},
    [HEAL_LOCATION_PALATI_CITY - 1] = {MAP_GROUP(PALATI_CITY), MAP_NUM(PALATI_CITY), 39, 25},
    [HEAL_LOCATION_PORT_PELLO - 1] = {MAP_GROUP(PORT_PELLO), MAP_NUM(PORT_PELLO), 22, 19},
    [HEAL_LOCATION_AREIOS_HIDEOUT - 1] = {MAP_GROUP(AREIOS_HIDEOUT), MAP_NUM(AREIOS_HIDEOUT), 27, 13},
    [HEAL_LOCATION_CHAMPIONS_PEAK_OUTSIDE - 1] = {MAP_GROUP(CHAMPIONS_PEAK_OUTSIDE), MAP_NUM(CHAMPIONS_PEAK_OUTSIDE), 15, 17},
    [HEAL_LOCATION_KALAMI_CITY - 1] = {MAP_GROUP(KALAMI_CITY), MAP_NUM(KALAMI_CITY), 20, 17},
    [HEAL_LOCATION_KIPOS_TOWN - 1] = {MAP_GROUP(KIPOS_TOWN), MAP_NUM(KIPOS_TOWN), 17, 34},
    [HEAL_LOCATION_PENTEPETAL_CITY - 1] = {MAP_GROUP(PENTEPETAL_CITY), MAP_NUM(PENTEPETAL_CITY), 33, 20},
    [HEAL_LOCATION_TOWER_OF_DIOXIPPUS - 1] = {MAP_GROUP(TOWER_OF_DIOXIPPUS), MAP_NUM(TOWER_OF_DIOXIPPUS), 14, 12},
    [HEAL_LOCATION_RUINS_OF_AHIYAWA - 1] = {MAP_GROUP(RUINS_OF_AHIYAWA), MAP_NUM(RUINS_OF_AHIYAWA), 26, 9},
    [HEAL_LOCATION_WAKEWATER_ISLE - 1] = {MAP_GROUP(WAKEWATER_ISLE), MAP_NUM(WAKEWATER_ISLE), 21, 22},
};
