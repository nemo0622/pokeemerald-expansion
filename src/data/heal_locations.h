static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_MARMARO_ISLAND - 1] = {MAP_GROUP(MARMARO_ISLAND), MAP_NUM(MARMARO_ISLAND), 19, 32},
    ...
    [HEAL_LOCATION_KIPOS_TOWN - 1] = {MAP_GROUP(KIPOS_TOWN), MAP_NUM(KIPOS_TOWN), 27, 37},
};
