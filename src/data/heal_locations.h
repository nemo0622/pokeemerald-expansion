static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SOFOS_CITY - 1] = {MAP_GROUP(SOFOS_CITY), MAP_NUM(SOFOS_CITY), 20, 49},
    ...
    [HEAL_LOCATION_FRESCO_ISLAND - 1] = {MAP_GROUP(FRESCO_ISLAND), MAP_NUM(FRESCO_ISLAND), 65, 27},
    [HEAL_LOCATION_PALATI_CITY - 1] = {MAP_GROUP(PALATI_CITY), MAP_NUM(PALATI_CITY), 39, 19},
    [HEAL_LOCATION_PORT_PELLO - 1] = {MAP_GROUP(PORT_PELLO), MAP_NUM(PORT_PELLO), 22, 19},
    [HEAL_LOCATION_AREIOS_HIDEOUT - 1] = {MAP_GROUP(AREIOS_HIDEOUT), MAP_NUM(AREIOS_HIDEOUT), 20, 8},
