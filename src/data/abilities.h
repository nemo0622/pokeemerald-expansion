const struct Ability gAbilitiesInfo[ABILITIES_COUNT] =
{
    ...
    {
        .name = _("Flower Gift"),
        .description = COMPOUND_STRING("Summon sun & change form."),
        .aiRating = 4,
        .cantBeCopied = TRUE,
        .cantBeTraced = TRUE,
        .breakable = TRUE,
    ...
    {
        .name = _("Surge Surfer"),
        .description = COMPOUND_STRING("Set Elec. Terrain & boost Speed."),
        .aiRating = 4,
    },
    ...
    {
        .name = _("Corrosion"),
        .description = COMPOUND_STRING("Poison supereffective on Steel."),
        .aiRating = 5,
    },
