...
const u16 DecorGfx_PICHU_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_PICHU_DOLL
};

const u16 DecorGfx_PIKACHU_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_PIKACHU_DOLL
};

const u16 DecorGfx_MARILL_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_MARILL_DOLL
};

const u16 DecorGfx_TOGEPI_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_TOGEPI_DOLL
};

const u16 DecorGfx_CYNDAQUIL_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_CYNDAQUIL_DOLL
};

const u16 DecorGfx_CHIKORITA_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_CHIKORITA_DOLL
};

const u16 DecorGfx_TOTODILE_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_TOTODILE_DOLL
};

const u16 DecorGfx_JIGGLYPUFF_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_JIGGLYPUFF_DOLL
};

const u16 DecorGfx_MEOWTH_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_MEOWTH_DOLL
};

const u16 DecorGfx_CLEFAIRY_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_CLEFAIRY_DOLL
};

const u16 DecorGfx_DITTO_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_DITTO_DOLL
};

const u16 DecorGfx_SMOOCHUM_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_SMOOCHUM_DOLL
};

const u16 DecorGfx_TREECKO_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_TREECKO_DOLL
};

const u16 DecorGfx_TORCHIC_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_TORCHIC_DOLL
};

const u16 DecorGfx_MUDKIP_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_MUDKIP_DOLL
};

const u16 DecorGfx_DUSKULL_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_DUSKULL_DOLL
};

const u16 DecorGfx_WYNAUT_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_WYNAUT_DOLL
};

const u16 DecorGfx_BALTOY_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_BALTOY_DOLL
};

const u16 DecorGfx_KECLEON_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_KECLEON_DOLL
};

const u16 DecorGfx_AZURILL_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_AZURILL_DOLL
};

const u16 DecorGfx_SKITTY_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_SKITTY_DOLL
};

const u16 DecorGfx_SWABLU_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_SWABLU_DOLL
};

const u16 DecorGfx_GULPIN_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_GULPIN_DOLL
};

const u16 DecorGfx_LOTAD_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_LOTAD_DOLL
};

const u16 DecorGfx_SEEDOT_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_SEEDOT_DOLL
};

const u16 DecorGfx_PIKA_CUSHION[] = {
    OBJ_EVENT_GFX_DECOR_PIKA_CUSHION
};

const u16 DecorGfx_ROUND_CUSHION[] = {
    OBJ_EVENT_GFX_DECOR_ROUND_CUSHION
};

const u16 DecorGfx_KISS_CUSHION[] = {
    OBJ_EVENT_GFX_DECOR_KISS_CUSHION
};

const u16 DecorGfx_ZIGZAG_CUSHION[] = {
    OBJ_EVENT_GFX_DECOR_ZIGZAG_CUSHION
};

const u16 DecorGfx_SPIN_CUSHION[] = {
    OBJ_EVENT_GFX_DECOR_SPIN_CUSHION
};

const u16 DecorGfx_DIAMOND_CUSHION[] = {
    OBJ_EVENT_GFX_DECOR_DIAMOND_CUSHION
};

const u16 DecorGfx_BALL_CUSHION[] = {
    OBJ_EVENT_GFX_DECOR_BALL_CUSHION
};

const u16 DecorGfx_GRASS_CUSHION[] = {
    OBJ_EVENT_GFX_DECOR_GRASS_CUSHION
};

const u16 DecorGfx_FIRE_CUSHION[] = {
    OBJ_EVENT_GFX_DECOR_FIRE_CUSHION
};

const u16 DecorGfx_WATER_CUSHION[] = {
    OBJ_EVENT_GFX_DECOR_WATER_CUSHION
};

const u16 DecorGfx_SNORLAX_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_BIG_SNORLAX_DOLL
};

const u16 DecorGfx_RHYDON_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_BIG_RHYDON_DOLL
};

const u16 DecorGfx_LAPRAS_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_BIG_LAPRAS_DOLL
};

const u16 DecorGfx_VENUSAUR_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_BIG_VENUSAUR_DOLL
};

const u16 DecorGfx_CHARIZARD_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_BIG_CHARIZARD_DOLL
};

const u16 DecorGfx_BLASTOISE_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_BIG_BLASTOISE_DOLL
};

const u16 DecorGfx_WAILMER_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_BIG_WAILMER_DOLL
};

const u16 DecorGfx_REGIROCK_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_BIG_REGIROCK_DOLL
};

const u16 DecorGfx_REGICE_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_BIG_REGICE_DOLL
};

const u16 DecorGfx_REGISTEEL_DOLL[] = {
    OBJ_EVENT_GFX_DECOR_BIG_REGISTEEL_DOLL
};
