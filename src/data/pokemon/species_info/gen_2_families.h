...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_THICK_LAYERS, ABILITY_TRIAGE },
        ...
        .description = COMPOUND_STRING(
            "Its leaves produce a fresh fragrance\n" // custom entry 5/11/25
            "to soothe nearby Pokémon. Because of\n"
            "this, small, weaker Pokémon flock to\n"
            "Chikorita in the wild."),
        .pokemonScale = 512,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BAYLEEF] =
    {
        ...
        .weight = 158,
        .description = COMPOUND_STRING(
            "Bayleef are extremely energetic, bounding\n" // custom entry 5/11/25
            "across grasslands and darting between\n"
            "trees. Scientists believe this is caused\n"
            "by the fragrance they release."),
        .pokemonScale = 296,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MEGANIUM] =
    {
        ...
        .weight = 1005,
        .description = COMPOUND_STRING(
            "Flowers are said to bloom where Meganium\n" // custom entry 5/11/25
            "walks. They show their affection by\n"
            "releasing calming scents and softly\n"
            "grunting, bringing smiles to all."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 277,
        .trainerOffset = 1,
    ...
    [SPECIES_MEGANIUM_MEGA] =
    {
        ...
        .weight = 1005,
        .description = COMPOUND_STRING(
            "Mega Meganium's flowers produce an aroma\n" // new 
            "stronger than any perfume. Its fur grows\n"
            "much thicker due to the Mega power,\n"
            "drastically increasing Meganium's defense."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 277,
        .trainerOffset = 1,
    ...
    [SPECIES_CYNDAQUIL] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_FLASH_FIRE, ABILITY_STAMINA },
        ...
        .weight = 79,
        .description = COMPOUND_STRING(
            "It is believed that the flames on a\n" // customy entry 5/11/25
            "Cyndaquil's back evolved as a defense\n"
            "mechanism. Trainers must be careful\n"
            "to avoid being burned at first."),
        .pokemonScale = 539,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_QUILAVA] =
    {
        ...
        .weight = 190,
        .description = COMPOUND_STRING(
            "Quilava fur is famed for its toughness\n" // custom entry 5/11/25
            "and resistance to fire. They move with\n"
            "caution, but when pushed to fight, they\n"
            "can shrug off many attacks with ease."),
        .pokemonScale = 329,
        .pokemonOffset = 11,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TYPHLOSION] =
    {
        ...
        .weight = 795,
        .description = COMPOUND_STRING(
            "Like flipping a switch, Typhlosion are the\n" // custom entry 5/11/25
            "opposites of Quilava. Instead of being\n"
            "cautious, they are extremely territorial,\n"
            "torching anything that gets too close."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 268,
        .trainerOffset = 1,
    ...
    [SPECIES_TYPHLOSION_HISUIAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_FRISK, ABILITY_COMATOSE },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Typhlosion"),
        .cryId = CRY_TYPHLOSION,
        .natDexNum = NATIONAL_DEX_TYPHLOSION,
        ...
        .weight = 698,
        .description = COMPOUND_STRING(
            "This subspecies of Typhlosion is much more\n" // custom entry 5/11/25
            "laid back than their common counterpart.\n"
            "Ancient stories speak of their ability to\n"
    ...
    [SPECIES_TOTODILE] =
    {
        ...
        .weight = 95,
        .description = COMPOUND_STRING(
            "Totodile are capable of crunching through\n" // custom entry 5/11/25
            "most common objects, to the dismay of new\n"
            "Trainers. They dive and roll in shallow\n"
            "water while playing."),
        .pokemonScale = 487,
        .pokemonOffset = 20,
        .trainerScale = 256,
    ...
    [SPECIES_CROCONAW] =
    {
        ...
        .weight = 250,
        .description = COMPOUND_STRING(
            "Its jaws are extremely powerful, crushing\n" // custom entry 5/12/25
            "through flesh and bone alike. Croconaw\n"
            "teeth are curved, making them even harder\n"
            "to remove. They can also grow back quickly."),
        .pokemonScale = 378,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FERALIGATR] =
    {
        ...
        .weight = 888,
        .description = COMPOUND_STRING(
            "It swims with its nose and crest peeking\n" // custom entry 5/12/25
            "above the water, disguising its true size.\n"
            "Interestingly, it shows a soft side to wild\n"
            "Pikipek, who pluck food out of its teeth."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 342,
        .trainerOffset = 7,
    ...
    [SPECIES_FERALIGATR_MEGA] =
    {
        ...
        .weight = 888,
        .description = COMPOUND_STRING(
            "Mega Feraligatr's hood-like appendage and\n" // new
            "arm spikes make it resemble an overgrown\n"
            "Totodile. Don't be fooled, though - it can\n"
            "deliver deadly blows by snapping them shut!"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 342,
        .trainerOffset = 7,
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Ilios hold Noctowl in high regard."), // new desc
        .pokemonScale = 278,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_ILLUMINATE, ABILITY_DAZZLING },
        .bodyColor = BODY_COLOR_WHITE,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_AZURILL] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_THICK_LAYERS, ABILITY_HUGE_POWER, ABILITY_SAP_SIPPER },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_LEAF_GUARD, ABILITY_HOSPITALITY },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_YANMA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SPEED_BOOST, ABILITY_COMPOUND_EYES, ABILITY_WIND_RIDER },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Yanma"),
        .cryId = CRY_YANMA,
    ...
    [SPECIES_YANMEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SPEED_BOOST, ABILITY_TINTED_LENS, ABILITY_WIND_RIDER },
        .bodyColor = BODY_COLOR_GREEN,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_RUN_AWAY, ABILITY_EARTH_EATER },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_MAGCARGO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_ROCKY_PAYLOAD, ABILITY_FLAME_BODY, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
    ...
    [SPECIES_SWINUB] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_THICK_LAYERS, ABILITY_FUR_COAT },
        .bodyColor = BODY_COLOR_BROWN,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_CORSOLA_GALARIAN] =
    {
        ...
        .formSpeciesIdTable = sCorsolaFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_CURSOLA}),
    },
    ...
    [SPECIES_MILTANK] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_THICK_LAYERS, ABILITY_SCRAPPY, ABILITY_SAP_SIPPER },
    #else
        .abilities = { ABILITY_THICK_LAYERS, ABILITY_NONE, ABILITY_SAP_SIPPER },
    #endif
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_LUGIA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_WATER_BUBBLE, ABILITY_NONE, ABILITY_MULTISCALE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Lugia"),
        .cryId = CRY_LUGIA,
    ...
    [SPECIES_HO_OH] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SOUL_HEART, ABILITY_NONE, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Ho-Oh"),
        .cryId = CRY_HO_OH,
