...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_SPRIGATITO] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_UNNERVE, ABILITY_PROTEAN },
        ...
        .description = COMPOUND_STRING(
            "Sprigatito was thought to be closely\n"
            "related to Litten, but it is now thought\n"
            "to be a case of Convergent Evolution.\n"
            "It gains energy from the sun and soil."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FLORAGATO] =
    {
        ...
        .weight = 122,
        .description = COMPOUND_STRING(
            "This Pokémon takes pride in tricking\n"
            "others, hiding a long vine tipped\n"
            "with a flower bud to play tricks on\n"
            "foes and fellow party Pokémon alike."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MEOWSCARADA] =
    {
        ...
        .weight = 312,
        .description = COMPOUND_STRING(
            "Meowscarada have fun hiding their\n"
            "true intent from opponents, using\n"
            "illusions and tricks to fool them\n"
    ...
    [SPECIES_FUECOCO] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_UNAWARE, ABILITY_DRY_SKIN },
        ...
        .weight = 98,
        .description = COMPOUND_STRING(
            "It relies on a daily routine of laying\n"
            "to rest on sunlit rocks to refuel their\n"
            "fire energy. Some fire leaks out, making\n"
            "a hairlike shape on its head."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CROCALOR] =
    {
        ...
        .weight = 307,
        .description = COMPOUND_STRING(
            "Crocalor concentrates excess flame\n"
            "energy into its head, creating an oval\n"
            "fireball on a rim of flames. It enjoys\n"
            "singing, although it is still learning."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SKELEDIRGE] =
    {
        ...
        .weight = 3265,
        .description = COMPOUND_STRING(
            "Excess fire energy manifests into a semi-\n"
            "independent bird of flame. Skeledirge is\n"
            "happiest when singing, using powerful\n"
            "vocals to stoke their internal flames."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_QUAXLY] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_STRONG_LEGS, ABILITY_MOXIE },
        ...
        .weight = 61,
        .description = COMPOUND_STRING(
            "It once ranged across an entire sea,\n"
            "but environmental change has limited it\n"
            "to a few populations on islands. It\n"
            "finds joy in grooming its feathers."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_QUAXWELL] =
    {
        ...
        .weight = 215,
        .description = COMPOUND_STRING(
            "It is constantly training its legs\n"
            "for dancing and battles alike. They\n"
            "learn from other dancing Pokémon such\n"
            "as Oricorio, developing new styles."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_QUAQUAVAL] =
    {
        ...
        .weight = 619,
        .description = COMPOUND_STRING(
            "Quaquaval is a true master in the art\n"
            "of dance, being inspired by people and\n"
            "Pokémon from around the world. Their\n"
            "legs are far stronger than they look."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LECHONK] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_AROMA_VEIL, ABILITY_GLUTTONY, ABILITY_THICK_LAYERS },
    ...
    [SPECIES_OINKOLOGNE_MALE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_LINGERING_AROMA, ABILITY_GLUTTONY, ABILITY_THICK_LAYERS },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_PAWMI] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_PAWMO}),
    },
    ...
    [SPECIES_CHARCADET] =
    {
        ...
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_FLAME_BODY, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_TOEDSCOOL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_MYCELIUM_MIGHT, ABILITY_NONE, ABILITY_EFFECT_SPORE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CETODDLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_THICK_LAYERS, ABILITY_SNOW_CLOAK, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_CETITAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_THICK_LAYERS, ABILITY_SLUSH_RUSH, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_WHITE,
...
#if P_FAMILY_OGERPON
#define OGERPON_SPECIES_INFO(Form1, Form2, type, ability, hiddenAbility, color, iconpalette, isTeraform, shadowX, shadowY, shadowSize)   \
    {                                                                                       \
        .baseHP        = 80,                                                                \
        .baseAttack    = 120,                                                               \
        .baseDefense   = 84,                                                                \
        ...
        .growthRate = GROWTH_SLOW,                                                          \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),                          \
        .abilities = { ability, ABILITY_NONE, hiddenAbility },                              \
        .bodyColor = color,                                                                 \
        ...
        SHADOW(shadowX, shadowY, shadowSize)                                                \
        FOOTPRINT(Ogerpon)                                                                  \
        OVERWORLD(                                                                          \
    ...
    [SPECIES_OGERPON_TEAL_MASK]             = OGERPON_SPECIES_INFO(Teal,        Mask,     TYPE_GRASS, ABILITY_DEFIANT, ABILITY_EMBODY_ASPECT_TEAL_MASK, BODY_COLOR_GREEN, 1, FALSE, 0, 11, SHADOW_SIZE_M),
    [SPECIES_OGERPON_WELLSPRING_MASK]       = OGERPON_SPECIES_INFO(Wellspring,  Mask,     TYPE_WATER, ABILITY_WATER_ABSORB, ABILITY_EMBODY_ASPECT_WELLSPRING_MASK, BODY_COLOR_BLUE,  0, FALSE, -2, 12, SHADOW_SIZE_S),
    [SPECIES_OGERPON_HEARTHFLAME_MASK]      = OGERPON_SPECIES_INFO(Hearthflame, Mask,     TYPE_FIRE,  ABILITY_MOLD_BREAKER, ABILITY_EMBODY_ASPECT_HEARTHFLAME_MASK, BODY_COLOR_RED,   0, FALSE, -2, 12, SHADOW_SIZE_M),
    [SPECIES_OGERPON_CORNERSTONE_MASK]      = OGERPON_SPECIES_INFO(Cornerstone, Mask,     TYPE_ROCK,  ABILITY_STURDY, ABILITY_EMBODY_ASPECT_CORNERSTONE_MASK, BODY_COLOR_GRAY,  0, FALSE, -1, 12, SHADOW_SIZE_M),
#if P_TERA_FORMS
    [SPECIES_OGERPON_TEAL_MASK_TERA]        = OGERPON_SPECIES_INFO(Teal,        MaskTera, TYPE_GRASS, ABILITY_EMBODY_ASPECT_TEAL_MASK,        BODY_COLOR_GREEN, 1, TRUE, 0, 0, 0),
    [SPECIES_OGERPON_WELLSPRING_MASK_TERA]  = OGERPON_SPECIES_INFO(Wellspring,  MaskTera, TYPE_WATER, ABILITY_EMBODY_ASPECT_WELLSPRING_MASK,  BODY_COLOR_BLUE,  0, TRUE, 0, 0, 0),
    [SPECIES_OGERPON_HEARTHFLAME_MASK_TERA] = OGERPON_SPECIES_INFO(Hearthflame, MaskTera, TYPE_FIRE,  ABILITY_EMBODY_ASPECT_HEARTHFLAME_MASK, BODY_COLOR_RED,   0, TRUE, 0, 0, 0),
    [SPECIES_OGERPON_CORNERSTONE_MASK_TERA] = OGERPON_SPECIES_INFO(Cornerstone, MaskTera, TYPE_ROCK,  ABILITY_EMBODY_ASPECT_CORNERSTONE_MASK, BODY_COLOR_GRAY,  0, TRUE, 0, 0, 0),
#endif //P_TERA_FORMS
