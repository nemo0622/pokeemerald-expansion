...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_CHESPIN] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_LONG_REACH, ABILITY_SPIKED_SHELL },
        ...
        .description = COMPOUND_STRING(
            "Chespin eats so many berries, the shell\n"
            "covering their body becomes hard due\n"
            "to increased nutrition. They can harden\n"
            "the spines on their body."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_QUILLADIN] =
    {
        ...
        .weight = 290,
        .description = COMPOUND_STRING(
            "Quilladin are very peaceful in the wild,\n"
            "forming colonies with Chespin and tending\n"
            "to berry bush groves. When threatened, it\n"
            "can use hard quills to protect themselves."),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CHESNAUGHT] =
    {
        ...
        .weight = 900,
        .description = COMPOUND_STRING(
            "They excel in defensive battles, using\n"
            "powerful arms and padding to block any\n"
            "attack. Chesnaught trained with love\n"
            "will protect a Trainer from anything."),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_CHESNAUGHT_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SPIKED_SHELL, ABILITY_SPIKED_SHELL, ABILITY_SPIKED_SHELL },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Chesnaught"),
        .cryId = CRY_CHESNAUGHT,
        .natDexNum = NATIONAL_DEX_CHESNAUGHT,
        ...
        .weight = 900,
        .description = COMPOUND_STRING(
            "Mega Chesnaught develops huge, shield-like\n" // new desc
            "barriers on its back. When attacking, it\n"
            "removes one, wielding it like a hammer and\n"
            "crushing most opponents in one hit."),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_FENNEKIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_MAGICIAN, ABILITY_TANGLING_HAIR },
        ...
        .weight = 94,
        .description = COMPOUND_STRING(
            "Instead of fighting, Fennekin often\n"
            "searches for sticks to snack on. They\n"
            "seem to prefer old, dry wood, becoming\n"
            "excited by the flammable treat."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BRAIXEN] =
    {
        ...
        .weight = 145,
        .description = COMPOUND_STRING(
            "Following their love of branches and\n"
            "twigs as a Fennekin, Braixen has evolved\n"
            "to use them in battle. Their branch can\n"
            "send signals and create strong flames."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_DELPHOX] =
    {
        ...
        .weight = 390,
        .description = COMPOUND_STRING(
            "Delphox has become perfectly adapted for\n"
            "ranged attacks, using their branch to\n"
            "cast powerful spells and control fire.\n"
            "It moves projectiles with telekinesis."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_DELPHOX_MEGA] =
    {
        ...
        .weight = 390,
        .description = COMPOUND_STRING(
            "Mega Delphox takes to the skies, riding\n" // new desc
            "branches controlled with psychic powers.\n"
            "Its flames mesmerize opponents and lowers\n"
            "their defenses before striking."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_FROAKIE] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_WATER_BUBBLE, ABILITY_PROTEAN },
        ...
        .weight = 70,
        .description = COMPOUND_STRING(
            "Froakie must never stray too far from\n"
            "water, as it needs to be constantly damp\n"
            "to be at full strength. It blows bubbles\n"
    ...
    [SPECIES_FROGADIER] =
    {
        ...
        .weight = 109,
        .description = COMPOUND_STRING(
            "It is often found clinging to the sides\n"
            "of trees, rocks, and even houses near\n"
            "their home pond. It can blast opponents\n"
            "with strong barrages of bubbles."),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GRENINJA_MEGA] =
    {
        ...
        .weight = 400,
        .description = COMPOUND_STRING(
            "Mega Greninja controls a large floating\n" // new desc
            "throwing star made of water. As it stalks\n"
            "its prey, it may choose to hang upside-down\n"
            "from the star, gaining the high ground."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_GOGOAT] =
    {
        ...
        .baseSpAttack  = 97,
        .baseSpDefense = 81,
        .types = MON_TYPES(TYPE_GRASS, TYPE_GROUND), // could also be Normal type instead? hmm
        .catchRate = 45,
        .expYield = 186,
        .evYield_HP = 2,
        .genderRatio = PERCENT_FEMALE(50),
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_HONEDGE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_DOUBLADE}),
    },
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_DRAGALGE_MEGA] =
    {
        ...
        .weight = 815,
        .description = COMPOUND_STRING(
            "Folktales of Ilian sailors crossing kelp\n"
            "forests that come alive were thought to be\n"
            "mere legends until the discovery of Mega\n"
            "Dragalge. Now, some researchers wonder..."),
        .pokemonScale = 267,
        .pokemonOffset = 2,
        .trainerScale = 286,
        .trainerOffset = 1,
    ...
    [SPECIES_TYRUNT] =
    {
        ...
        .weight = 260,
        .description = COMPOUND_STRING(
            "It may look scary, but Tyrunt is quite\n" // new desc
            "immature and cannot control its power.\n"
            "It is prone to throwing tantrums, shutting\n"
            "down streets until it tires out."),
        .pokemonScale = 366,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_DAY, 34, SPECIES_TYRANTRUM}),
    },
    ...
    [SPECIES_TYRANTRUM] =
    {
        ...
        .weight = 2700,
        .description = COMPOUND_STRING(
            "Tyrantrum was likely once the apex predator\n" // new desc
            "of its age. Following millennia of decline,\n"
            "however, Tyrantrum are currently extremely\n"
            "rare. Their strength has never declined."),
        .pokemonScale = 257,
        .pokemonOffset = 10,
        .trainerScale = 423,
        .trainerOffset = 8,
    ...
    [SPECIES_AMAURA] =
    {
        ...
        .abilities = { ABILITY_REFRIGERATE, ABILITY_NONE, ABILITY_PRISM_ARMOR },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .weight = 252,
        .description = COMPOUND_STRING(
            "Amaura traditionally lives in areas of\n" // new desc
            "extreme cold where there are no major\n"
            "predators. It uses light-up frills to\n"
            "get the attention of nearby Aurorus."),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_NIGHT, 34, SPECIES_AURORUS}),
    },
    ...
    [SPECIES_AURORUS] =
    {
        ...
        .weight = 2250,
        .description = COMPOUND_STRING(
            "Its giant frills can be used for combat,\n" // new desc
            "releasing waves of ice at opponents. New\n"
            "studies show that the lights they produce\n"
            "are used for communication across distances."),
        .pokemonScale = 275,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HAWLUCHA] =
    {
        ...
        .weight = 215,
        .description = COMPOUND_STRING(
            "Hawlucha gracefully glides through the\n" // new desc
            "air while battling. It takes advantage\n"
            "of the slightest air movements to pummel\n"
            "foes many times its size."),
        .pokemonScale = 366,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_HAWLUCHA_MEGA] =
    {
        ...
        .weight = 215,
        .description = COMPOUND_STRING(
            "It is obsessed with image, doing its best\n" // new desc
            "battling with cheering crowds behind it.\n"
            "Mega Hawlucha's combination of bulk and\n"
            "power allows it to crush all competition."),
        .pokemonScale = 366,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_DEDENNE] =
    {
        ...
        .abilities = { ABILITY_CHEEK_POUCH, ABILITY_PIXILATE, ABILITY_TRANSISTOR },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_PUMPKABOO_AVERAGE] =
    {
        ...
        .abilities = { ABILITY_TANGLING_HAIR, ABILITY_FRISK, ABILITY_INSOMNIA },
        .bodyColor = BODY_COLOR_BROWN,
