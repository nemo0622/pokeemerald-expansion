...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_CRANIDOS] =
    {
        ...
        .weight = 315,
        .description = COMPOUND_STRING(
            "Thought to have gone extinct 100 million\n" // custom entry 5/12/25
            "years ago, it was recently rediscovered\n"
            "near Péntepetal City. Tragically, it has\n"
            "already been hunted down for its skull."),
        .pokemonScale = 338,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_RAMPARDOS] =
    {
        ...
        .weight = 1025,
        .description = COMPOUND_STRING(
            "Strong Cranidos which prove their power\n" // custom entry 5/12/25
            "in battle may evolve into Rampardos.\n"
            "Their bodies are perfectly designed for\n"
            "rough combat."),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
    ...
    [SPECIES_SHIELDON] =
    {
        ...
        .weight = 570,
        .description = COMPOUND_STRING(
            "This Lazarus Taxa species has already been\n" // custom entry 5/12/25
            "nearly hunted to extinction after its\n"
            "rediscovery. It only survives in zoos and\n"
    ...
    [SPECIES_BASTIODON] =
    {
        ...
        .weight = 1495,
        .description = COMPOUND_STRING(
            "Bastiodon are living shields, forming\n" // custom entry 5/12/25
            "protective walls around their young.\n"
            "Despite their ferocious appearance, they\n"
            "prefer calm environments to rest and play."),
        .pokemonScale = 272,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_BUIZEL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_WATER_VEIL, ABILITY_PROPELLER_TAIL },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CHERRIM_OVERCAST] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_GRASS),
        .abilities = { ABILITY_FLOWER_GIFT, ABILITY_NONE, ABILITY_DROUGHT },
    ...
    [SPECIES_PURUGLY] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_THICK_LAYERS, ABILITY_OWN_TEMPO, ABILITY_DEFIANT },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_CHATOT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_BIG_PECKS, ABILITY_VOCALIST },
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_PRESSURE, ABILITY_INFILTRATOR, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_PURPLE,
        ...
        .weight = 1080,
        .description = COMPOUND_STRING(
            "Legends tell of these Pokémon\n" // custom entry 5/12/25
            "being born from bloodshed during war,\n"
            "each containing 108 lost souls. Scientists\n"
    ...
    [SPECIES_SKORUPI] =
    {
        ...
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_SNIPER, ABILITY_ANGER_SHELL },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SNOVER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_SNOW_WARNING, ABILITY_NONE, ABILITY_LONG_REACH },
        .bodyColor = BODY_COLOR_WHITE,
        ...
        .weight = 505,
        .description = COMPOUND_STRING(
            "Snover is a highly inquisitive Pokémon.\n" // new desc
            "If it finds footprints, it will try to\n"
            "follow their path and find whatever made\n"
            "them. They love to play in the snow."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_ABOMASNOW] =
    {
        ...
        .weight = 1355,
        .description = COMPOUND_STRING(
            "Abomasnow springs to life during harsh\n" // new desc
            "snowstorms, giving them a poor reputation.\n"
            "We now know that stories of the abominable\n"
            "snowman are from run-ins with Abomasnow."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 348,
        .trainerOffset = 6,
    ...
    [SPECIES_ABOMASNOW_MEGA] =
    {
        ...
        .weight = 1850,
        .description = COMPOUND_STRING(
            "Mega Abomasnow grows huge spikes of ice\n" // new desc
            "upon changing form. The weight of these\n"
            "growths can be difficult to manage, but\n"
            "they make Abomasnow even more formidable."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 348,
        .trainerOffset = 6,
