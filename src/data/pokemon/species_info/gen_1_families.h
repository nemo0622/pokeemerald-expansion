...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_CHLOROPHYLL, ABILITY_THICK_LAYERS },
    ...
    [SPECIES_CATERPIE] =
    {
        ...
        .weight = 29,
        .description = COMPOUND_STRING(
            "It uses its antennae to fight with\n"
            "other Caterpie and Weedle. It can easily\n"
            "eat leaves many times its size, which\n"
            "can damage crop fields."), // new desc
        .pokemonScale = 549,
        .pokemonOffset = 22,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_METAPOD] =
    {
        ...
        .weight = 99,
        .description = COMPOUND_STRING(
            "It can hardly move, as its limbs\n"
            "are undergoing transformation within\n"
            "its shell. They try their best to\n"
            "hide from predators."), // new desc
        .pokemonScale = 350,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BUTTERFREE] =
    {
        ...
        .weight = 320,
        .description = COMPOUND_STRING(
            "Butterfree lives off of honey and nectar\n"
            "from wild plants in their environment.\n"
            "Farmers often keep populations of them\n"
            "to pollinate crops."), // new desc
        .pokemonScale = 312,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_RATTATA_ALOLAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_GLUTTONY, ABILITY_HUSTLE, ABILITY_THICK_LAYERS },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Rattata"),
        .cryId = CRY_RATTATA,
        .natDexNum = NATIONAL_DEX_RATTATA,
    ...
    [SPECIES_RATICATE_ALOLAN_TOTEM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_THICK_LAYERS, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Raticate"),
        .cryId = CRY_RATICATE,
        .natDexNum = NATIONAL_DEX_RATICATE,
    ...
    [SPECIES_SPEAROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_TECHNICIAN, ABILITY_NONE, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PICHU_SPIKY_EARED] =
    {
        ...
        SHADOW(-2, 0, SHADOW_SIZE_S)
        FOOTPRINT(Pichu)
        .levelUpLearnset = sSpikyEarPichuLevelUpLearnset,
        OVERWORLD(
...
#define RAICHU_SPEED 120
    ...
    [SPECIES_RAICHU_MEGA_X] =
    {
        ...
        .weight = 300,
        .description = COMPOUND_STRING(
            "Mega Raichu's X form can float using\n" // new desc
            "electromagnetism, repelling itself from\n"
            "the ground with its tails. Its electric\n"
            "fists can take down almost any foe."),
        .pokemonScale = 426,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_RaichuMega_X,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_RaichuMega_X,
        .frontAnimId = ANIM_GROW_VIBRATE,
        .backPic = gMonBackPic_RaichuMega_X,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 6,
        .backAnimId = BACK_ANIM_SHAKE_FLASH_YELLOW,
        .palette = gMonPalette_RaichuMega_X,
        .shinyPalette = gMonShinyPalette_RaichuMega_X,
        .iconSprite = gMonIcon_RaichuMega_X,
        .iconPalIndex = 0,
    ...
    [SPECIES_RAICHU_MEGA_Y] =
    {
        ...
        .weight = 300,
        .description = COMPOUND_STRING(
            "Mega Raichu's Y form shrinks in size, but\n" // new desc
            "grows exponentially stronger in its control\n"
            "over electricity. It can unleash a charge\n"
            "instantly, giving foes no time to react."),
        .pokemonScale = 426,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_RaichuMega_Y,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_RaichuMega_Y,
        .frontAnimId = ANIM_GROW_VIBRATE,
        .backPic = gMonBackPic_RaichuMega_Y,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 6,
        .backAnimId = BACK_ANIM_SHAKE_FLASH_YELLOW,
        .palette = gMonPalette_RaichuMega_Y,
        .shinyPalette = gMonShinyPalette_RaichuMega_Y,
        .iconSprite = gMonIcon_RaichuMega_Y,
        .iconPalIndex = 0,
    ...
    [SPECIES_SANDSHREW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAND_VEIL, ABILITY_SAND_RUSH, ABILITY_EARTH_EATER },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_WIGGLYTUFF] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "divine. Supposedly, some can go on\n"
            "fearsome rampages."),
        .pokemonScale = 328,
        .pokemonOffset = 11,
        .trainerScale = 256,
    ...
    [SPECIES_PARAS] =
    {
        ...
        .abilities = { ABILITY_EFFECT_SPORE, ABILITY_DAMP, ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Paras"),
        .cryId = CRY_PARAS,
...
#define DUGTRIO_ATTACK (P_UPDATED_STATS >= GEN_7 ? 100 : 80)
    ...
    [SPECIES_MEOWTH] =
    {
        ...
        .weight = 42,
        .description = COMPOUND_STRING(
            "Meowth is a popular pet in Ilios.\n"
            "This Pokémon adores the shine of gold,\n"
            "motivating them to collect hoards of it.\n"
            "These include priceless ancient coins!"),
        .pokemonScale = 480,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 27, SPECIES_PERSIAN}),
    },
    ...
    [SPECIES_PERSIAN] =
    {
        ...
        .weight = 320,
        .description = COMPOUND_STRING(
            "Persian's whiskers can detect the slightest\n" // new desc
            "change in air currents. When threatened,\n"
            "the gem on its head begins to glow with\n"
            "a mysterious power."),
        .pokemonScale = 320,
        .pokemonOffset = 10,
        .trainerScale = 256,
    ...
    [SPECIES_MEOWTH_ALOLAN] =
    {
        ...
        .weight = 42,
        .description = COMPOUND_STRING(
            "Meowth's Alolan variant was bred to live\n" // new desc
            "alongside royalty. This may be why it is so\n"
            "proud by nature, expecting Trainers to meet\n"
            "its every desire."),
        .pokemonScale = 480,
        .pokemonOffset = 19,
        .trainerScale = 256,
        ...
        .formSpeciesIdTable = sMeowthFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 27, SPECIES_PERSIAN_ALOLAN}),
    },
    ...
    [SPECIES_PERSIAN_ALOLAN] =
    {
        ...
        .weight = 330,
        .description = COMPOUND_STRING(
            "Its previos form's pride is taken to an\n" // new desc
            "extreme in Alolan Persian. It toys with\n"
            "opponents to entertain itself, letting them\n"
            "start to run off before capturing them."),
        .pokemonScale = 320,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MEOWTH_GALARIAN] =
    {
        ...
        .weight = 75,
        .description = COMPOUND_STRING(
            "An ancient seafaring people once lived\n" // new desc
            "alongside this variant of Meowth. By eating\n"
            "scraps of bronze and other metals, its\n"
            "fur has become extremelty strong."),
        .pokemonScale = 480,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
        ...
        .formSpeciesIdTable = sMeowthFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 27, SPECIES_PERRSERKER}),
    },
    ...
    [SPECIES_PERRSERKER] =
    {
        ...
        .weight = 280,
        .description = COMPOUND_STRING(
            "Old murals across the Ilios Region show\n" // new desc
            "raids by seafaring people along with their\n"
            "Perrserker. They may be responsible for\n"
            "a temporary decline of ancient Ilios."),
        .pokemonScale = 366,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_PSYDUCK] =
    {
        ...
        .abilities = { ABILITY_DAMP, ABILITY_CLOUD_NINE, ABILITY_SOUNDPROOF },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_GOLDUCK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_DAMP, ABILITY_CLOUD_NINE, ABILITY_VOCALIST },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GROWLITHE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_FLASH_FIRE, ABILITY_FUR_COAT },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_GROWLITHE_HISUIAN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_ROCK_HEAD, ABILITY_FUR_COAT },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Growlithe"),
        .cryId = CRY_GROWLITHE,
        .natDexNum = NATIONAL_DEX_GROWLITHE,
...
#define ALAKAZAM_SP_DEF (P_UPDATED_STATS >= GEN_6 ? 95 : 85)
    ...
    [SPECIES_BELLSPROUT] =
    {
        ...
        .weight = 40,
        .description = COMPOUND_STRING(
            "Bellsprout can root themselves into the\n" // new desc
            "soil, drawing nutrients and standing\n"
            "against attacks. It creates a sweet smell\n"
            "to attract Bug-type prey."),
        .pokemonScale = 354,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WEEPINBELL] =
    {
        ...
        .weight = 64,
        .description = COMPOUND_STRING(
            "This Pokémon hangs upside down to hide\n" // new desc
            "amongst tree leaves. Many orchard farmers\n"
            "in Ilios will go to pick fruits, just\n"
            "to be hit by a falling Weepinbell."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VICTREEBEL] =
    {
        ...
        .weight = 155,
        .description = COMPOUND_STRING(
            "Victreebel acid smells strongly like honey.\n" // new desc
            "They live in dense groups, attracting\n"
            "unsuspecting prey to their demise. Their\n"
            "lifestyle is quite unique among plants."),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 312,
        .trainerOffset = 3,
    ...
    [SPECIES_VICTREEBEL_MEGA] =
    {
        ...
        .weight = 155,
        .description = COMPOUND_STRING(
            "Mega Victreebel is full to bursting with\n" // new desc
            "sweet smelling, highly corrosive acid. It\n"
            "bounces happily, but when aggrivated, it\n"
            "can unleash a tidal wave of sludge."),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 312,
        .trainerOffset = 3,
...
#define FARFETCHD_ATTACK 95
    ...
    [SPECIES_DODUO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_RUN_AWAY, ABILITY_STRONG_LEGS, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Doduo"),
        .cryId = CRY_DODUO,
    ...
    [SPECIES_DODRIO] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "heads. It uses its long legs to race\n"
            "across plains and attack prey. Nothing\n"
            "can outrun it for long."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 268,
        .trainerOffset = 0,
    ...
    [SPECIES_SEEL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_THICK_LAYERS, ABILITY_ICE_SCALES, ABILITY_ICE_BODY },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Seel"),
        .cryId = CRY_SEEL,
    ...
    [SPECIES_GRIMER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_MUK}),
    },
    ...
    [SPECIES_GASTLY] =
    {
        ...
        .weight = 1,
        .description = COMPOUND_STRING(
            "Gastly may appear menacing, but it prefers\n" // new desc
            "harmless pranks and jokes over doing\n"
            "real harm. Strong winds can blow them\n"
            "away, so they hide when storms come."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HAUNTER] =
    {
        ...
        .weight = 1,
        .description = COMPOUND_STRING(
            "Haunter dislikes bright lights, so wary\n" // new desc
            "Trainers carry flashlights to deter them.\n"
            "They can phase through walls and can\n"
            "paralyze foes with their tongues."),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 293,
        .trainerOffset = 2,
    ...
    [SPECIES_GENGAR] =
    {
        ...
        .weight = 405,
        .description = COMPOUND_STRING(
            "This Pokémon loves full moons, when\n" // new desc
            "nighttime shadows stretch longest. It\n"
            "jumps between the shadows of people\n"
            "walking at night to feed on their fear."),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 302,
        .trainerOffset = 2,
    ...
    [SPECIES_GENGAR_MEGA] =
    {
        ...
        .weight = 405,
        .description = COMPOUND_STRING(
            "Mega Gengar lets out chilling laughter\n" // new desc
            "while it chases down victims. During\n"
            "battle, it can melt into the shadows of\n"
            "the foe, waiting for the perfect strike."),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 302,
        .trainerOffset = 2,
    ...
    [SPECIES_ONIX] =
    {
        ...
        .weight = 2100,
        .description = COMPOUND_STRING(
            "Onix burrows through the earth at up to\n" // new desc
            "50 mph, breaching the surface in a manner\n"
            "similar to Wailord and other ocean Pokémon.\n"
            "Many myths condemn Onix as malicious."),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 515,
        .trainerOffset = 14,
    ...
    [SPECIES_STEELIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_STRONG_JAW, ABILITY_SAND_STREAM },
        .bodyColor = BODY_COLOR_GRAY,
        ...
        .weight = 4000,
        .description = COMPOUND_STRING(
            "The ancient people of Ilios's fear of\n" // new desc
            "Onix likely stems from its evolution.\n"
            "Evidence suggests that Onix and Steelix\n"
            "were used in war my opposing armies."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 516,
        .trainerOffset = 13,
    ...
    [SPECIES_STEELIX_MEGA] =
    {
        ...
        .weight = 7400,
        .description = COMPOUND_STRING(
            "Crystals hover around Mega Steelix as\n" // new desc
            "proof of their control over minerals.\n"
            "If an ancient army was able to use this\n"
            "Pokémon, it would have been unstoppable."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 516,
        .trainerOffset = 13,
    ...
    [SPECIES_DROWZEE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INSOMNIA, ABILITY_FOREWARN, ABILITY_POISON_PUPPETEER },
    #else
    ...
    [SPECIES_VOLTORB_HISUIAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SEED_SOWER, ABILITY_STATIC, ABILITY_AFTERMATH },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Voltorb"),
        .cryId = CRY_VOLTORB,
        .natDexNum = NATIONAL_DEX_VOLTORB,
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_EXEGGUTOR_ALOLAN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_FRISK, ABILITY_LONG_REACH, ABILITY_HARVEST },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Exeggutor"),
        .cryId = CRY_EXEGGUTOR,
        .natDexNum = NATIONAL_DEX_EXEGGUTOR,
    ...
    [SPECIES_HITMONLEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_LIMBER, ABILITY_LONG_REACH, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SCYTHER] =
    {
        ...
        .weight = 560,
        .description = COMPOUND_STRING(
            "Packs of Scyther train vigorously in\n"
            "forests and mountains, leaving entire\n"
            "sections of woodlands bare of trees.\n"
            "Very few prey escape with their lives."),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 293,
        .trainerOffset = 2,
    ...
    [SPECIES_SCIZOR] =
    {
        ...
        .weight = 1180,
        .description = COMPOUND_STRING(
            "Scizor are highly territorial, developing\n" // new desc
            "hard exoskeletons and crushing pincers to\n"
            "compete with others for land. They are\n"
            "considered to be great hunters."),
        .pokemonScale = 278,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SCIZOR_MEGA] =
    {
        ...
        .weight = 1250,
        .description = COMPOUND_STRING(
            "Mega Evolution provides Scizor with even\n" // new desc
            "stronger pincers, equipped with sharp,\n"
            "tooth-like structures. Its wings beat to\n"
            "keep its body cool while fighting."),
        .pokemonScale = 278,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KLEAVOR] =
    {
        ...
        .weight = 890,
        .description = COMPOUND_STRING(
            "Kleavor's exoskeleton is constructed from\n" // new desc
            "Black Augurite, making it tough to crack.\n"
            "The stone axes on its arms allow it to\n"
            "slash through boulders in a flash."),
        .pokemonScale = 267,
        .pokemonOffset = 2,
        .trainerScale = 286,
        .trainerOffset = 1,
    ...
    [SPECIES_TAUROS] =
    {
        ...
        .weight = 884,
        .description = COMPOUND_STRING(
            "Tauros are barely able to stand still for\n" // new desc
            "more then a few moments before growing\n"
            "restless. There are stories about a culture\n"
            "on Kaptara Island that worshipped them."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MAGIKARP] =
    {
        ...
        .weight = 100,
        .description = COMPOUND_STRING(
            "It can do little more than float in the\n" // new desc
            "current, as its fins are too small and\n"
            "weak to swim against it. Old legends tell\n"
            "of Magikarp jumping to impossible heights."),
        .pokemonScale = 310,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GYARADOS] =
    {
        ...
        .weight = 2350,
        .description = COMPOUND_STRING(
            "Gyarados is widely feared in the Ilios\n" // new desc
            "Region, as a number of them are known to\n"
            "stalk coastal areas. They are unpredictable\n"
            "and prone to uncontrollable rampages."),
        .pokemonScale = 256,
        .pokemonOffset = 6,
        .trainerScale = 481,
        .trainerOffset = 13,
    ...
    [SPECIES_GYARADOS_MEGA] =
    {
        ...
        .weight = 3050,
        .description = COMPOUND_STRING(
            "Mega Gyarados is driven by the need to\n" // new desc
            "destroy. Only a few, highly skilled\n"
            "Trainers can master this Pokémon, becoming\n"
            "a fierce opponent in battle."),
        .pokemonScale = 256,
        .pokemonOffset = 6,
        .trainerScale = 481,
        .trainerOffset = 13,
    ...
    [SPECIES_VAPOREON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_WATER_ABSORB, ABILITY_ADAPTABILITY, ABILITY_PISCIVORE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_JOLTEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_ADAPTABILITY, ABILITY_STRONG_LEGS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_FLAREON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FUR_COAT, ABILITY_ADAPTABILITY, ABILITY_STRONG_LEGS },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_OMANYTE] =
    {
        ...
        .abilities = { ABILITY_SKILL_LINK, ABILITY_SHELL_ARMOR, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .weight = 75,
        .description = COMPOUND_STRING(
            "This Pokémon was long-thought extinct\n" // new desc
            "before its rediscovery on the coast of\n"
            "Ilios. Omanyte is weak, but it has a\n"
            "rock-hard shell to retreat into."),
        .pokemonScale = 521,
        .pokemonOffset = 22,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_OMASTAR] =
    {
        ...
        .weight = 350,
        .description = COMPOUND_STRING(
            "Wild Omastar, when sighted, often have\n" // new desc
            "chips and cuts taken out of their shell.\n"
            "Recent analysis has found that Kabutops\n"
            "forms a violent rivalry with Omastar."),
        .pokemonScale = 307,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KABUTO] =
    {
        ...
        .weight = 115,
        .description = COMPOUND_STRING(
            "Kabuto were only known from fossils before\n" // new desc
            "a specimen was found crawling up a southern\n"
            "Ilian beach. Their physical forms haven't\n"
            "changed much in the last 300 million years."),
        .pokemonScale = 454,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KABUTOPS] =
    {
        ...
        .weight = 405,
        .description = COMPOUND_STRING(
            "Kabutops, unlike it's previous form, is\n" // new desc
            "a strong hunter on land and at sea. It may\n"
            "be slowly adapting to a life entirely on\n"
            "land, but it swims to hunt down Omastar."),
        .pokemonScale = 271,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AERODACTYL] =
    {
        ...
        .weight = 590,
        .description = COMPOUND_STRING(
            "Once thought extinct, Aerodactyl can once\n" // new desc
            "again be seen in the skies of Ilios.\n"
            "They are omnivorous, but their sharp\n"
            "teeth are best at tearing meat."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 302,
        .trainerOffset = 4,
    ...
    [SPECIES_AERODACTYL_MEGA] =
    {
        ...
        .weight = 790,
        .description = COMPOUND_STRING(
            "Mega Aerodactyl resembles a subspecies\n" // new desc
            "seen in rare fossils. They become much\n"
            "stronger, developing sharp, carbon-based\n"
            "protrusions all over its body."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 302,
        .trainerOffset = 4,
    ...
    [SPECIES_MUNCHLAX] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PICKUP, ABILITY_THICK_LAYERS, ABILITY_GLUTTONY },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_SNORLAX] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_IMMUNITY, ABILITY_THICK_LAYERS, ABILITY_GLUTTONY },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_DRATINI] =
    {
        ...
        .weight = 33,
        .description = COMPOUND_STRING(
            "Dratini was thought to be a simply myth\n" // new desc
            "until being fished up in Kanto around a\n"
            "century ago. Now, small populations have\n"
            "been reported in waters worldwide."),
        .pokemonScale = 256,
        .pokemonOffset = 8,
        .trainerScale = 386,
        .trainerOffset = 6,
    ...
    [SPECIES_DRAGONAIR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SHED_SKIN, ABILITY_NONE, ABILITY_ATMOSPHERIC },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .weight = 165,
        .description = COMPOUND_STRING(
            "Dragonair roaming the waters of Ilios have\n" // new desc
            "a unique typing. Crystals embedded in its\n"
            "neck and tail store energy, allowing it to\n"
            "control weather and the elements."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 411,
        .trainerOffset = 5,
    ...
    [SPECIES_DRAGONITE] =
    {
        ...
        .weight = 2100,
        .description = COMPOUND_STRING(
            "Dragonite is extremely kindhearted. They\n" // new desc
            "soar across the sea, finding lost sailors\n"
            "or struggling Pokémon and rescuing them.\n"
            "Some even deliver mail! They love to help."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 309,
        .trainerOffset = 4,
