...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_FLAPPLE] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_RIPEN, ABILITY_GLUTTONY, ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_APPLETUN] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_RIPEN, ABILITY_GLUTTONY, ABILITY_THICK_LAYERS },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_TOXTRICITY_AMPED] =
    {
        ...
        .abilities = { ABILITY_VOCALIST, ABILITY_PLUS, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_TOXTRICITY_LOW_KEY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_VOCALIST, ABILITY_MINUS, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Toxtricity"),
    ...
    [SPECIES_SIZZLIPEDE] =
    {
        ...
        .weight = 10,
        .description = COMPOUND_STRING(
            "Sizzlipede stores gas produced by decaying\n" // custom entry 5/12/25
            "plant material, releasing and igniting it\n"
            "to produce flame. They have been known\n"
            "to cook their prey to perfection."),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CENTISKORCH] =
    {
        ...
        .weight = 1200,
        .description = COMPOUND_STRING(
            "Unlike Sizzlipede, Centiskorch generate\n" // custom entry 5/12/25
            "flammable gas internally. It can lash\n"
            "its body at foes to burn and stun them,\n"
            "wrapping around prey to cook them."),
        .pokemonScale = 275,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_IMPIDIMP] =
    {
        ...
        .weight = 55,
        .description = COMPOUND_STRING(
            "Impidimp absorbs negative emotion through\n" // new desc
            "its elongated nose. To keep them away,\n"
            "people living in rural Ilios hang steel\n"
            "talismans. It seems to work."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MORGREM] =
    {
        ...
        .weight = 125,
        .description = COMPOUND_STRING(
            "Instead of harmless pranks like Impidimp,\n" // new desc
            "Morgrem can cause real problems to create\n"
            "negative emotions. They can change signs,\n"
            "lure people off paths, and salt fields."),
        .pokemonScale = 366,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_GRIMMSNARL] =
    {
        ...
        .weight = 610,
        .description = COMPOUND_STRING(
            "Grimmsnarl is the inspiration for many\n" // new desc
            "urban legends and fairy tales. They emerge\n"
            "from the deep woods at night to visit rural\n"
            "homes, regardless of any silver by the door."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                      \
    ...
    [SPECIES_FALINKS_MEGA] =
    {
        ...
        .weight = 620,
        .description = COMPOUND_STRING(
            "Mega Falinks is the ultimate form of a\n" // new desc
            "warrior. The individuals making it up\n"
            "share one mind, acting in unison to strike\n"
            "down foes and defend themselves."),
        .pokemonScale = 275,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CUFANT] =
    {
        ...
        .weight = 1000,
        .description = COMPOUND_STRING(
            "Cufant is made of copper, which they dig\n" // new desc
            "up and eat almost every morning. Although\n"
            "once found across the world, their range\n"
    ...
    [SPECIES_COPPERAJAH] =
    {
        ...
        .weight = 6500,
        .description = COMPOUND_STRING(
            "More green, tarnished copper skin gains\n" // new desc
            "them respect. Researchers believe they are\n"
            "among the most intelligent living Pokémon,\n"
            "so poaching them is particularly awful."),
        .pokemonScale = 275,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
