const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_AQUA_GRUNT_M] = TRAINER_PIC_GRUNT_KECLEON,
    ...
    [FACILITY_CLASS_AQUA_GRUNT_F] = TRAINER_PIC_GRUNT_SANDSLASH,
    ...
    [FACILITY_CLASS_AQUA_LEADER_ARCHIE] = TRAINER_PIC_LEADER_SALAMENCE,
