...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_OCTAZOOKA] =
    {
        ...
        .description = COMPOUND_STRING(
            "Fires a ball with Water and\n"
            "Fire power. Cuts accuracy."),
    ...
    [MOVE_INGRAIN] =
    {
        ...
        .description = COMPOUND_STRING(
            "Lays roots that restore 1/8.\n"
            "HP. User can't switch out."),
    ...
    [MOVE_WILD_CHARGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Electrical tackle that can\n"
            "slightly hurt the user."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_DARKEST_LARIAT] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Dark Lariat", "Darkest Lariat"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ANCHOR_SHOT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Traps foe with a Steel\n"
            "and Grass-type chain."),
        .effect = EFFECT_TWO_TYPED_MOVE,
        .power = 80,
        .type = TYPE_STEEL,
        .accuracy = 100,
    ...
    [MOVE_REVELATION_DANCE] =
    {
        ...
        .description = COMPOUND_STRING(
            "A mystic dance by experienced\n"
            "performers. Matches user type."),
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("DualIronBash", "Double Iron Bash"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RISING_VOLTAGE] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Rise Voltage", "Rising Voltage"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("SpringStorm", "Springtide Storm"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Pop. Bomb", "Population Bomb"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("ReviveBless.", "Revival Blessing"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TACHYON_CUTTER] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Tachyon Cut", "Tachyon Cutter"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("RvlationStep", "Revelation Step"),
        .description = COMPOUND_STRING(
            "A mystic waltz by learning\n"
            "dancers. Matches user type."),
        .effect = EFFECT_REVELATION_DANCE,
        .power = 55,
        .type = TYPE_NORMAL,
        .accuracy = 100,
