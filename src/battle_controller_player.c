...
// static void PlayerHandleChooseMove(u32 battler); // moved to battle_controllers.h
...
// static void HandleInputChooseTarget(u32 battler); // moved to battle_controllers.h
// static void HandleInputChooseMove(u32 battler); // moved to battle_controllers.h
...
// static void HandleMoveSwitching(u32 battler); // moved to battle_controllers.h
...
static void MoveSelectionDisplayMoveDescription(u32 battler)
{
    ...
    u8 cat_desc_physical[9] = _("PHYSICAL");
    u8 cat_desc_special[9] = _("SPECIAL");
    u8 cat_desc_status[9] = _("STATUS");
    u8 pwr_desc[7] = _("PWR: ");
    u8 acc_desc[7] = _("ACC: ");
    ...
    if(cat == DAMAGE_CATEGORY_PHYSICAL)
        StringAppend(gDisplayedStringBattle, cat_desc_physical);
    else if(cat == DAMAGE_CATEGORY_SPECIAL)
        StringAppend(gDisplayedStringBattle, cat_desc_special);
    else
        StringAppend(gDisplayedStringBattle, cat_desc_status);
