...
{
    [TIME_OF_DAY_NIGHT] = {.coeff = 5, .blendColor = TINT_NIGHT, .isTint = TRUE}, // default coeff = 10
    [TIME_OF_DAY_TWILIGHT] = {.coeff = 3, .blendColor = 0xA8B0E0, .isTint = TRUE}, // default coeff = 4
