...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_OLDALE_TOWN] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_DEWFORD_TOWN] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_LAVARIDGE_TOWN] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_FALLARBOR_TOWN] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_VERDANTURF_TOWN] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_PACIFIDLOG_TOWN] = MAPPOPUP_THEME_MARBLE,
    ...
    [MAPSEC_ROUTE_101] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE_102] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE_103] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE_104] = MAPPOPUP_THEME_MARBLE,
    ...
    [MAPSEC_ROUTE_110] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE_111] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE_112] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE_113] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE_114] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE_115] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE_116] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE_117] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE_118] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE_119] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE_120] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE_121] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE_122] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_ROUTE_123] = MAPPOPUP_THEME_MARBLE,
    ...
    [MAPSEC_UNDERWATER_124] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_UNDERWATER_126] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_UNDERWATER_127] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_UNDERWATER_128] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_UNDERWATER_SOOTOPOLIS] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_GRANITE_CAVE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_MT_CHIMNEY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SAFARI_ZONE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_BATTLE_FRONTIER] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_PETALBURG_WOODS] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_RUSTURF_TUNNEL] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ABANDONED_SHIP] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_NEW_MAUVILLE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_METEOR_FALLS] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_METEOR_FALLS2] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_MT_PYRE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_AQUA_HIDEOUT_OLD] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SHOAL_CAVE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SEAFLOOR_CAVERN] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_UNDERWATER_SEAFLOOR_CAVERN] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_VICTORY_ROAD] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_MIRAGE_ISLAND] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_CAVE_OF_ORIGIN] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SOUTHERN_ISLAND] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_FIERY_PATH] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_FIERY_PATH2] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_JAGGED_PASS] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_JAGGED_PASS2] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SEALED_CHAMBER] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_UNDERWATER_SEALED_CHAMBER] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_SCORCHED_SLAB] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ISLAND_CAVE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_DESERT_RUINS] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ANCIENT_TOMB] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_INSIDE_OF_TRUCK] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SKY_PILLAR] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SECRET_BASE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_DYNAMIC] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_AQUA_HIDEOUT - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_MAGMA_HIDEOUT - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_MIRAGE_TOWER - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    ...
    [MAPSEC_ARTISAN_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_MARINE_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_UNDERWATER_MARINE_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_TERRA_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_UNDERWATER_105 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_UNDERWATER_125 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_UNDERWATER_129 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_DESERT_UNDERPASS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ALTERING_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_NAVEL_ROCK - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
