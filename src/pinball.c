...
static u8 GetCollisionAttribute(u8 gameType, bool32 ballIsEntering, int index)
{
    const u8 *entranceCollisionMap = sMeowthStageEntranceBgCollisionMap;
    const u8 *collisionMap = sMeowthStageBgCollisionMap;
...
static u8 GetCollisionMaskRow(u8 gameType, int collisionAttribute, int row)
{
    ...
    {
        const u8 *masks = sMeowthStageBgCollisionMasks;
        switch (gameType)
        {
        case GAME_TYPE_MEOWTH:
