...
// old version from before 1.8.0 i think
...
static u8 UNUSED InitFieldMoveMonSprite(u32 species, bool8 isShiny, u32 personality)
{
    bool16 noDucking;
    u8 monSprite;
    struct Sprite *sprite;
...
u8 FldEff_NPCFlyOut(void)
{
    ...
    sprite->oam.paletteNum = LoadObjectEventPalette(FLDEFF_PAL_TAG_MAY);
    PlaySE(SE_M_FLY);
    return spriteId;
}
