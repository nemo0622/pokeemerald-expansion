...
const u8 gText_FlyToWhere[] = _("Fly to {STR_VAR_3}?");
...
const u8 gText_QuestComplete[] =_("{COLOR GREEN}complete{COLOR DARK_GRAY}");
const u8 gText_QuestActive[] =_("{COLOR BLUE}active{COLOR DARK_GRAY}");
const u8 gText_SubquestAnnounce[] = _("A new Subquest in\n'{STR_VAR_1}' has begun!");

//names
const u8 gText_SideQuestName_1[] = _("Welcome to Alola!");
const u8 gText_SideQuestName_2[] = _("Island Challenge");
const u8 gText_SideQuestName_3[] = _("The Pokémon of Alola");
const u8 gText_SideQuestName_4[] = _("Sticker Collection");
const u8 gText_SideQuestName_5[] = _("Finding Zygarde");
const u8 gText_SideQuestName_6[] = _("School's In Session");
const u8 gText_SideQuestName_7[] = _("Samson's Garden");
const u8 gText_SideQuestName_8[] = _("The Pokémon of Ultra Space");
const u8 gText_SideQuestName_9[] = _("Side Quest 9");
const u8 gText_SideQuestName_10[] = _("Side Quest 10");
const u8 gText_SideQuestName_11[] = _("Ilima's Trial");
const u8 gText_SideQuestName_12[] = _("Melemele Grand Trial");
const u8 gText_SideQuestName_13[] = _("Lana's Trial");
const u8 gText_SideQuestName_14[] = _("Kiawe's Trial");
const u8 gText_SideQuestName_15[] = _("Mallow's Trial");
const u8 gText_SideQuestName_16[] = _("Akala Grand Trial");
const u8 gText_SideQuestName_17[] = _("Sophocles' Trial");
const u8 gText_SideQuestName_18[] = _("Acerola's Trial");
const u8 gText_SideQuestName_19[] = _("Ula'ula Grand Trial");
const u8 gText_SideQuestName_20[] = _("Ryuki's Trial");
const u8 gText_SideQuestName_21[] = _("Mina's Trial");
const u8 gText_SideQuestName_22[] = _("Poni Grand Trial");
const u8 gText_SideQuestName_23[] = _("Big Poppa's Big Fish");
const u8 gText_SideQuestName_24[] = _("Tourist's Difficulty");
...
//descriptions
const u8 gText_SideQuestDesc_1[] = _("Get your bearings in the Alola Region.");
const u8 gText_SideQuestDesc_2[] = _("Complete various Trials across\nAlola's Four Islands.");
const u8 gText_SideQuestDesc_3[] = _("Catch all Pokémon from across Alola.");
const u8 gText_SideQuestDesc_4[] = _("Collect all Totem Stickers hidden\nacross Alola.");
const u8 gText_SideQuestDesc_5[] = _("Collect all Zygarde Cells hidden\nacross Alola.");
const u8 gText_SideQuestDesc_6[] = _("Read all Education Signs put up by\nthe Alola Leo School staff.");
const u8 gText_SideQuestDesc_7[] = _("Bring Pokémon to Grandpa Samson Oak's garden.");
const u8 gText_SideQuestDesc_8[] = _("Catch all Pokémon in the Ultra Pokédex,\nfound across Ultra Space.");
const u8 gText_SideQuestDesc_9[] = _("Description 9");
const u8 gText_SideQuestDesc_10[] = _("Description 10");
const u8 gText_SideQuestDesc_11[] = _("Complete Captain Ilima's\nNormal-type Trial.");
const u8 gText_SideQuestDesc_12[] = _("Complete Kahuna Hala's\nFighting-type Trial.");
const u8 gText_SideQuestDesc_13[] = _("Complete Captain Lana's\nWater-type Trial.");
const u8 gText_SideQuestDesc_14[] = _("Complete Captain Kiawe's\nFire-type Trial.");
const u8 gText_SideQuestDesc_15[] = _("Complete Captain Mallow's\nGrass-type Trial.");
const u8 gText_SideQuestDesc_16[] = _("Complete Kahuna Olivia's\nRock-type Trial.");
const u8 gText_SideQuestDesc_17[] = _("Complete Captain Sophocles'\nElectric-type Trial.");
const u8 gText_SideQuestDesc_18[] = _("Complete Captain Acerola's\nGhost-type Trial.");
const u8 gText_SideQuestDesc_19[] = _("Complete Kahuna Nanu's\nDark-type Trial.");
const u8 gText_SideQuestDesc_20[] = _("Complete Captain Ryuki's\nDragon-type Trial.");
const u8 gText_SideQuestDesc_21[] = _("Complete Captain Mina's\nFairy-type Trial.");
const u8 gText_SideQuestDesc_22[] = _("Complete Kahuna Hapu's\nGround-type Trial.");
const u8 gText_SideQuestDesc_23[] = _("Show Big Poppa the completed\nPokédex page of {COLOR BLUE}Wishiwashi{COLOR DARK_GRAY}.");
const u8 gText_SideQuestDesc_24[] = _("Bring a sightseeing Collector\na Premier Ball.");
...
const u8 gText_SideQuestDoneDesc_1[] = _("You got to know your new home!");
const u8 gText_SideQuestDoneDesc_2[] = _("All Trials have been complete.");
const u8 gText_SideQuestDoneDesc_3[] = _("The Alolan Pokédex is complete!");
const u8 gText_SideQuestDoneDesc_4[] = _("You have collected all 100 Totem Stickers.");
const u8 gText_SideQuestDoneDesc_5[] = _("You have collected all 100 Zygarde Cells.");
const u8 gText_SideQuestDoneDesc_6[] = _("You read all Educational Signs.\nWhat a genius!");
const u8 gText_SideQuestDoneDesc_7[] = _("Samson's Garden is now a safe haven\nfor all Pokémon!");
const u8 gText_SideQuestDoneDesc_8[] = _("You caught all Pokémon found in\nAlola's Ultra Wormholes.");
const u8 gText_SideQuestDoneDesc_9[] = _("Completed Quest 9");
const u8 gText_SideQuestDoneDesc_10[] = _("Completed Quest 10");
const u8 gText_SideQuestDoneDesc_11[] = _("You cleared Ilima's Trial.");
const u8 gText_SideQuestDoneDesc_12[] = _("You cleared Hala's Trial.");
const u8 gText_SideQuestDoneDesc_13[] = _("You cleared Lana's Trial.");
const u8 gText_SideQuestDoneDesc_14[] = _("You cleared Kiawe's Trial.");
const u8 gText_SideQuestDoneDesc_15[] = _("You cleared Mallow's Trial.");
const u8 gText_SideQuestDoneDesc_16[] = _("You cleared Olivia's Trial.");
const u8 gText_SideQuestDoneDesc_17[] = _("You cleared Sophocles' Trial.");
const u8 gText_SideQuestDoneDesc_18[] = _("You cleared Acerola's Trial.");
const u8 gText_SideQuestDoneDesc_19[] = _("You cleared Nanu's Trial.");
const u8 gText_SideQuestDoneDesc_20[] = _("You cleared Ryuki's Trial.");
const u8 gText_SideQuestDoneDesc_21[] = _("You cleared Mina's Trial.");
const u8 gText_SideQuestDoneDesc_22[] = _("You cleared Hapu's Trial.");
const u8 gText_SideQuestDoneDesc_23[] = _("Big Poppa learned all about\n{COLOR BLUE}Wishiwashi{COLOR DARK_GRAY}'s Schooling behavior.");
const u8 gText_SideQuestDoneDesc_24[] = _("The Collector might catch a\nreal Pokémon with the Premier Ball.");
...
//map
const u8 gText_SideQuestMap1[] = _("Melemele Island");
const u8 gText_SideQuestMap2[] = _("Alola Region");
const u8 gText_SideQuestMap3[] = _("Alola Region");
const u8 gText_SideQuestMap4[] = _("Alola Region");
const u8 gText_SideQuestMap5[] = _("Alola Region");
const u8 gText_SideQuestMap6[] = _("Alola Region");
const u8 gText_SideQuestMap7[] = _("Hau'oli Outskirts - Home");
const u8 gText_SideQuestMap8[] = _("Ultra Space");
const u8 gText_SideQuestMap9[] = _("Map 9");
const u8 gText_SideQuestMap10[] = _("Map 10");
const u8 gText_SideQuestMap11[] = _("Verdant Cavern");
const u8 gText_SideQuestMap12[] = _("Iki Town");
const u8 gText_SideQuestMap13[] = _("Brooklet Hill");
const u8 gText_SideQuestMap14[] = _("Wela Volcano Park");
const u8 gText_SideQuestMap15[] = _("Lush Jungle");
const u8 gText_SideQuestMap16[] = _("Ruins of Life");
const u8 gText_SideQuestMap17[] = _("Hokulani Observatory");
const u8 gText_SideQuestMap18[] = _("Thrifty Megamart");
const u8 gText_SideQuestMap19[] = _("Malie City");
const u8 gText_SideQuestMap20[] = _("Vast Poni Canyon");
const u8 gText_SideQuestMap21[] = _("Seafolk Village");
const u8 gText_SideQuestMap22[] = _("Exeggutor Island");
const u8 gText_SideQuestMap23[] = _("Hau'oli Beachfront (Surf Shop)");
const u8 gText_SideQuestMap24[] = _("Hau'oli Beachfront (Tourist Bureau)");
...
const u8 gText_SubQuest1_Name1[] = _("Finding Grandpa");
const u8 gText_SubQuest1_Name2[] = _("Iki Town, For Real!");
const u8 gText_SubQuest1_Name3[] = _("Finding Hau");
const u8 gText_SubQuest1_Name4[] = _("Manalo Festival Battle!");
const u8 gText_SubQuest1_Name5[] = _("Quick Detour");
const u8 gText_SubQuest1_Name6[] = _("Ready For Anything");
const u8 gText_SubQuest1_Desc1[] = _("Meet Samson Oak in Iki Town.");
const u8 gText_SubQuest1_Desc2[] = _("Follow Route 1 to Iki Town.");
const u8 gText_SubQuest1_Desc3[] = _("Find Hau, Kahuna Hala's grandson, north of\nIki Town.");
const u8 gText_SubQuest1_Desc4[] = _("Battle Hau in the Manalo Festival Battle.");
const u8 gText_SubQuest1_Desc5[] = _("Meet with Lillie and Professor Kukui\nin Kukui's Lab.");
const u8 gText_SubQuest1_Desc6[] = _("Complete the Alola Leo Trainer School\ncurriculum by battling students.");
const u8 gText_SubQuest1_Map1[] = _("Route 1");
const u8 gText_SubQuest1_Map2[] = _("Iki Town");
const u8 gText_SubQuest1_Map3[] = _("Mahalo Trail");
const u8 gText_SubQuest1_Map4[] = _("Iki Town");
const u8 gText_SubQuest1_Map5[] = _("Hau'oli Outskirts");
const u8 gText_SubQuest1_Map6[] = _("Alola Leo School");

// Subquests for QUEST_ISLAND_CHALLENGE
const u8 gText_SubQuest2_Name1[] = _("Ilima's Trial");
const u8 gText_SubQuest2_Name2[] = _("Hala's Grand Trial");
const u8 gText_SubQuest2_Name3[] = _("Lana's Trial");
const u8 gText_SubQuest2_Name4[] = _("Kiawe's Trial");
const u8 gText_SubQuest2_Name5[] = _("Mallow's Trial");
const u8 gText_SubQuest2_Name6[] = _("Olivia's Grand Trial");
const u8 gText_SubQuest2_Name7[] = _("Sophocles' Trial");
const u8 gText_SubQuest2_Name8[] = _("Acerola's Trial");
const u8 gText_SubQuest2_Name9[] = _("Nanu's Grand Trial");
const u8 gText_SubQuest2_Name10[] = _("Ryuki's Trial");
const u8 gText_SubQuest2_Name11[] = _("Mina's Trial");
const u8 gText_SubQuest2_Name12[] = _("Hapu's Grand Trial");
const u8 gText_SubQuest2_Desc1[] = _("Complete Ilima's Normal-type Trial.");
const u8 gText_SubQuest2_Desc2[] = _("Complete Kahuna Hala's\nFighting-type Trial.");
const u8 gText_SubQuest2_Desc3[] = _("Complete Lana's Water-type Trial.");
const u8 gText_SubQuest2_Desc4[] = _("Complete Kiawe's Fire-type Trial.");
const u8 gText_SubQuest2_Desc5[] = _("Complete Mallow's Grass-type Trial.");
const u8 gText_SubQuest2_Desc6[] = _("Complete Kahuna Olivia's\nRock-type Trial.");
const u8 gText_SubQuest2_Desc7[] = _("Complete Sophocles' Electric-type Trial.");
const u8 gText_SubQuest2_Desc8[] = _("Complete Acerola's Ghost-type Trial.");
const u8 gText_SubQuest2_Desc9[] = _("Complete Kahuna Nanu's\nDark-type Trial.");
const u8 gText_SubQuest2_Desc10[] = _("Complete Ryuki's Dragon-type Trial.");
const u8 gText_SubQuest2_Desc11[] = _("Complete Mina's Fairy-type Trial.");
const u8 gText_SubQuest2_Desc12[] = _("Complete Kahuna Hapu's\nGround-type Trial.");
const u8 gText_SubQuest2_Map1[] = _("Verdant Cavern");
const u8 gText_SubQuest2_Map2[] = _("Iki Town");
const u8 gText_SubQuest2_Map3[] = _("Brooklet Hill");
const u8 gText_SubQuest2_Map4[] = _("Wela Volcano Park");
const u8 gText_SubQuest2_Map5[] = _("Lush Jungle");
const u8 gText_SubQuest2_Map6[] = _("Ruins of Life");
const u8 gText_SubQuest2_Map7[] = _("Hokulani Observatory");
const u8 gText_SubQuest2_Map8[] = _("Thrifty Megamart");
const u8 gText_SubQuest2_Map9[] = _("Malie City");
const u8 gText_SubQuest2_Map10[] = _("Vast Poni Canyon");
const u8 gText_SubQuest2_Map11[] = _("Seafolk Village");
const u8 gText_SubQuest2_Map12[] = _("Exeggutor Island");

// Subquests for QUEST_DEX_COMPLETION
const u8 gText_SubQuest3_Name1[] = _("Melemele Island Dex");
const u8 gText_SubQuest3_Name2[] = _("Akala Island Dex");
const u8 gText_SubQuest3_Name3[] = _("Ula'ula Island Dex");
const u8 gText_SubQuest3_Name4[] = _("Poni Island Dex");
const u8 gText_SubQuest3_Desc1[] = _("Catch all Pokémon found on this island.");
const u8 gText_SubQuest3_Desc2[] = _("Catch all Pokémon found on this island.");
const u8 gText_SubQuest3_Desc3[] = _("Catch all Pokémon found on this island.");
const u8 gText_SubQuest3_Desc4[] = _("Catch all Pokémon found on this island.");
const u8 gText_SubQuest3_Map1[] = _("Melemele Island");
const u8 gText_SubQuest3_Map2[] = _("Akala Island");
const u8 gText_SubQuest3_Map3[] = _("Ula'ula Island");
const u8 gText_SubQuest3_Map4[] = _("Poni Island");
...
const u8 gText_SubQuest4_Map3[] = _("Verdant Cavern");
