...
const u8 gText_DexHoennTitle[] = _("Ilios Dex");
...
const u8 gText_DexHoennDescription[] = _("Ilios region's Pokédex");
...
const u8 gText_TourneyTree[] = _("Tourney Three");
...
const u8 gText_ArcanineDoll128BP[] = _("ARCANINE DOLL{CLEAR_TO 0x58}128BP");
const u8 gText_RaikouDoll256BP[] = _("RAIKOU DOLL{CLEAR_TO 0x58}256BP");
const u8 gText_EnteiDoll256BP[] = _("ENTEI DOLL{CLEAR_TO 0x58}256BP");
const u8 gText_SuicuneDoll256BP[] = _("SUICUNE DOLL{CLEAR_TO 0x58}256BP");
...
const u8 gText_10P30P50P50P[] = _("{CLEAR_TO 0x03}10P{CLEAR_TO 0x2B}30P{CLEAR_TO 0x53}50P{CLEAR_TO 0x77}{EMOJI_ROTOM_RIGHT}50P");
...
const u8 gText_MenuRotomPhone[] = _("Phone {EMOJI_ROTOM_LEFT}{EMOJI_ROTOM_RIGHT}");
...
const u8 gText_DexHoenn[] = _("Ilios");
...
const u8 gText_MysteryGiftCode[] = _("Enter cheat code:");
...
const u8 gText_DifficultySetting[] = _("Difficulty");
const u8 gText_DifficultySetting_Normal[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Normal");
const u8 gText_DifficultySetting_Hard[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Hard");
...
const u8 gText_DayNightCycleSetting[] = _("Day / Night");
const u8 gText_DayNightCycleSetting_On[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Visible");
const u8 gText_DayNightCycleSetting_Off[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}No Tint");
...
const u8 gText_LevelCapsSetting[] = _("Level Caps");
const u8 gText_LevelCapsSetting_On[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}On");
const u8 gText_LevelCapsSetting_Off[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Off");
...
//// side quest data
//generic strings
const u8 gText_QuestAnnounce[] = _("Quest: {STR_VAR_1}\nis now {STR_VAR_2}!");
const u8 gText_QuestComplete[] =_("complete");
const u8 gText_QuestActive[] =_("active");

//names
const u8 gText_SideQuestName_1[] = _("Find Pokédex");
const u8 gText_SideQuestName_2[] = _("Gym 1");
const u8 gText_SideQuestName_3[] = _("Talk to Prof. Elia");
const u8 gText_SideQuestName_4[] = _("Gym 2");
const u8 gText_SideQuestName_5[] = _("Talk to Prof. Elia");
const u8 gText_SideQuestName_6[] = _("Gym 3");
const u8 gText_SideQuestName_7[] = _("Gym 4");
...
const u8 gText_SideQuestName_15[] = _("Archaic Pokémon");
const u8 gText_SideQuestName_16[] = _("Berry Novice");
const u8 gText_SideQuestName_17[] = _("Berry Enthusiast");
const u8 gText_SideQuestName_18[] = _("Berry Expert");
const u8 gText_SideQuestName_19[] = _("Berry Master");
const u8 gText_SideQuestName_20[] = _("Save our Sails!");
...
const u8 gText_SideQuestName_36[] = _("Nemo's Birds");
...
const u8 gText_SideQuestDesc_2[] = _("Defeat Gym 1 in\nJusmail Town.");
const u8 gText_SideQuestDesc_3[] = _("Update Professor Elia with your\nadventure progress!");
const u8 gText_SideQuestDesc_4[] = _("Defeat Gym 2 in\nKalami City.");
const u8 gText_SideQuestDesc_5[] = _("Update Professor Elia with your\nadventure progress!");
const u8 gText_SideQuestDesc_6[] = _("Defeat Gym 3 in\nPythios Town.");
const u8 gText_SideQuestDesc_7[] = _("Defeat Gym 4 in\nSofos City.");
...
const u8 gText_SideQuestDesc_15[] = _("Show a completed Pokédex entry\nof Baltoy to the Lass\nfor a reward.");
const u8 gText_SideQuestDesc_16[] = _("Plant 20 Berry Trees around the\nIlios Region for a gift\nfrom the Jusmail Town Berry Club.");
const u8 gText_SideQuestDesc_17[] = _("Plant 50 Berry Trees around the\nIlios Region for a gift\nfrom the Jusmail Town Berry Club.");
const u8 gText_SideQuestDesc_18[] = _("Plant 100 Berry Trees around the\nIlios Region for a gift\nfrom the Jusmail Town Berry Club.");
const u8 gText_SideQuestDesc_19[] = _("Plant 200 Berry Trees around the\nIlios Region for a gift\nfrom the Jusmail Town Berry Club.");
const u8 gText_SideQuestDesc_20[] = _("Defeat the Team Chimera Admin waiting\nto attack Piraeus east of\nPythios Town.");
...
const u8 gText_SideQuestDesc_24[] = _("Catch a Blitzle and show it\nto the Punk Rocker to help\nher love Pokémon.");
...
const u8 gText_SideQuestDesc_36[] = _("Show Nemo all four forms\nof Oricorio in your\nparty.");
...
const u8 gText_SideQuestDoneDesc_1[] = _("The Pokédex was found!");
const u8 gText_SideQuestDoneDesc_2[] = _("The Gym Challenge has been completed!");
...
//map
const u8 gText_SideQuestMap1[] = _("Bronze Fields"); // QUEST_FIND_POKEDEX
const u8 gText_SideQuestMap2[] = _("Jusmail Town"); // QUEST_GYM_1
const u8 gText_SideQuestMap3[] = _("Acrisia University"); // QUEST_CHECK_AFTER_GYM_1
const u8 gText_SideQuestMap4[] = _("Kalami City"); // QUEST_GYM_2
const u8 gText_SideQuestMap5[] = _("Acrisia University"); // QUEST_CHECK_AFTER_GYM_2
const u8 gText_SideQuestMap6[] = _("Pythios Town"); // QUEST_GYM_3
const u8 gText_SideQuestMap7[] = _("Sofos City"); // QUEST_GYM_4
const u8 gText_SideQuestMap8[] = _("Myrrini Island"); // QUEST_GYM_5
...
const u8 gText_SideQuestMap16[] = _("Ilios Region"); // QUEST_PLANT_20_BERRIES
const u8 gText_SideQuestMap17[] = _("Ilios Region"); // QUEST_PLANT_50_BERRIES
const u8 gText_SideQuestMap18[] = _("Ilios Region"); // QUEST_PLANT_100_BERRIES
const u8 gText_SideQuestMap19[] = _("Ilios Region"); // QUEST_PLANT_200_BERRIES
const u8 gText_SideQuestMap20[] = _("Erinys Path"); // QUEST_HELP_PIRAEUS
...
const u8 gText_SideQuestMap42[] = _("Sea of Asteri (West)"); // QUEST_ASTERI_SEA_PEARL_STRING
...
const u8 gText_SubQuest1_Name1[] = _("Gym 1");
const u8 gText_SubQuest1_Name2[] = _("Visit Prof. Elia");
const u8 gText_SubQuest1_Name3[] = _("Gym 2");
const u8 gText_SubQuest1_Name4[] = _("Visit Prof. Elia");
const u8 gText_SubQuest1_Name5[] = _("Gym 3");
const u8 gText_SubQuest1_Name6[] = _("Gym 4");
const u8 gText_SubQuest1_Name7[] = _("Gym 5");
const u8 gText_SubQuest1_Name8[] = _("Gym 6");
const u8 gText_SubQuest1_Name9[] = _("Gym 7");
const u8 gText_SubQuest1_Name10[] = _("Gym 8");
...
const u8 gText_SubQuest1_Desc1[] = _("Defeat Gym 1 in\n Jusmail Town.");
const u8 gText_SubQuest1_Desc2[] = _("Update Prof. Elia on\n your progress!");
const u8 gText_SubQuest1_Desc3[] = _("Defeat Gym 2 in\n Kalami City.");
const u8 gText_SubQuest1_Desc4[] = _("Update Prof. Elia on\n your progress!");
const u8 gText_SubQuest1_Desc5[] = _("Defeat Gym 3 in\n Pythios Town.");
const u8 gText_SubQuest1_Desc6[] = _("Defeat Gym 4 in\n Sofos City.");
const u8 gText_SubQuest1_Desc7[] = _("Defeat Gym 5 on\n Myrrini Island.");
const u8 gText_SubQuest1_Desc8[] = _("Defeat Gym 6 on\n the Fresco Isles.");
const u8 gText_SubQuest1_Desc9[] = _("Defeat Gym 7 in\n Palati City.");
const u8 gText_SubQuest1_Desc10[] = _("Defeat Gym 8 in\n Areios Hideout.");
...
const u8 gText_SubQuest1_SubMap1[] = _("Jusmail Town");
const u8 gText_SubQuest1_SubMap2[] = _("Acrisia City");
const u8 gText_SubQuest1_SubMap3[] = _("Kalami City");
const u8 gText_SubQuest1_SubMap4[] = _("Acrisia City");
const u8 gText_SubQuest1_SubMap5[] = _("Pythios Town");
const u8 gText_SubQuest1_SubMap6[] = _("Sofos City");
const u8 gText_SubQuest1_SubMap7[] = _("Myrrini Island");
const u8 gText_SubQuest1_SubMap8[] = _("The Fresco Isles");
const u8 gText_SubQuest1_SubMap9[] = _("Palati City");
const u8 gText_SubQuest1_SubMap10[] = _("Areios Hideout");
