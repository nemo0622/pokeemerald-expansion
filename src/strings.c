...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("ETHAN");
const u8 gText_ExpandedPlaceholder_May[] = _("LYRA");
...
const u8 gText_BirchBoy[] = _("MODEL 1");
const u8 gText_BirchGirl[] = _("MODEL 2");
...
const u8 gText_MysteryGiftCode[] = _("Enter Gift Code:");
...
const u8 gText_ChangeTime[] = _("CHANGE");
