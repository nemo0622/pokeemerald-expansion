...
# Known Bugs
### UI & Graphics
- Region Map: After opening the Info window in the Region Map like 30 times, it returns you to field.
    - Explanation: This is a chopped solution to the UI running out of memory lol, but most people probably won't run into this
- Pokédex: Orange Pokémon selection outline upper-right corner occasionally vanishes
